import { hX as K, bh as D } from "./main-BpIyUAdL.js";
import { y as X } from "./DoubleArray-BqozZvkM.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-BLfoLAS3.js";
import { n as Z, s as ee } from "./vec3-Clj_JEkr.js";
import "./sphere-Dp2pTfe-.js";
import "./I3SUtil-CmCtCRQm.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-taNwqMDU.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-BpIyUAdL.js").then((d) => d.qK), import("./main-BpIyUAdL.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-C-DYrPnb.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-Be9GAWZd.js.map
