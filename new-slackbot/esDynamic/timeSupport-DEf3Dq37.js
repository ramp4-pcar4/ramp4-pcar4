...
async function Ye() {
  return (await import("./geometryEngineJSON-CRoQQRma.js").then((e) => e.g)).geodesicBuffer;
}
function Ze(e) {
...
function He() {
  return import("./geometryEngineJSON-CRoQQRma.js").then((e) => e.g);
}
...
//# sourceMappingURL=timeSupport-DEf3Dq37.js.map
