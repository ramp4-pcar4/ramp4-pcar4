import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-BpIyUAdL.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-BkVYz9OD.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-Dot3Y8cI.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-BNYtO3Fr.js")).default, n = (await import("./index-CYgL9gr3.js")).default, a = (await import("./index-abSFeCjB.js")).default, w = (await import("./index-D0jhm2XS.js")).default, p = (await import("./index-DYTHVaWO.js")).default, r = (await import("./index-YaMKHM9z.js")).default, b = (await import("./index-C1_JaIM2.js")).default;
...
//# sourceMappingURL=index-DK-l5DWB.js.map
