...
class a {
  ...
  clearFilters() {
    ...
    }), this._filterByExtent = !1, this._filtered = !1, this._searchFilter = "";
  }
  _checkFilters() {
    this._filtered = Object.values(this._columns).some((t) => t.filter.value !== "" || t.filter.min || t.filter.max);
  }
  get filtered() {
...
//# sourceMappingURL=table-state-manager-CQv-OGS1.js.map
