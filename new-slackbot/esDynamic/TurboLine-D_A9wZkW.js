import { af as le, hX as ue } from "./main-BpIyUAdL.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-CpIyLcsi.js").then((i) => i.l) : await import("./libtess-iVJ-qske.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-D_A9wZkW.js.map
