...
import { _ as H, d as L, F as X, G as ee } from "./main-4J-35TZy.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-C-oWNI26.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CqQ7lvoD.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CMAuLJWH.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DjTGqd6e.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-l3PH3I5P.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CrPoWwGD.js")))
      }), s;
    }), n = (s) => {
