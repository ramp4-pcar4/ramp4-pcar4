import { e as e$1, y, kc as e$2, k as a$1, kd as W$1, ke as n$1, kf as s$3, kg as v, bp as l$1, hv as n, kh as e$3, dA as l$2, fw as n$2, n as r$1, ki as l$3, L as L$1, eZ as D$1, kj as v$1, c as s$4, kk as p$3, fE as M, kl as $, U as U$1, f9 as v$2, km as et, gz as r$2, fa as A, kn as t$1, bO as s$5, ko as K, kp as J, jC as t$2, kq as F, bN as Et, kr as n$3 } from './main-5658cd6e.js';
...
*/
const a="esri-identity-form",l={base:a,group:`${a}__group`,label:`${a}__label`,footer:`${a}__footer`,esriInput:"esri-input",esriButton:"esri-button",esriButtonSecondary:"esri-button--secondary"},p$2="ArcGIS Online";let d$1=class d extends W$1{constructor(s,e){super(s,e),this._usernameInputNode=null,this._passwordInputNode=null,this.signingIn=!1,this.server=null,this.resource=null,this.error=null,this.oAuthPrompt=!1;}render(){const{error:s,server:e,resource:t,signingIn:o,oAuthPrompt:n,messages:a}=this,d=n$1("div",{class:l.group},s$3(n?a.oAuthInfo:a.info,{server:e&&/\.arcgis\.com/i.test(e)?p$2:e,resource:`(${t||a.lblItem})`})),c=n?null:n$1("div",{class:l.group,key:"username"},n$1("label",{class:l.label},a.lblUser,n$1("input",{value:"",required:!0,autocomplete:"off",spellcheck:!1,type:"text",bind:this,afterCreate:v,"data-node-ref":"_usernameInputNode",class:l.esriInput}))),m=n?null:n$1("div",{class:l.group,key:"password"},n$1("label",{class:l.label},a.lblPwd,n$1("input",{value:"",required:!0,type:"password",bind:this,afterCreate:v,"data-node-ref":"_passwordInputNode",class:l.esriInput}))),h=n$1("div",{class:this.classes(l.group,l.footer)},n$1("input",{type:"submit",disabled:!!o,value:o?a.lblSigning:a.lblOk,class:l.esriButton}),n$1("input",{type:"button",value:a.lblCancel,bind:this,onclick:this._cancel,class:this.classes(l.esriButton,l.esriButtonSecondary)})),b=s?n$1("div",null,s.details&&s.details.httpStatus?a.invalidUser:a.noAuthService):null;return n$1("form",{class:l.base,bind:this,onsubmit:this._submit},d,b,c,m,h)}_cancel(){this._set("signingIn",!1),this._usernameInputNode&&(this._usernameInputNode.value=""),this._passwordInputNode&&(this._passwordInputNode.value=""),this.emit("cancel");}_submit(s){s.preventDefault(),this._set("signingIn",!0);const e=this.oAuthPrompt?{}:{username:this._usernameInputNode&&this._usernameInputNode.value,password:this._passwordInputNode&&this._passwordInputNode.value};this.emit("submit",e);}};e$1([y(),e$2("esri/identity/t9n/identity")],d$1.prototype,"messages",void 0),e$1([y()],d$1.prototype,"signingIn",void 0),e$1([y()],d$1.prototype,"server",void 0),e$1([y()],d$1.prototype,"resource",void 0),e$1([y()],d$1.prototype,"error",void 0),e$1([y()],d$1.prototype,"oAuthPrompt",void 0),d$1=e$1([a$1("esri.identity.IdentityForm")],d$1);const c=d$1;
...
See https://js.arcgis.com/4.26/esri/copyright.txt for details.
*/
const d="esri-identity-modal",p$1={base:d,open:`${d}--open`,closed:`${d}--closed`,title:`${d}__title`,dialog:`${d}__dialog`,content:`${d}__content`,closeButton:`${d}__close-button`,iconClose:"esri-icon-close"};let u=class extends W$1{constructor(t,e){super(t,e),this.container=document.createElement("div"),this.content=null,this.open=!1,this._focusTrap=null,this._close=()=>{this.open=!1;},document.body.appendChild(this.container),this.addHandles(l$1((()=>this.open),(()=>this._toggleFocusTrap())));}destroy(){this._destroyFocusTrap();}get title(){return this.messages?.auth.signIn}render(){const t=this.id,{open:e,content:o,title:s,messages:i}=this,r=e&&!!o,n={[p$1.open]:r,[p$1.closed]:!r},a=n$1("button",{class:p$1.closeButton,"aria-label":i.close,title:i.close,bind:this,onclick:this._close,type:"button"},n$1("span",{"aria-hidden":"true",class:p$1.iconClose})),l=`${t}_title`,d=`${t}_content`,u=s?n$1("h1",{id:l,class:p$1.title},s):null,h=r?n$1("div",{bind:this,class:p$1.dialog,role:"dialog","aria-labelledby":l,"aria-describedby":d,afterCreate:this._createFocusTrap},a,u,this._renderContent(d)):null;return n$1("div",{tabIndex:-1,class:this.classes(p$1.base,n)},h)}_destroyFocusTrap(){this._focusTrap?.deactivate({onDeactivate:()=>{}}),this._focusTrap=null;}_toggleFocusTrap(){const{_focusTrap:t,open:e}=this;t&&(e?t.activate():t.deactivate());}_createFocusTrap(t){this._destroyFocusTrap();const o=requestAnimationFrame((()=>{this._focusTrap=createFocusTrap(t,{initialFocus:"input",onDeactivate:this._close}),this._toggleFocusTrap();}));this.addHandles(n((()=>cancelAnimationFrame(o))));}_renderContent(t){const e=this.content;return "string"==typeof e?n$1("div",{class:p$1.content,id:t,innerHTML:e}):e$3(e)?n$1("div",{class:p$1.content,id:t},e.render()):e instanceof HTMLElement?n$1("div",{class:p$1.content,id:t,bind:e,afterCreate:this._attachToNode}):null}_attachToNode(t){const e=this;t.appendChild(e);}};e$1([y({readOnly:!0})],u.prototype,"container",void 0),e$1([y()],u.prototype,"content",void 0),e$1([y()],u.prototype,"open",void 0),e$1([y(),e$2("esri/t9n/common")],u.prototype,"messages",void 0),e$1([y()],u.prototype,"title",null),u=e$1([a$1("esri.identity.IdentityModal")],u);const h=u;
