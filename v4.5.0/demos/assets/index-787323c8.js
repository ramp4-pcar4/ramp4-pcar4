...
import { c2 as defineComponent, c4 as inject, c6 as resolveComponent, c8 as openBlock, c9 as createBlock, ca as withCtx, fn as createBaseVNode, i3 as normalizeStyle, cb as createTextVNode, c3 as useI18n, cc as toDisplayString, cd as unref, bZ as FixtureInstance, gF as markRaw } from './main-5658cd6e.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-3555dec7.js'),true?["./p2-screen-1-3555dec7.js","./main-5658cd6e.js","./preload-helper-a4975f27.js","./main-2af48127.css"]:void 0,import.meta.url).then(
                    (data) => {
                      resolve(data);
                    }
                  ),
