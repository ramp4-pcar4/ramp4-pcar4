...
export { EsriBasemap, EsriBasemapGallery, EsriClassBreakInfo, EsriClassBreaksRenderer, EsriColour, EsriConfig, EsriExtent, EsriFeatureFilter, EsriFeatureLayer, EsriField, EsriGeometry, EsriGeometryFromJson, EsriGraphic, EsriGraphicsLayer, EsriImageryLayer, EsriLOD, EsriMap, EsriMapImageLayer, EsriMapView, EsriMultipoint, EsriOpenStreetMapLayer, EsriPictureMarkerSymbol, EsriPoint, EsriPolygon, EsriPolyline, EsriQuery, EsriQueryByIds, EsriRenderer, EsriRendererFromJson, EsriRequest, EsriScaleBar, EsriSimpleFillSymbol, EsriSimpleLineSymbol, EsriSimpleMarkerSymbol, EsriSimpleRenderer, EsriSpatialReference, EsriSymbol, EsriSublayer, EsriSymbolFromJson, EsriTileLayer, EsriUniqueValueInfo, EsriUniqueValueRenderer, EsriWMSLayer, EsriWMSSublayer };
