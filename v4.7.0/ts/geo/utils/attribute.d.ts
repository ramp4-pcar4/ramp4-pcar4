...
import type { Attributes, AttributeSet, BaseGeometry, CompactJson, Extent, FieldDefinition, GetGraphicServiceDetails, RampLayerFieldInfoConfig, RampLayerFieldMetadataConfig, TabularAttributeSet } from '@/geo/api';
