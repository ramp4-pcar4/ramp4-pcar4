import { APIScope, InstanceAPI, type PanelTeleportObject } from './internal';
import type { PanelConfig, PanelConfigRoute, PanelConfigScreens, PanelConfigStyle, PanelDirection } from '@/stores/panel';
