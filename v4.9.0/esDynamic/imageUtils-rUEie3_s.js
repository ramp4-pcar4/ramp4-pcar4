import { am as m, au as d, a2 as u, K as w, s as p } from "./main-DIdq27YS.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-wjxvz6Cb.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-DZpHkR9N.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-rUEie3_s.js.map
