import { hX as K, bh as D } from "./main-DIdq27YS.js";
import { y as X } from "./DoubleArray-Do7o-QA5.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-hBlBRf1z.js";
import { n as Z, s as ee } from "./vec3-D3PXDBov.js";
import "./sphere-DOGPHAGA.js";
import "./I3SUtil-A6CA1kK5.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-oDmFaaXD.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-DIdq27YS.js").then((d) => d.qK), import("./main-DIdq27YS.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-CUlKz6iO.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-DHd6oxAn.js.map
