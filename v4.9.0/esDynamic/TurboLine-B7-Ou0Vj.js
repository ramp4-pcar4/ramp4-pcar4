import { af as le, hX as ue } from "./main-DIdq27YS.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-C_xeqx82.js").then((i) => i.l) : await import("./libtess-CjPUSQee.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-B7-Ou0Vj.js.map
