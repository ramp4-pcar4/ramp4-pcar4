import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-DIdq27YS.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-DQqjQHEw.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-LCgUriC1.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-DHdQqBp6.js")).default, n = (await import("./index-C6k3l5OD.js")).default, a = (await import("./index-u6x6oXQW.js")).default, w = (await import("./index-BsQzSgqw.js")).default, p = (await import("./index-B0gJ1M9s.js")).default, r = (await import("./index-DWdlmQ0I.js")).default, b = (await import("./index-Ch4qvY8N.js")).default;
...
//# sourceMappingURL=index-BeHPjITK.js.map
