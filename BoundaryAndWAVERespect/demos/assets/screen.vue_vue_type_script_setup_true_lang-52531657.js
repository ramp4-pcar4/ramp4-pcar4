...
import { bG as defineComponent, bH as useI18n, bI as inject, bJ as ref, bK as onMounted, bL as onBeforeUnmount, bM as computed, bN as resolveComponent, bO as resolveDirective, bP as openBlock, bQ as createBlock, bR as withCtx, bS as createTextVNode, bT as toDisplayString, bU as unref, bV as createVNode, bW as withDirectives, bX as createElementBlock, bY as Fragment, bZ as renderList, b_ as defineAsyncComponent } from './main-23ddedaa.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const legendHeader = defineAsyncComponent(() => __vitePreload(() => import('./header-fd8e3a4c.js'),true?["./header-fd8e3a4c.js","./main-23ddedaa.js","./preload-helper-a4975f27.js","./main-8d5f9fd0.css","./header-9648bea9.css"]:void 0,import.meta.url));
    const legendItem = defineAsyncComponent(() => __vitePreload(() => import('./item-1dcef507.js'),true?["./item-1dcef507.js","./main-23ddedaa.js","./preload-helper-a4975f27.js","./main-8d5f9fd0.css","./marked.esm-4889c960.js","./item-cfa5729b.css"]:void 0,import.meta.url));
    const { t } = useI18n();
