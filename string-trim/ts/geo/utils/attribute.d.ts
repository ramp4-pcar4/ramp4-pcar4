...
import type { Attributes, AttributeSet, BaseGeometry, CompactJson, Extent, FieldDefinition, GetGraphicServiceDetails, RampLayerFieldInfoConfig, RampLayerFieldInfoConfigFields, RampLayerFieldMetadataConfig, TabularAttributeSet } from '@/geo/api';
...
export declare class AttributeAPI extends APIScope {
     ...
     */
    getFieldWithProperTrimming(fieldInfo: RampLayerFieldInfoConfig, attribute: RampLayerFieldInfoConfigFields): string | undefined;
    /**
