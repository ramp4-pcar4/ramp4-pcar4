...
import { bG as defineComponent, bH as useI18n, bI as inject, bJ as ref, bK as onMounted, bL as onBeforeUnmount, bM as computed, bN as resolveComponent, bO as resolveDirective, bP as openBlock, bQ as createBlock, bR as withCtx, bS as createTextVNode, bT as toDisplayString, bU as unref, bV as createVNode, bW as withDirectives, bX as createElementBlock, bY as Fragment, bZ as renderList, b_ as defineAsyncComponent } from './main-d907decb.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const legendHeader = defineAsyncComponent(() => __vitePreload(() => import('./header-26ddce16.js'),true?["./header-26ddce16.js","./main-d907decb.js","./preload-helper-a4975f27.js","./main-41b1eb1b.css","./header-9648bea9.css"]:void 0,import.meta.url));
    const legendItem = defineAsyncComponent(() => __vitePreload(() => import('./item-70b87271.js'),true?["./item-70b87271.js","./main-d907decb.js","./preload-helper-a4975f27.js","./main-41b1eb1b.css","./marked.esm-4889c960.js","./item-c1880561.css"]:void 0,import.meta.url));
    const { t } = useI18n();
