  ...
  setup(__props) {
    ...
    const itemData = () => {
      ...
      for (const [key] of Object.entries(displayMetadata)) {
        if (typeof displayMetadata[key].value === "string" && iApi.ui.isPlainText(displayMetadata[key].value)) {
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const iApi = inject("iApi");
    const itemData = () => {
      let helper = props.identifyData.data.data ? structuredClone(props.identifyData.data.data) : structuredClone(props.identifyData.data);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const itemName = computed(() => {
      ...
      if (typeof returnValue === "string" && iApi.ui.isPlainText(returnValue)) {
...
const _withScopeId = (n) => (pushScopeId("data-v-a7d6d610"), n = n(), popScopeId(), n);
const _hoisted_1$1 = {
  key: 0,
...
const resultList_vue_vue_type_style_index_0_scoped_a7d6d610_lang = '';

const ResultList = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a7d6d610"]]);
