...
import { _ as C, d as A, F as j, G } from "./main-D-hoCQCQ.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-BPbA40QP.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-B8K-HUhR.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-BXarM5kX.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-CXi0fvo1.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-BRw0id47.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-BqwHpsiy.js")))
      }), a;
    }), n = (a) => {
