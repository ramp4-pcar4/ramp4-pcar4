...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-BdpsZiT5.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-DkYG1Fs1.js"), "./icons/edit-icon.vue": () => import("./edit-icon-n-pf2xX9.js"), "./icons/point-icon.vue": () => import("./point-icon-C-WxXElF.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-DKKQ342Q.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-DW5pMRX3.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-CvSvf2Jw.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
