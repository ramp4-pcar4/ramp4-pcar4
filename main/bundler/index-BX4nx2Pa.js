...
import { _ as H, d as L, F as K, G as X } from "./main-Bo2LIhTV.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-56zf57QB.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DbZTj_jq.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DZxN6Pju.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DVKLJPQ6.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-Con2f_sS.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-Cs1hD_cS.js")))
      }), s;
    }), n = (s) => {
