...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-Ca1uw4W0.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-Bq8QJ1he.js"), "./icons/edit-icon.vue": () => import("./edit-icon-dor2Przf.js"), "./icons/point-icon.vue": () => import("./point-icon-B6f5Bg4M.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-uv2W2LEL.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-ByTLkaH1.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-BJmFg7Gp.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
