...
import { _ as H, d as L, F as K, G as X } from "./main-D_7d3wHc.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-ojIDxhDJ.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CtrVOUJe.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CCky0K7f.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DkIqVOTj.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-O64vJPSi.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-D3mwG-Gz.js")))
      }), s;
    }), n = (s) => {
