...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-CyMXTjZO.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-G2Pn71kM.js"), "./icons/edit-icon.vue": () => import("./edit-icon-GvUk8LLA.js"), "./icons/point-icon.vue": () => import("./point-icon-CFHQaceB.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-EQHlif60.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-Dq9dY47I.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-DquVtw0X.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
