import { defineComponent as D, inject as oe, resolveComponent as Pe, createBlock as Xe, openBlock as E, unref as h, withCtx as re, createElementBlock as k, Fragment as Je, renderList as et, createElementVNode as a, createTextVNode as se, createCommentVNode as R, toDisplayString as T, ref as C, onBeforeMount as ve, withDirectives as F, withKeys as V, withModifiers as P, normalizeClass as B, vModelText as ne, vModelSelect as kt, onMounted as Q, nextTick as _e, onBeforeUnmount as X, resolveDirective as U, computed as z, useTemplateRef as Mt, getCurrentInstance as At, watch as Ie, vShow as le, createVNode as Ee, markRaw as Ge } from "vue";
import "tiny-emitter";
import { a as fe, _ as ge, G as Z, W as Ft, X as Tt, L as $t, Y as Rt, Z as tt, $ as ae, i as lt, a0 as Ye, a1 as Le, a2 as St } from "./main-CyMXTjZO.js";
...
const zt = ["onClick"], Ut = { class: "md-icon-small inline" }, Ot = {
  ...
  setup(_) {
    const o = oe("iApi"), { t: e } = H();
    return (r, l) => {
      const n = Pe("dropdown-menu");
      return E(), Xe(n, {
        class: "relative",
        position: "bottom-end",
        ...
        header: re(() => l[0] || (l[0] = [
          a("div", { class: "flex p-8" }, [
            a("svg", {
              ...
              a("g", { id: "format-list-checks_cache966" }, [
                a("path", { d: "M3,5H9V11H3V5M5,7V9H7V7H5M11,7H21V9H11V7M11,15H21V17H11V15M5,20L1.5,16.5L2.91,15.09L5,17.17L9.59,12.59L11,14L5,20Z" })
              ])
            ])
          ], -1)
        ])),
        default: re(() => [
          (E(!0), k(Je, null, et(_.columnDefs.filter(
            (u) => u.headerName && u.headerName.length > 0 && !(!h(o).ui.exposeOids && _.systemCols?.has(u.headerName)) && !(!h(o).ui.exposeMeasurements && (_.systemCols?.has(u.headerName) || _.systemCols?.has(u.field)))
          ), (u) => (E(), k("a", {
            key: u.headerName,
            onClick: (p) => {
              _.columnApi?.setColumnVisible(u.field, u.hide), u.hide = !u.hide, r.$emit("refreshHeaders");
            },
            href: "javascript:;",
            ...
            a("div", Ut, [
              ...
              u.hide ? R("", !0) : (E(), k("svg", Ot, l[1] || (l[1] = [
                a("g", { id: "done" }, [
                  a("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                ], -1)
              ])))
            ])
          ], 8, zt))), 128))
...
class Qe {
   ...
   */
  static onCellKeyPress({ event: o }) {
    function e(r) {
      r.forEach((l) => {
        l.href && window.open(l.href), l.childNodes.length > 0 && e(l.childNodes);
      });
    }
    o.key == "Enter" && e(o.target.childNodes);
  }
  /**
   ...
   */
  constructor(o, e, r) {
    this.element = o, this.agGridApi = e, this.agColumnApi = r, this.agGrid = this.element.querySelector(jt), this.headerRows = Array.prototype.slice.call(
  ...
  initAccessibilityListeners() {
    Array.prototype.slice.call(
      ...
      e.addEventListener("keydown", (n) => {
        this.cellKeydownHandler(n, e, l);
      }), e.addEventListener("blur", (n) => {
        this.cellBlurHandler(n, e, l);
      }), l[l.length - 1].addEventListener("keydown", (n) => {
        this.cellButtonTabHandler(n, e, l, !1);
      }), l[0].addEventListener("keydown", (n) => {
        this.cellButtonTabHandler(n, e, l, !0);
      });
    });
  }
  /**
  ...
  removeAccessibilityListeners() {
    Array.prototype.slice.call(
      ...
      e.removeEventListener("keydown", (n) => {
        ...
        this.cellBlurHandler(n, e, l);
      }), l[l.length - 1].removeEventListener("keydown", (n) => {
        this.cellButtonTabHandler(n, e, l, !1);
      }), l[0].removeEventListener("keydown", (n) => {
        this.cellButtonTabHandler(n, e, l, !0);
      });
    });
  }
   ...
   */
  cellKeydownHandler(o, e, r) {
    o.key === "Enter" && o.target === e && (o.preventDefault(), r.forEach((l) => {
   ...
   * @param {HTMLElement[]} buttons The list of buttons in the cell
   */
  cellBlurHandler(o, e, r) {
    o.target === e && !r.includes(o.relatedTarget) && r.forEach((l) => {
   ...
   */
  cellButtonTabHandler(o, e, r, l) {
    o.key === "Tab" && (l && o.shiftKey || !l && !o.shiftKey) && (o.preventDefault(), e.focus(), r.forEach((n) => {
   ...
   */
  initScrollListeners() {
    this.agGrid.style.cursor = "grab", this.agGrid.addEventListener("mousedown", (o) => {
      this.scrollMouseDownHandler(o);
    });
  }
  /**
  ...
  removeScrollListeners() {
    this.agGrid.style.cursor = "default", this.agGrid.removeEventListener("mousedown", (o) => {
      this.scrollMouseDownHandler(o);
    });
  }
  /**
   ...
   */
  scrollMouseDownHandler(o) {
    const e = this.element.querySelector(".ag-body-horizontal-scroll-viewport"), r = e.scrollLeft, l = o.clientX;
    this.agGrid.style.cursor = "grabbing";
    const n = (p) => {
      const m = p.clientX - l;
      e.scrollLeft = r - m;
    }, u = () => {
      this.agGrid.style.cursor = "grab", this.agGrid.removeEventListener("mousemove", n), this.agGrid.removeEventListener("mouseup", u), this.agGrid.removeEventListener("mouseleave", u);
    };
    this.agGrid.addEventListener("mousemove", n), this.agGrid.addEventListener("mouseup", u), this.agGrid.addEventListener("mouseleave", u);
  }
}
function Wt(_) {
  const o = _.previousHeaderPosition.column, e = _.previousHeaderPosition.headerRowIndex;
  let r = _.backwards ? e - 1 : e + 1;
  return r === -1 ? null : (r === _.headerRowCount && (r = -1), { headerRowIndex: r, column: o });
}
function Yt(_) {
...
const Zt = { class: "h-full flex items-center justify-center" }, Qt = ["placeholder", "aria-label", "disabled"], Xt = ["placeholder", "aria-label", "disabled"], Jt = {
  ...
  props: ["params"],
  setup(_) {
    const o = fe(), { t: e } = H(), r = _, l = C(""), n = C(""), u = C(r.params.stateManager.columns[r.params.column.colDef.field].filter.static), p = () => {
      l.value = l.value !== "" && !isNaN(l.value) ? l.value : null, r.params.parentFilterInstance((w) => {
        b(w), r.params.stateManager.setColumnFilterValue(r.params.column.colDef.field, l.value, "min");
      });
    }, m = () => {
      n.value = n.value !== "" && !isNaN(n.value) ? n.value : null, r.params.parentFilterInstance((w) => {
        b(w), r.params.stateManager.setColumnFilterValue(r.params.column.colDef.field, n.value, "max");
      });
    }, b = (w) => {
      (isNaN(l.value) || l.value === null) && (l.value = ""), (isNaN(n.value) || n.value === null) && (n.value = ""), n.value !== "" && l.value !== "" ? w.setModel({
        filterType: "number",
        type: "inRange",
        filter: l.value,
        filterTo: n.value
        ...
        filter: l.value
      }) : w.setModel(null), r.params.api.onFilterChanged();
    };
    return ve(() => {
      l.value = r.params.stateManager.getColumnFilterValue(r.params.column.colDef.field, "min"), n.value = r.params.stateManager.getColumnFilterValue(r.params.column.colDef.field, "max"), p(), m();
    }), (w, y) => (E(), k("div", Zt, [
      F(a("input", {
      ...
      y[10] || (y[10] = a("span", { class: "w-12" }, null, -1)),
      F(a("input", {
        ...
        style: { width: "45%" },
        type: "number",
        "onUpdate:modelValue": y[5] || (y[5] = (L) => n.value = L),
        onInput: y[6] || (y[6] = (L) => m()),
  ...
  props: ["params"],
  setup(_) {
    const o = fe(), { t: e } = H(), r = _, l = C(""), n = C(r.params.stateManager.columns[r.params.column.colDef.field].filter.static), u = () => {
      r.params.parentFilterInstance((p) => {
        l.value = l.value ? l.value : "", p.setModel({
          filterType: "text",
          type: "contains",
          filter: l.value
        }), r.params.stateManager.setColumnFilterValue(r.params.column.colDef.field, l.value), r.params.api.onFilterChanged();
      });
    };
    return ve(() => {
      l.value = r.params.stateManager.getColumnFilterValue(r.params.column.colDef.field), u();
    }), (p, m) => (E(), k("div", ll, [
      F(a("input", {
  ...
  props: ["params"],
  setup(_) {
    const o = _, e = C(""), r = C([]), l = C(o.params.stateManager.columns[o.params.column.colDef.field].filter.static), n = () => {
      e.value = e.value ? e.value : "", o.params.parentFilterInstance((u) => {
        e.value === "..." ? (u.setModel(null), e.value = "") : u.setModel({
          filterType: "text",
          type: "contains",
          filter: e.value
        }), o.params.stateManager.setColumnFilterValue(o.params.column.colDef.field, e.value), o.params.api.onFilterChanged();
      });
    };
    return ve(() => {
      e.value = o.params.stateManager.getColumnFilterValue(o.params.column.colDef.field);
      let u = o.params.rowData;
      u = u.map((p) => p[o.params.column.colId]), r.value = u.filter((p, m) => u.indexOf(p) === m), r.value.unshift("..."), n();
    }), (u, p) => (E(), k("div", nl, [
      F(a("select", {
        ...
        onChange: p[1] || (p[1] = (m) => n()),
        onMousedown: p[2] || (p[2] = P(() => {
        }, ["stop"])),
        "aria-label": e.value,
        disabled: l.value
      }, [
        (E(!0), k(Je, null, et(r.value, (m) => (E(), k("option", {
          value: m,
          key: m
        }, T(m), 9, il))), 128))
      ], 42, ol), [
  ...
  setup(_) {
    const o = fe(), { t: e } = H(), r = _, l = C(""), n = C(""), u = C(r.params.stateManager.columns[r.params.column.colDef.field].filter.static), p = () => {
      r.params.parentFilterInstance((w) => {
        b(w), r.params.stateManager.setColumnFilterValue(r.params.column.colDef.field, l.value, "min");
      });
    }, m = () => {
      r.params.parentFilterInstance((w) => {
      ...
      n.value === "" && l.value === "" ? w.setModel(null) : n.value !== "" && l.value !== "" ? w.setModel({
        filterType: "date",
        type: "inRange",
        dateFrom: l.value,
        dateTo: n.value
  ...
  props: ["params"],
  setup(_) {
    const o = _, { t: e } = H(), r = C(), l = () => o.params.clearFilters();
    return Q(async () => {
      await _e();
      const n = r.value?.closest(".ag-header-cell"), u = n.closest(".ag-pinned-left-header");
      n.addEventListener("keydown", async (p) => {
      ...
      const n = r.value?.closest(".ag-header-cell"), u = n.closest(".ag-pinned-left-header");
      n.removeEventListener("keydown", async (p) => {
        p.key === "Enter" && (p.stopPropagation(), l(), await _e(), u.querySelector(".ag-header-cell.ag-floating-filter").focus());
      }), n.removeEventListener("focus", () => {
        r.value._tippy.show();
      }), n.removeEventListener("blur", () => {
        r.value._tippy.hide();
      });
    }), (n, u) => {
      const p = U("tippy");
      return F((E(), k("button", {
        ...
        a("svg", {
          ...
          a("g", null, [
            a("g", null, [
              a("path", { d: "M19.79,5.61C20.3,4.95,19.83,4,19,4H6.83l7.97,7.97L19.79,5.61z" }),
              a("path", { d: "M2.81,2.81L1.39,4.22L10,13v6c0,0.55,0.45,1,1,1h2c0.55,0,1-0.45,1-1v-2.17l5.78,5.78l1.41-1.41L2.81,2.81z" })
            ])
          ])
        ], -1)
      ]), 8, yl)), [
  ...
  props: ["params"],
  setup(_) {
    const { t: o } = H(), e = _, r = C(), l = C(0), n = C(!1), u = C(!1), p = C(!1), m = C(null), b = () => {
      ...
      u.value && (m.value.moveColumn(e.params.column, A), e.params.api.ensureColumnVisible(M[A]), r.value?.closest(".ag-header-row")?.querySelector(`[col-id="${e.params.column.colId}"]`)?.querySelector(".move-left")?.focus());
    }, y = () => {
      const c = m.value.getAllDisplayedColumns(), M = m.value.getAllGridColumns(), A = M.indexOf(c[c.indexOf(e.params.column) + 1]);
    ...
    return Q(() => {
      n.value = e.params.column.colDef.sortable, m.value = e.params.columnApi, e.params.sort === "asc" ? (l.value = 1, e.params.setSort("asc")) : e.params.sort === "desc" && (l.value = 2, e.params.setSort("desc")), b(), e.params.column.addEventListener("leftChanged", () => {
        b();
      });
    }), X(() => {
      ...
      return E(), k("div", {
        ...
        n.value ? (E(), k("div", wl, [
          F((E(), k("button", {
            type: "button",
            onClick: M[0] || (M[0] = (J) => L(J)),
            content: h(o)(`grid.header.sort.${l.value}`),
            "aria-label": h(o)(`grid.header.sort.${l.value}`),
            class: "customHeaderLabel hover:bg-gray-300 font-bold p-8 max-w-full",
            role: "columnheader",
            tabindex: "-1"
          }, [
            F((E(), k("div", null, [
              se(T(_.params.displayName), 1)
            ])), [
              [A, { externalTrigger: !0 }]
            ])
          ], 8, xl)), [
            [O, { placement: "top", hideOnClick: !1 }]
          ])
        ])) : F((E(), k("span", Cl, [
          se(T(_.params.displayName), 1)
        ])), [
        ...
        n.value ? (E(), k("div", Ll, [
          ...
          _.params.enableSorting && l.value === 1 ? (E(), k("span", El, M[3] || (M[3] = [
            a("div", { class: "md-icon-small" }, [
              a("svg", {
                height: "24",
                width: "24"
              }, [
                a("g", { id: "arrow_upward" }, [
                  a("path", { d: "M4 12l1.41 1.41L11 7.83V20h2V7.83l5.58 5.59L20 12l-8-8-8 8z" })
                ])
              ])
            ], -1)
          ]))) : R("", !0),
          _.params.enableSorting && l.value === 2 ? (E(), k("span", kl, M[4] || (M[4] = [
            a("div", { class: "md-icon-small" }, [
              a("svg", {
                ...
                a("g", { id: "arrow_downward" }, [
                  a("path", { d: "M20 12l-1.41-1.41L13 16.17V4h-2v12.17l-5.58-5.59L4 12l8 8 8-8z" })
                ])
              ])
            ], -1)
          ]))) : R("", !0),
          F((E(), k("button", {
            type: "button",
            content: h(o)("grid.header.reorder.left"),
            "aria-label": h(o)("grid.header.reorder.left"),
            onClick: M[1] || (M[1] = (J) => w()),
            ...
            a("div", { class: "inline-block" }, [
              a("svg", {
                ...
                a("g", { id: "keyboard_arrow_left" }, [
                  a("path", { d: "M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z" })
                ])
              ])
            ], -1)
          ]), 8, Ml)), [
          ...
          F((E(), k("button", {
            type: "button",
            content: h(o)("grid.header.reorder.right"),
            "aria-label": h(o)("grid.header.reorder.right"),
            onClick: M[2] || (M[2] = (J) => y()),
            ...
            a("div", { class: "inline-block" }, [
              a("svg", {
                ...
                a("g", { id: "keyboard_arrow_right" }, [
                  a("path", { d: "M8.59 16.34l4.58-4.59-4.58-4.59L10 5.75l6 6-6 6z" })
                ])
              ])
            ], -1)
          ]), 8, Al)), [
  ...
  props: ["params"],
  setup(_) {
    const o = _, { t: e } = H(), r = oe("iApi"), l = C(), n = async () => {
      const u = o.params.data, p = u.rvUid, m = r.geo.layer.getLayer(p), b = m.oidField, y = o.params.layerCols[m.id].find(
        (c) => c.origAttr === b
      ...
      r.event.emit(
        ...
        !0
      ), o.params.isTeleport && r.scrollToInstance();
    };
    return Q(() => {
      o.params.eGridCell.addEventListener("keydown", (u) => {
        u.key === "Enter" && n();
      ...
      o.params.eGridCell.removeEventListener("keydown", (u) => {
        u.key === "Enter" && n();
  ...
  props: ["params"],
  setup(_) {
    const o = C("none"), e = _, r = oe("iApi"), l = Tt(), n = C(), { t: u } = H(), p = z(() => {
      ...
      const y = e.params.layerCols[w.id].find((M) => M.origAttr === w.oidField), L = e.params.data[y ? y.mappedAttr ?? y.origAttr : w.oidField], c = () => {
        ...
        w.getGraphic(L, M).then((A) => {
          A.geometry.invalid() ? (console.error(`Could not find graphic for objectid ${L}`), b("error")) : (r.geo.map.zoomMapTo(A.geometry), b("zoomed"), r.updateAlert(r.$i18n.t("grid.cells.alert.zoom")), e.params.isTeleport && r.scrollToInstance());
        }).catch(() => {
          b("error");
        });
      };
      w.layerType === $t.FEATURE && w.geomType !== Rt.POINT ? w.getGraphicExtent(L).then((M) => {
        r.geo.map.zoomMapTo(M), b("zoomed"), r.updateAlert(r.$i18n.t("grid.cells.alert.zoom")), e.params.isTeleport && r.scrollToInstance();
      }).catch(() => {
        c();
      }) : c();
    }, b = (w) => {
      w === "zoomed" || w === "error" ? setTimeout(() => {
        o.value = w, n.value?._tippy.show(), setTimeout(() => {
          n.value?._tippy.hide(), o.value = "none";
        }, 3e3);
      }, 300) : o.value = w;
    };
    return Q(() => {
      p.value && (e.params.eGridCell.addEventListener("keydown", (w) => {
        w.key === "Enter" && o.value === "none" && m();
      ...
      return p.value ? F((E(), k("button", {
        ...
        type: "button",
        class: "flex items-center justify-center w-40 h-36",
        content: h(u)(`grid.cells.zoom${o.value === "none" ? "" : `.${o.value}`}`),
        onClick: m,
        tabindex: "-1",
        ref_key: "button",
        ref: n,
        "aria-label": h(u)(`grid.cells.zoom${o.value === "none" ? "" : `.${o.value}`}`)
      }, [
        o.value === "zooming" ? (E(), k("div", Sl)) : o.value === "zoomed" ? (E(), k("svg", Dl, y[0] || (y[0] = [
          a("path", {
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
            d: "M4.5 12.75l6 6 9-13.5"
          }, null, -1)
        ]))) : o.value === "error" ? (E(), k("svg", Il, y[1] || (y[1] = [
          a("path", {
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
  ...
  props: ["params"],
  setup(_) {
    const o = _, e = oe("iApi"), r = C(), l = z(() => {
      const u = Object.assign({}, o.params.data), p = e.geo.layer.getLayer(u.rvUid), m = o.params.config.displayOn;
      return !(!p || m === "geo" && !p.mapLayer || m === "data" && p.mapLayer);
    }), n = () => {
      const u = Object.assign({}, o.params.data), p = e.geo.layer.getLayer(u.rvUid), m = o.params.layerCols[p.id].find((w) => w.origAttr === p.oidField), b = m.mappedAttr ? u[m.mappedAttr] : u[m.origAttr];
      p.getGraphic(b, { getAttribs: !0 }).then((w) => {
        e.event.emit(o.params.config.actionEvent, {
          data: w.attributes,
          layer: p,
          uid: o.params.data.rvUid,
          oid: b
        });
      });
    };
    return Q(() => {
      ...
      return l.value ? F((E(), k("button", {
        ...
        content: o.params.config.tooltip,
        onClick: n,
        tabindex: "-1",
        ref_key: "el",
        ref: r
        ...
        a("span", {
          innerHTML: o.params.config.icon
        }, null, 8, Hl)
      ], 8, Pl)), [
        [m, { placement: "top" }]
      ]) : R("", !0);
  ...
  props: ["params"],
  setup(_) {
    const o = fe(), e = oe("iApi"), { t: r } = H(), l = C(), n = C(), u = C(!1), p = _, m = z(() => o.mobileView), b = () => {
      n.value?.textContent && (u.value = !0, l.value?._tippy.show(), navigator.clipboard.writeText(n.value?.textContent), setTimeout(() => {
        u.value = !1;
      }, 2e3));
    }, w = z(() => p.params.type === "number" ? p.params.value == null ? "" : e.ui.formatNumber(p.params.value) : p.params.type === "date" ? p.params.value == null ? "" : new Date(p.params.value).toISOString().slice(0, 10) : p.params.type === "string" ? !p.params.value || /<a[^>]*>[^<]+<\/a>/g.test(p.params.value) ? p.params.value : Dt(p.params.value, {
      target: "_blank",
      validate: {
        url: (L) => /^https?:\/\//.test(L)
        // only links that begin with a protocol will be hyperlinked
      }
    }) : ""), y = z(() => /<a[^>]*>[^<]+<\/a>/g.test(p.params.value) || /(http(s)?:\/\/.*)/g.test(p.params.value));
    return Q(() => {
      p.params.eGridCell.addEventListener("dblclick", () => {
        ...
        n.value._tippy.hide(), l.value?._tippy.hide();
      }), p.params.eGridCell.addEventListener("focus", () => {
        n.value?._tippy.show(), setTimeout(() => {
          document.activeElement === p.params.eGridCell && l.value?._tippy.show();
        }, 1e3), n.value._tippy.reference.clientWidth >= n.value._tippy.reference.scrollWidth && n.value._tippy.hide();
      });
    }), X(() => {
      p.params.eGridCell.removeEventListener("dblclick", () => {
        ...
        n.value._tippy.show(), l.value?._tippy.show();
      });
    }), (L, c) => {
      ...
      return E(), k("div", null, [
        ...
        n.value?.textContent ? F((E(), k("div", {
          key: 0,
          ref_key: "copyTooltip",
          ref: l,
          content: h(r)(`grid.label.${u.value ? "copied" : "copy"}`)
        }, null, 8, zl)), [
          [A, {
            triggerTarget: n.value,
            placement: "bottom",
            theme: "ramp4",
            hideOnClick: !1,
            delay: [1e3, 0]
...
}, oa = ["aria-label"], ia = { class: "pb-2 flex ml-auto justify-end" }, ua = ["content", "aria-label"], da = ["aria-label"], pa = { class: "md-icon-small flex flex-nowrap items-center gap-x-4" }, ca = { class: "grow" }, ma = {
  key: 0,
  height: "18",
  width: "18",
  viewBox: "0 0 24 24"
}, va = ["aria-label"], fa = { class: "md-icon-small flex flex-nowrap items-center gap-x-4" }, ga = { class: "grow" }, ha = {
  key: 0,
  height: "18",
  width: "18",
  viewBox: "0 0 24 24"
  ...
  width: "18",
  viewBox: "0 0 24 24"
}, Ca = ["aria-label"], La = { class: "md-icon-small flex flex-nowrap items-center gap-x-4" }, _a = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  width: "18",
  viewBox: "0 0 24 24"
}, Aa = ["aria-label"], Fa = { class: "md-icon-small flex flex-nowrap items-center gap-x-4" }, Ta = { class: "grow" }, $a = ["content"], Ra = /* @__PURE__ */ D({
  ...
  setup(_) {
    const o = [ae.OID, ae.DOUBLE, ae.SINGLE, ae.INTEGER], e = oe("iApi"), r = lt(), l = fe(), n = z(() => l.mobileView), u = C(!n.value), p = C(), m = Mt("gridContainer"), { t: b, locale: w } = H(), y = () => At()?.proxy?.$forceUpdate(), L = _, c = C({
      id: "dummy",
      layerIds: [],
      state: new Gt(),
      fieldMap: {}
    }), M = C(!0), A = C(new Nt()), O = C(), J = C(), K = C(!1), ee = C(!1), ie = C([]), ke = C(0), q = C([]), he = C([]), Me = C(""), I = C(new Bt()), te = C([]), ue = C([]), ye = C("OBJECTID"), Ae = C(void 0), at = Qe.onCellKeyPress, j = C({ firstRow: 0, lastRow: 0, visibleRows: 0 }), be = C({}), rt = e.geo.layer.getLayer(L.gridId), de = C({}), st = C(r.grids[L.gridId].layerIds), G = z(() => r.grids[L.gridId] ? r.grids[L.gridId].layerIds.map((s) => e.geo.layer.getLayer(s)).filter((s) => s !== void 0) : []), Fe = C(/* @__PURE__ */ new Set()), we = C([]), xe = () => {
      ...
      A.value = s.api, I.value = s.columnApi, Me.value = c.value.state.title || rt?.name || L.gridId, $e(), ue.value.length > 0 && I.value.autoSizeAllColumns(), xe(), A.value.addEventListener("rowDataChanged", xe), q.value.push(
        e.event.on(Z.FILTER_CHANGE, ({ uid: t, filterKey: v }) => {
          v !== Le.GRID && t && G.value.map((i) => i.uid).includes(t) && W();
        })
      ), q.value.push(
        e.event.on(
          Z.LAYER_VISIBILITYCHANGE,
          ({ layer: t }) => {
            t.uid && G.value.map((v) => v.uid).includes(t.uid) && W();
          }
        )
      ), q.value.push(
        e.event.on(Z.LAYER_RELOAD_END, (t) => {
          t.loadPromise().then(() => {
            G.value.map((v) => v.uid).includes(t.uid) && W();
          });
        })
      ), q.value.push(
        e.event.on(Z.LANG_CHANGE, () => {
          A.value.redrawRows({
            force: !0
          });
        })
        ...
        e.event.on(
          Z.MAP_EXTENTCHANGE,
          Ze(100, () => {
            c.value.state.filterByExtent && W();
          })
        )
      ), q.value.push(
        e.event.on(Z.LAYER_REMOVE, (t) => {
      ...
      c.value.state.filterByExtent = !c.value.state.filterByExtent, W();
    }, dt = () => {
      const s = O.value.api.getColumnDefs();
      c.value.state.colFilter = !c.value.state.colFilter, s.forEach((t) => {
        t.floatingFilter = c.value.state.colFilter;
      }), O.value.api.setColumnDefs(s);
    }, $e = () => {
      A.value && !K.value && (c.value.state.searchFilter !== "" && Te(), c.value.state.applyToMap && Re(), _e(() => {
        const s = I.value.getAllDisplayedColumns();
        O.value.api.refreshCells({
          columns: [s[0]]
          // Limits the refresh action to the row number column.
        }), Ne();
      }));
    }, Ne = () => {
      j.value.firstRow = A.value.getFirstDisplayedRow() + 1, j.value.lastRow = A.value.getLastDisplayedRow() + 1, j.value.visibleRows = A.value.getDisplayedRowCount();
    }, Be = () => {
      A.value.setFilterModel({}), c.value.state.clearFilters(), A.value.refreshHeader();
    }, pt = () => {
      u.value = !u.value;
      const s = u.value ? "left" : null, t = I.value.getAllDisplayedColumns();
      I.value.setColumnsPinned(t.slice(1, 3), s);
    }, ct = () => {
      const s = I.value.getAllDisplayedColumns().filter((i) => !i.getColDef().preventExport), t = document.createElement("p"), v = (i) => (t.innerHTML = i, t.textContent || t.innerText);
      ...
      s.floatingFilterComponent = "dateFloatingFilter", s.filterParams.comparator = function(v, i) {
        const d = new Date(i);
      ...
      s.floatingFilterComponent = "textFloatingFilter", s.floatingFilterComponentParams = {
        suppressFilterButton: !0,
        stateManager: t
      }, s.filterParams.textMatcher = function(i) {
      ...
      s.filterParams.textFormatter = function(i) {
        return v(i);
      };
    }, ht = (s, t, v) => {
    ...
    }, yt = () => !Object.values(be.value).every((s) => s === void 0), bt = (s) => {
      const t = be.value[s.data.rvUid];
      return t === void 0 || t.includes(s.data[ye.value]);
    }, W = async () => {
      const s = new St(), t = we.value.slice().map((i) => i.getPromise());
      ...
      G.value.filter((s) => s.mapLayer).forEach((s) => {
        if (!c.value.state.applyToMap)
          s.setSqlFilter(Le.GRID, "");
        else {
          const t = xt(s.id);
          s.setSqlFilter(Le.GRID, t);
        }
      });
    }, xt = (s) => {
      ...
      const v = c.value.state.searchFilter.replace(/'/g, "''").split(" "), i = A.value.rowModel.rowsToDisplay, d = I.value.getAllDisplayedColumns().filter(
        (x) => (x.colDef.filter === "agTextColumnFilter" || x.colDef.filter === "agNumberColumnFilter") && Se(s, x.getColId())
      ), f = [];
      return i.forEach((x) => {
        let S = !0, g = "";
        for (const $ of v) {
          ...
          let ce = !1;
          for (const De of d) {
            const me = De.getColId(), Ce = Se(s, De.getColId())?.origAttr, We = De.getColDef();
            if (x.data[me] === void 0)
              ce = !1;
            else if (We.filter === "agTextColumnFilter") {
              const Y = x.data[me] === null ? null : x.data[me].toString();
              ...
              const Y = x.data[me] === null ? null : x.data[me];
              if (Y !== null && pe.test(Y)) {
                g ? g = g.concat(" AND ", `(${Ce} = ${Y})`) : g = g.concat("(", `(${Ce} = ${Y})`), ce = !f.includes(g + ")");
                break;
              }
            }
          }
      ...
      (K.value || ee.value) && G.value.forEach((s) => {
        s.abortAttributeLoad(), s.clearFeatureCache();
      });
    }, N = z(() => {
      const s = G.value.map((i) => i.visibility && i.canModifyLayer && i.mapLayer), t = G.value.some(
    ...
    ), Se = (s, t) => de.value[s].find((v) => (v.mappedAttr ?? v.origAttr) === t), Oe = () => {
      const s = G.value.filter(
        (t) => t && t.supportsFeatures && t.isLoaded
      );
      s.length === 0 && ze(), ke.value = s.reduce((t, { featureCount: v }) => t + v, 0), ie.value = new Array(G.value.length).fill(0), s.forEach((t, v) => ie.value[v] += t.downloadedAttributes()), s.forEach((t, v) => {
        he.value.push(
          Ie(
        ...
        const t = s.map((v) => Ge(v).getTabularAttributes().then((i) => {
        ...
        Promise.all(t).then((v) => {
          if (s.every((d) => d.attribLoadAborted())) {
            K.value = !1;
            return;
          }
          const i = {
          ...
          v.forEach((d, f) => {
            ...
            d === "rvRowIndex" || d === "rvSymbol" || d === "rvInteractive" ? ht(x, te.value, c.value.state) : (o.indexOf(S.type) > -1 ? (ft(x, c.value.state), x.filter = "agNumberColumnFilter", x.autoHeight = !0, x.cellRenderer = f.template === "" ? Ve : e.component(f.template), x.cellRendererParams = {
              type: "number"
            }) : S.type === ae.DATE ? (mt(x, c.value.state), x.filter = "agDateColumnFilter", x.autoHeight = !0, x.minWidth = 400, x.cellRenderer = f.template === "" ? Ve : e.component(f.template), x.cellRendererParams = {
              type: "date"
            }) : S.type === ae.STRING && (x.isSelector ? vt(x, i.rows, c.value.state) : gt(x, c.value.state), x.filter = "agTextColumnFilter", x.autoHeight = !0, x.cellRenderer = f.template === "" ? Ve : e.component(f.template), x.cellRendererParams = {
              type: "string"
            }), te.value.push(x));
          }), ue.value = Ge(i.rows), te.value = Ge(te.value), $e(), K.value = !1;
        }).catch((v) => {
          console.error(v), ee.value = !0, K.value = !1;
        });
      });
    }, Ke = (s) => {
      s.key === "Tab" && m.value?.matches(":focus") && m.value._tippy.show();
    }, je = () => {
      m.value._tippy.hide();
    };
    return Q(() => {
      ...
      c.value = r.grids[L.gridId], K.value = !0, y(), j.value = {
        firstRow: 0,
        lastRow: 0,
        visibleRows: 0
      }, J.value = {
        ...
        onBodyScroll: () => {
          [...e.$vApp.$el.querySelectorAll("[id^=tippy]")].forEach((s) => {
            s._tippy && p.value?.contains(s._tippy.reference) && s._tippy.hide();
          });
        },
        onBodyScrollEnd: () => {
          Ne();
      ...
      }, Oe(), N.value === "partial" && e.notify.show(Ye.WARNING, e.$i18n.t("layer.filterwarning")), he.value.push(
        Ie(w, () => {
        ...
        Ie(N, (s) => {
          s === "partial" && e.notify.show(Ye.WARNING, e.$i18n.t("layer.filterwarning"));
        })
      );
    }), X(() => {
      Ue(), q.value.forEach((s) => e.event.off(s)), he.value.forEach((s) => s()), Ae.value?.removeAccessibilityListeners(), Ae.value?.removeScrollListeners(), m.value?.removeEventListener("keyup", Ke), m.value?.removeEventListener("blur", je);
    }), (s, t) => {
      const v = Pe("dropdown-menu"), i = U("truncate"), d = U("tippy");
      return E(), k("div", {
        ...
        F(a("div", null, [
          a("p", Ul, T(h(b)("grid.splash.error")), 1)
        ], 512), [
          [le, ee.value]
        ]),
        F(a("div", Ol, [
          a("div", Kl, [
            a("span", jl, T(ie.value.reduce((f, x) => f + x, 0)), 1),
            t[12] || (t[12] = a("svg", {
            ...
            a("span", ql, T(ke.value), 1)
          ]),
          a("div", Wl, [
            a("span", Yl, T(ie.value.reduce((f, x) => f + x, 0) < ke.value ? h(b)("grid.splash.loading") : h(b)("grid.splash.building")), 1)
          ]),
          a("div", null, [
            a("button", {
              type: "button",
        ...
        F(a("div", Ql, [
          a("div", Xl, [
            ...
            F((E(), k("div", ea, [
              se(T(h(b)("grid.filters.label.info", {
                range: j.value.visibleRows !== 0 ? `${j.value.firstRow} - ${j.value.lastRow}` : "0",
                total: j.value.visibleRows
              })) + " ", 1),
              j.value.visibleRows !== ue.value.length ? (E(), k("span", ta, T(h(b)("grid.filters.label.filtered", {
                max: ue.value.length
              })), 1)) : R("", !0)
            ])), [
              [i]
              ...
              Ee(v, {
                ...
                header: re(() => t[16] || (t[16] = [
                  a("svg", {
                    ...
                    a("path", { d: "M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" })
                  ], -1)
                ])),
                default: re(() => [
                  a("a", {
                    ...
                    class: B(["leading-snug w-256", {
                      hover: N.value !== "disabled" ? "none" : "text-black",
                      disabled: N.value === "disabled"
                    }]),
                    onClick: t[7] || (t[7] = (f) => N.value !== "disabled" && wt()),
                    role: "button",
                  ...
                  a("a", {
                    ...
                    a("div", fa, [
                      t[20] || (t[20] = a("svg", {
                        ...
                        a("path", { d: "M 3,2L 20.9888,2L 21,2L 21,2.01122L 21,3.99999L 20.9207,3.99999L 14,10.9207L 14,22.909L 9.99999,18.909L 10,10.906L 3.09405,3.99999L 3,3.99999L 3,2 Z " })
                      ], -1)),
                      a("span", ga, T(h(b)("grid.label.filters.show")), 1),
                      c.value.state.colFilter ? (E(), k("svg", ha, t[19] || (t[19] = [
                        a("g", { id: "done" }, [
                          a("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : R("", !0)
                  ...
                  a("a", {
                    ...
                    onClick: t[9] || (t[9] = (f) => N.value !== "disabled" && ut()),
                    role: "button",
                    ...
                    a("div", ba, [
                      t[22] || (t[22] = a("svg", {
                        ...
                        a("path", { d: "M 4 10 Z M 2 2 L 19.9888 2 L 20 2 L 20 2.0112 L 20 4 L 19.9207 4 L 13 10.9207 L 13 22.909 L 9 18.909 L 9 10.906 L 2.0941 4 L 2 4 L 2 2 Z M 24 13 L 21 14 L 18 13 L 15 14 V 22 L 18 21 l 3 1 l 3 -1 z M 21 21 l -3 -1 V 14 l 3 1.055 z" })
                      ], -1)),
                      a("span", wa, T(h(b)("grid.filters.label.extent")), 1),
                      N.value !== "disabled" && c.value.state.filterByExtent ? (E(), k("svg", xa, t[21] || (t[21] = [
                        a("g", { id: "done" }, [
                          a("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : R("", !0)
                  ...
                  a("a", {
                    ...
                    a("div", La, [
                      u.value ? (E(), k("svg", _a, t[23] || (t[23] = [
                        a("path", { d: "M18,8H17V6A5,5 0 0,0 12,1A5,5 0 0,0 7,6V8H6A2,2 0 0,0 4,10V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V10A2,2 0 0,0 18,8M12,3A3,3 0 0,1 15,6V8H9V6A3,3 0 0,1 12,3Z" }, null, -1)
                      ]))) : u.value ? R("", !0) : (E(), k("svg", Ea, t[24] || (t[24] = [
                        a("path", { d: "M18 1.5c2.9 0 5.25 2.35 5.25 5.25v3.75a.75.75 0 01-1.5 0V6.75a3.75 3.75 0 10-7.5 0v3a3 3 0 013 3v6.75a3 3 0 01-3 3H3.75a3 3 0 01-3-3v-6.75a3 3 0 013-3h9v-3c0-2.9 2.35-5.25 5.25-5.25z" }, null, -1)
                      ]))),
                      a("span", ka, T(h(b)("grid.label.pinColumns")), 1),
                      u.value ? (E(), k("svg", Ma, t[25] || (t[25] = [
                        a("g", { id: "done" }, [
                          a("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : R("", !0)
                  ...
                  a("a", {
                    ...
                    a("div", Fa, [
                      t[26] || (t[26] = a("svg", {
                        ...
                        a("g", null, [
                          a("path", { d: "M6 2c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6H6zm7 7V3.5L18.5 9H13z" })
                        ])
                      ], -1)),
                      a("span", Ta, T(h(b)("grid.label.export")), 1)
                    ])
                  ], 8, Aa)
                ]),
                _: 1
...
}), Sa = /* @__PURE__ */ ge(Ra, [["__scopeId", "data-v-02ea309b"]]), Da = /* @__PURE__ */ D({
  __name: "screen",
  props: {
    panel: {
      type: tt,
  ...
  setup(_) {
    const o = lt(), { t: e } = H(), r = z(() => o.currentId);
    return (l, n) => {
      const u = Pe("panel-screen");
      return E(), Xe(u, { panel: _.panel }, {
        header: re(() => [
          se(T(h(e)("grid.title")), 1)
        ]),
        content: re(() => [
          Ee(Sa, {
            class: "rv-grid",
...
}), _r = /* @__PURE__ */ ge(Da, [["__scopeId", "data-v-904e67ef"]]);
export {
  _r as default
};
