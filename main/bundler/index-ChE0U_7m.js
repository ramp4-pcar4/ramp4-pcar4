...
import { _ as H, d as L, F as K, G as X } from "./main-ZtcIRjvM.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Cx4E8Or6.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BVV9Cl1L.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-gOmEJEDs.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-B5d-yvCO.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-D8LrNLTk.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CSaRLOfc.js")))
      }), s;
    }), n = (s) => {
