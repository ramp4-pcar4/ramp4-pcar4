import { createElementBlock as r, openBlock as e, defineComponent as O, inject as S, resolveComponent as T, createVNode as y, unref as d, withCtx as M, createElementVNode as m, markRaw as f, defineAsyncComponent as g, computed as E, Fragment as z, renderList as F, createBlock as w, normalizeStyle as R, normalizeClass as G, resolveDynamicComponent as I, ref as $, onMounted as Q, nextTick as U, onBeforeUnmount as J, resolveDirective as V, withDirectives as P, createCommentVNode as _ } from "vue";
import { _ as H, d as L, F as K, G as X } from "./main-DFkDtyEK.js";
...
const W = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ O({
  ...
  setup(b) {
    const i = S("iApi"), { t } = N(), o = ee(), p = [
      {
        type: "point",
        icon: f(g(() => import("./point-icon-CEahwmah.js")))
      },
      {
        type: "polyline",
        icon: f(g(() => import("./polyline-icon-D2awTRaE.js")))
      },
      {
        type: "polygon",
        icon: f(g(() => import("./polygon-icon-BTK1kyzK.js")))
      },
      {
        type: "circle",
        icon: f(g(() => import("./circle-icon-CXB0UeUm.js")))
      },
      {
        type: "rectangle",
        icon: f(g(() => import("./rectangle-icon-Bh4Vyt-_.js")))
      }
    ], a = E(() => {
      const s = p.filter((v) => o.supportedTypes.some((x) => x.type === v.type));
      return s.push({
        type: "edit",
        icon: f(g(() => import("./edit-icon-V3QarSAV.js")))
      }), s;
    }), n = (s) => {
    ...
    return (s, v) => {
      ...
      return e(), r("div", ae, [
        (e(!0), r(z, null, F(a.value, (u, C) => (e(), w(x, {
          ...
          style: R({ marginBottom: C !== a.value.length - 1 ? "0px" : "0" })
        }, {
          default: M(() => [
    ...
    return (c, h) => {
      ...
      return e(), r("div", re, [
            ...
            l.value <= v.value ? (e(), w(Y, {
              ...
              default: M(() => [
                (e(), r("svg", {
                  ...
                  class: G(["fill-current w-6 mx-auto transition-all transform", { "rotate-180": s.value }])
                }, h[1] || (h[1] = [
        ...
        l.value <= v.value && s.value ? P((e(), r("div", {
          ...
          style: R({ maxHeight: `${(l.value - 70) * 0.8}px`, height: "fit-content", width: "fit-content" }),
          content: d(p)("panels.controls.items")
        }, [
          n.value ? (e(), r("div", ve, [
            y(j)
