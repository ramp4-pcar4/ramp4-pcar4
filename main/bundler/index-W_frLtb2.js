...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-CBWdV-Iy.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-9OCnoyVg.js"), "./icons/edit-icon.vue": () => import("./edit-icon-D7dOvXPj.js"), "./icons/point-icon.vue": () => import("./point-icon--X5qB7oB.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-Bpn-skL1.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-Cqo8HeF3.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-DdvN3BcM.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
