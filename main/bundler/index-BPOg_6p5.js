...
import { _ as C, d as A, F as j, G } from "./main-BrkRTITA.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-D0niv__a.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-WYCJztkP.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-DVbPsRNN.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-CCnzethN.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-DmPKadPO.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-DaJAq3Kl.js")))
      }), a;
    }), n = (a) => {
