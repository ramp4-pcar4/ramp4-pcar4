import { $ as e, et as t } from "./main-J2UTKznz.js";
import { i as n, w as r } from "./esri-vcEQ1sbb.js";
import { t as i } from "./_plugin-vue_export-helper-B3ysoDQm.js";
import { S as a, b as o, c as s, f as ee, g as te, i as ne, t as re, u as ie, x as ae, y as oe } from "./store-rB8-tOpA.js";
import { t as se } from "./color-control-BDgknx3N.js";
import { t as ce } from "./download-icon-CfXMdF48.js";
import { i as le, r as ue } from "./shape-io-B97H4STD.js";
...
var Le = { class: "rv-header-title" }, Re = {
	...
	setup(i) {
		let Ce = i, { t: D, locale: dr } = Fe(), O = we("iApi"), k = re(), A = v(Ce.initialTab), j = v(!1), M = v([]), N = v([]), P = v([]), F = v(""), fr = v([]), pr = v(null), I = v(!1), L = v(!1), R = v(!1), mr = 0, z = [
			...
			let e = B.value;
			if (!e) return;
			let t = e.attributes?.type ?? e.type ?? "shape", n = le([e], ue(`ramp-draw-${t}`));
