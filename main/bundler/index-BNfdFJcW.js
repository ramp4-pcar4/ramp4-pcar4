...
import { _ as H, d as L, F as K, G as X } from "./main-Cfoi7mvt.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Df7qI5y5.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-ZHWzer5V.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CnXYXK46.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-vnjRP7_v.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-B53Z595K.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CZuXUydr.js")))
      }), s;
    }), n = (s) => {
