...
import { _ as H, d as L, F as X, G as ee } from "./main-BdpsZiT5.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-C-WxXElF.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DW5pMRX3.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DKKQ342Q.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DkYG1Fs1.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CvSvf2Jw.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-n-pf2xX9.js")))
      }), s;
    }), n = (s) => {
