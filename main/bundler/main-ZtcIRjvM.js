...
class Bs {
  ...
  async projectGeoJson(e, t, i) {
    let r, o;
    if (t ? r = this.normalizeProj(t) : r = _.parseGeoJsonCrs(e.crs), i ? o = this.normalizeProj(i) : o = Vs, o === r)
      return e;
  ...
  async projectGeometry(e, t) {
    ...
    const i = t.toGeoJSON(), r = await this.projectGeoJson(i, this.normalizeProj(t.sr), this.normalizeProj(e)), o = We.geom.geomGeoJsonToRamp(r, t.id);
...
const Ct = B("maptip", () => {
  ...
  __name: "esri-map",
  setup(s) {
    const e = Ct(), t = ge("iApi"), i = P(() => e.maptipPoint), r = P(() => e.maptipInstance), o = P(() => e.content), a = we([]), l = f(!1);
    a.push(
      It(i, () => {
        if (i.value) {
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const r = i.target.dataset.breakpoints, o = r ? JSON.parse(r) : e ?? Qs;
...
const er = ["data-cy"], Ji = /* @__PURE__ */ O({
  ...
  const s = f(void 0), e = f(void 0), t = f(0), i = f(0), r = f(!1), o = f(!0), a = f({}), l = f({}), n = f([]), c = f([]), u = f([]), p = f(1), d = P(() => i.value);
  function g(S) {
  ...
  setup(s) {
    ...
    const e = Ye(), t = ge("iApi"), i = f(), r = P(() => e.opacity), o = P(() => e.mobileView);
    Je(() => {
    ...
    return (u, p) => (v(), W(Ni, {
      ...
      default: se(() => [
        (v(!0), A(He, null, ht(a(I(t).screenSize), (d) => (v(), W(Ji, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  setup(s) {
    ...
    return Je(() => {
      window.addEventListener(
        ...
        a.value && o.value && (t.value = Ps(a.value, o.value, {
...
}), rr = { class: "h-full flex flex-col" }, or = { class: "w-full flex mb-6" }, ar = ["content", "aria-label"], nr = /* @__PURE__ */ O({
  __name: "screen",
  props: {
    panel: {
      type: Object,
...
const cr = ["content"], ur = { class: "flex items-center text-left" }, pr = { class: "select-text cursor-text" }, dr = ["content"], hr = {
    ...
    return (n, c) => {
      ...
      return M((v(), A("li", {
        ...
        m("div", ur, [
          ...
          M((v(), A("button", {
            type: "button",
            onClick: c[0] || (c[0] = Qt((p) => a(s.notification), ["stop"])),
    ...
    return (l, n) => {
      ...
      return v(), A("div", null, [
        a.value.length > 0 ? M((v(), A("ul", {
          ...
          (v(!0), A(He, null, ht(a.value, (d, g) => (v(), A(He, {
            key: d.message + g
          }, [
            g > 0 ? (v(), A("div", yr)) : V("", !0),
            M(ne(fr, {
  ...
  setup(s) {
    const { t: e } = Y(), t = ge("iApi"), i = () => {
      t.reload();
    }, r = P(() => `${mt.major}.${mt.minor}.${mt.patch}`), o = P(() => mt.hash.slice(0, 9)), a = P(() => {
            ...
            m("div", null, [
              ...
              m("div", kr, [
                m("div", null, [
                  ...
                  m("span", Pr, " [" + U(o.value) + "] ", 1)
                ]),
                m("div", null, [
                  m("span", Nr, U(a.value[0]), 1),
                  m("span", Fr, U(a.value[1]), 1)
                ]),
  ...
  __name: "map-caption",
  setup(s) {
    const e = Ue(), t = pe(), { t: i } = Y(), r = ge("iApi"), o = P(() => e.scale), a = P(() => e.attribution), l = P(() => e.coords), n = P(() => e.langtoggle), c = P(() => t.config.map), u = f([]), p = we([]);
    p.push(
      It(c, (w) => {
    ...
    return (w, b) => {
      ...
      return v(), A("div", Ur, [
        ...
        a.value?.text.disabled ? V("", !0) : M((v(), A("span", qr, [
        ...
        m("div", jr, [
          ...
          o.value?.disabled ? V("", !0) : M((v(), A("button", {
            key: 1,
            type: "button",
  ...
  setup(s) {
    ...
    return (o, a) => {
      ...
      return M((v(), A("button", {
        ...
        r.value && r.value > 0 ? (v(), A("span", eo, U(r.value), 1)) : V("", !0)
      ], 8, Qr)), [
        [l]
      ]);
    };
  }
}), io = /* @__PURE__ */ Ne(to, [["__scopeId", "data-v-a451db5c"]]), so = { class: "flex items-center mb-20" }, ro = { class: "text-xl" }, oo = /* @__PURE__ */ O({
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), A("div", {
        ...
        m("div", {
          ...
          m("div", so, [
            m("h2", ro, U(I(t)("keyboardInstructions.title")), 1),
            ne(p, {
              class: "ml-auto",
...
}), rt = B("instance", () => ({ started: f(!1) })), ao = { class: "h-full relative" }, no = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, lo = { class: "absolute top-8 w-full flex justify-center" }, co = {
  key: 1,
  class: "w-full h-full"
}, uo = /* @__PURE__ */ O({
  __name: "shell",
  setup(s) {
    const e = ge("iApi"), t = rt(), i = ye(), r = Ye(), { t: o } = Y(), a = P(() => i.items.appbar), l = () => {
      e.event.emit("openKeyboardInstructions");
    }, n = () => r.teleported;
    return (c, u) => (v(), A("div", ao, [
      m("div", no, [
        ...
        ne(oo, { class: "keyboard-instructions-modal" }),
        ...
        a.value ? V("", !0) : (v(), W(io, { key: 0 })),
        ne(Xr, { class: "z-30" })
      ]),
      I(t).started ? (v(), W(Xs, { key: 0 })) : (v(), A("div", co, u[1] || (u[1] = [
...
}), po = /* @__PURE__ */ Ne(uo, [["__scopeId", "data-v-3d441124"]]), ho = O({
  name: "App",
  components: { Shell: po },
  setup() {
    const s = vs();
...
const go = /* @__PURE__ */ Ne(ho, [["render", yo]]), Se = "focus-list", qe = "focus-item", vo = "focus-icon", bo = "focus-container", ut = `[${Se}],[${bo}]`, wt = "truncate-text", At = "show-truncate", at = "focused", Kt = `button,input,select,a,textarea,[contenteditable],[${Se}],[${vo}],[tabIndex]`, wo = {
  mounted(s, e) {
    +s.getAttribute("tabindex") <= 0 && s.setAttribute("tabindex", "0"), s.toggleAttribute(Se, !0), new Ao(s, e.value);
  },
  updated(s) {
    Xi(s);
  }
...
const wi = "focus-item", Eo = {
  beforeMount(s, e) {
    s.hasAttribute("id") || s.setAttribute("id", xo()), e.value ? s.setAttribute(wi, e.value) : s.toggleAttribute(wi, !0);
  }
};
function xo() {
  let s;
...
const si = "focus-container", Qi = "focus-list", So = "focus-icon", qt = `[${Qi}],[${si}]`, Ai = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Qi}],[${si}],[${So}],[tabIndex]`;
let jt = [];
const Io = {
  mounted(s) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(s)) && jt.push(new _o(s));
  },
  beforeUnmount(s) {
...
const To = "truncate-text", Lo = "truncate-trigger", Ro = {
  beforeMount(s, e) {
    !s.classList.contains("truncate") && !e.value?.noTruncateClass && s.classList.add("truncate"), s.toggleAttribute(To, !0);
  },
  mounted(s, e) {
    let t;
    e.value && e.value.externalTrigger && (t = s.closest(`[${Lo}]`)), ks(s, {
...
const Co = ["content"], Oo = {
  ...
  setup(s, { expose: e }) {
    const { t } = Y(), i = Ye(), r = $t(), o = ge("iApi"), a = mi("el"), l = mi("contentEl"), n = f();
    e({ el: a });
    const c = s, u = P(() => o.fixture.get("appbar") ? r.temporary : []), p = P(() => i.mobileView), d = P(() => i.reorderable), g = (b) => b.scrollHeight > b.clientHeight, h = () => !p.value && !c.panel.teleport, y = (b) => {
    ...
    return Je(() => {
      ...
      return M((v(), A("div", {
        ...
        s.header ? (v(), A("header", Oo, [
          ne(T, {
            class: ie(s.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (R) => s.panel.close())
          }, null, 8, ["class"]),
          M((v(), A("h2", ko, [
            b.$slots.header ? Me(b.$slots, "header", { key: 0 }) : (v(), A("div", Mo, U(I(t)(s.panel.alertName)), 1))
          ])), [
            [Gt]
          ]),
          ...
          m("div", {
            ...
            s.panel.teleport ? V("", !0) : (v(), A("div", Po, [
              d.value ? (v(), W(F, {
                key: 0,
...
}), Go = { class: "relative" }, Uo = ["content", "aria-label"], Vo = ["transform"], Bo = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), zo = { class: "relative" }, qo = ["content", "aria-label"], jo = /* @__PURE__ */ O({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), Jo = { class: "w-32 h-32" }, Ko = ["content", "aria-label"], Zo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), ea = { class: "relative" }, ta = ["content", "aria-label"], ia = /* @__PURE__ */ O({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), sa = { class: "relative" }, ra = ["content", "aria-label"], oa = /* @__PURE__ */ O({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), aa = { class: "relative" }, na = ["content", "aria-label"], la = /* @__PURE__ */ O({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), ua = /* @__PURE__ */ Ne(ca, [["__scopeId", "data-v-51e22a4a"]]), pa = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(s) {
    ...
    return (r, o) => {
      ...
      return v(), W(a, {
        ...
        default: se(() => [
          I(t).isFullscreen ? (v(), A("svg", pa, o[0] || (o[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, ga = ["content", "aria-label"], va = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, wa = ["aria-label", "content"], Aa = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
...
}), Ea = /* @__PURE__ */ Ne(Aa, [["__scopeId", "data-v-1cb84ae1"]]), xa = B("areas-of-interest", () => ({ areas: f([]) })), Sa = B("export", () => {
  const s = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class La {
  ...
  fsaToProvince(e) {
    ...
    return r === "X" ? i === "X0A" || i === "X0B" || i === "X0C" ? t = 62 : t = 61 : t = _a[r], this.codeToProvince(t);
  }
}
function Ra(s) {
  return new La(s);
...
async function Oa(s, e) {
  ...
  return r.test(e) && !s.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new xt(s, i), await Pa(t)) : a.test(e) && !s.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new xt(s, i), await Na(t)) : o.test(e) && !s.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new xt(s, i), await Fa(t)) : (i = encodeURIComponent(e.trim()), t = new xt(s, i), await Da(t)), t;
}
const ri = async (s) => {
  ...
  const e = s.config;
  if (await ka(s), e.categories.length === 0 || e.categories.includes("ADDR")) {
...
}, Ga = "~FSA~", xi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Si = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ii = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", _i = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Ti {
  config;
  constructor(e, t) {
    let i, r, o, a;
    ...
    if (c && c.serviceUrl) {
      ...
      n = `${c.serviceUrl}/query/?where=${w}%3D'${Ga}'&outFields=${w}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, g, h, y;
   ...
   */
  async query(e) {
    const t = await Oa(this.config, e.toUpperCase()), i = this.config.sortOrder.length, r = t.results.filter((n) => n.order < i), o = t.results.filter((n) => n.order >= i);
...
const Ua = B("geosearch", () => {
  const s = f(new Ti("en", void 0)), e = f({
    type: "",
    province: "",
    extent: void 0
  }), t = f(!1), i = f(""), r = f(""), o = f(""), a = f([]), l = f([]), n = f(!1), c = f([]), u = P(
    ...
    if (!N)
      ...
      const F = setInterval(() => {
        s.value.config.provinces.listFetched && s.value.config.types.typesFetched && (clearInterval(F), s.value.query(`${N}*`).then((Q) => {
          c.value = Q.failedServs, o.value = N, l.value = Q.results;
          const Qe = Li(
            t.value,
            //@ts-expect-error TODO: explain why this is needed or remove
            e.value,
...
var Ba = /* @__PURE__ */ ((s) => (s.Title = "title", s.Text = "text", s.Image = "image", s.Markdown = "markdown", s.Template = "template", s))(Ba || {});
class Ri extends is {
  _infoType;
    ...
    if (!([
      ...
      switch (e) {
        ...
        case "areas-of-interest":
          return xa(this.$vApp.$pinia);
        case "details":
          return Hi(this.$vApp.$pinia);
        case "export":
          return Sa(this.$vApp.$pinia);
        case "extentguard":
...
function Za(s, e) {
  ...
  const i = Zs(), r = Fi(go).use(i).use(Cs, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  r.directive("focus-container", Io), r.directive("focus-list", wo), r.directive("focus-item", Eo), r.directive("truncate", Ro), r.component("panel-screen", Do), r.component("pin", Bo), r.component("close", jo), r.component("back", Yo), r.component("expand", Qo), r.component("panel-options-menu", ua), r.component("dropdown-menu", ii), r.component("minimize", ia), r.component("right", oa), r.component("left", la), r.component("fullscreen-nav-button", ha), r.component("geolocator-nav-button", fa), r.component("home-nav-button", ma), r.component("mapnav-button", va), r.component("appbar-button", Ea), r.component("transition", Pi), r.component("transition-group", Ni), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || We.sharedUtils.generateUUID()}`, r.provide("iApi", e);
  const o = r.mount(s);
    ...
    if (e ? (e.logo ? e.logo.disabled ? r.logo.disabled = !0 : (r.logo.altText = e.logo.altText || i.altText, r.logo.link = e.logo.link || i.link, r.logo.value = e.logo.value || i.value) : (r.logo.altText = i.altText, r.logo.link = i.link, r.logo.value = i.value), e.text ? e.text.disabled ? r.text.disabled = !0 : r.text.value = e.text.value || t.value : r.text.value = t.value, Ue(this.$vApp.$pinia).setAttribution(r)) : (r.logo.altText = i.altText, r.logo.link = i.link, r.logo.value = i.value, r.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        ...
        Promise.all(c).then((u) => {
          o = u.filter((d) => d?.copyright).map((d) => d.copyright).join(" | "), r.text.value = o || r.text.value || t.value, Ue(this.$vApp.$pinia).setAttribution(r);
        });
      }
    }
  }
...
class tn extends Xa {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new Qa(e), this.caption = new en(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
...
class ci extends Ze {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = L.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new ji(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new os();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new ns(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === te.ESRI_FEATURE) {
        ...
        this.attribs.attLoader = new as(this.$iApi, o);
      } else
...
class _n extends Ze {
  ...
  runIdentify(e) {
    ...
    return e.geometry.type === L.POINT && (i = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((r) => {
      ...
      return r.geomType !== L.POLYGON && i ? a.filterGeometry = i : a.filterGeometry = e.geometry, a.filterSql = r.getCombinedSqlFilter(), a.sourceSR = r.sourceSR, r.queryOIDs(a).then((n) => {
        n.forEach((c) => {
...
class Cn extends Ze {
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((r) => {
      if (r) {
        let o = !0, a;
        typeof r != "string" ? a = lt.JSON : r.indexOf("Search returned no results") === -1 && r !== "" ? a = lt.TEXT : (o = !1, a = lt.UNKNOWN), o && i.items.push(vt.makeRawItem(a, r));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
...
class rs extends ss {
  ...
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new Dn(this.$iApi, o), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class Mn extends rs {
  ...
  onLoadActions() {
    const e = super.onLoadActions(), t = Date.now(), r = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, o = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((l) => {
      ...
      this.attribs.attLoader = new as(this.$iApi, n), this.attribs.quickCache = new ns(this.geomType);
...
class Bn extends J {
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [r, o] = await Ae(Be(`${e}/legend`, t));
...
class zn extends J {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((r, o) => {
      let a;
      return t.returnGeometry ? a = this.$iApi.geo.geom.geomEsriToRamp(r.geometry, `queryResult${o}`) : a = new ze(), new Ee(a, "", r.attributes);
    });
  }
  /**
...
class qn extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = We.geom, this.proj = We.proj, this.shared = We.sharedUtils, this.map = new tn(e), this.layer = new yn(e), this.attributes = new Nn(e), this.query = new zn(e), this.symbology = new Bn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const jn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CBzyPsIs.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-ox_YQOLe.js"), "../fixtures/basemap/index.ts": () => import("./index-Buj33FQo.js"), "../fixtures/crosshairs/index.ts": () => import("./index-6EATz6k0.js"), "../fixtures/details/index.ts": () => import("./index-DxhtqP7H.js"), "../fixtures/draw/index.ts": () => import("./index-t19IdK48.js"), "../fixtures/export-footnote/index.ts": () => import("./index-Df9D7sZC.js"), "../fixtures/export-legend/index.ts": () => import("./index-CYh6ydOG.js"), "../fixtures/export-map/index.ts": () => import("./index-DjvGLkmO.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-De5MyOeb.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-CuXzfe4U.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-DxXcliEK.js"), "../fixtures/export-title/index.ts": () => import("./index-DUsHavas.js"), "../fixtures/export/index.ts": () => import("./index-BRXfsg3B.js"), "../fixtures/extentguard/index.ts": () => import("./index-CaqfWHmI.js"), "../fixtures/gazebo/index.ts": () => import("./index-CseIMbCu.js"), "../fixtures/geosearch/index.ts": () => import("./index-xIyoeV-e.js"), "../fixtures/grid/index.ts": () => import("./index-fLtsSsBB.js"), "../fixtures/help/index.ts": () => import("./index-BicQP-26.js"), "../fixtures/hilight/index.ts": () => import("./index-BXAXOjqq.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-D0Pt5Kkd.js"), "../fixtures/legend/index.ts": () => import("./index-hM4p0DaU.js"), "../fixtures/mapnav/index.ts": () => import("./index-ChE0U_7m.js"), "../fixtures/metadata/index.ts": () => import("./index-Cw0R1JB3.js"), "../fixtures/northarrow/index.ts": () => import("./index-D3M3xyAz.js"), "../fixtures/overviewmap/index.ts": () => import("./index-xTB37yJs.js"), "../fixtures/panguard/index.ts": () => import("./index-ByYmRn6Q.js"), "../fixtures/scrollguard/index.ts": () => import("./index-BIYR7pYc.js"), "../fixtures/settings/index.ts": () => import("./index-7_D4dhns.js"), "../fixtures/snowman/index.ts": () => import("./index-U2HXxTOO.js"), "../fixtures/swipe/index.ts": () => import("./index-BVKYMk-U.js"), "../fixtures/wizard/index.ts": () => import("./index-fuFTa7s4.js") });
class Wn extends J {
  /**
...
const Zn = /* @__PURE__ */ Ne(Jn, [["render", Kn], ["__scopeId", "data-v-a3c61802"]]), Xn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-Cyd8kHNx.js"), "../fixtures/basemap/screen.vue": () => import("./screen-Ds80reW-.js"), "../fixtures/export/screen.vue": () => import("./screen-Dtpco3Ie.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-BuVVtmLt.js"), "../fixtures/grid/screen.vue": () => import("./screen-kaaLi3d0.js"), "../fixtures/help/screen.vue": () => import("./screen-BMKsPU7E.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-OiMRJL7c.js"), "../fixtures/legend/screen.vue": () => import("./screen-BOWWs8-x.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CWunh7l7.js"), "../fixtures/settings/screen.vue": () => import("./screen-Dwzbkgxm.js"), "../fixtures/wizard/screen.vue": () => import("./screen-ZtSR_mEe.js") });
class St extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (js(t) || qs(t))
      ...
      const o = new Promise((a, l) => {
        r.then((n) => {
          this.loadedScreens.push(e), a(Ws(n) ? n.default : n);
        }), r.catch((n) => l(n));
      });
      i = ws({
...
function tl(s) {
  ...
  return sl(s.services, e), il(s.map, e), rl(s.ui, e), s.plugins && ol(s.plugins, e), e;
}
function il(s, e) {
  ...
  return s.controls && s.controls.length > 0 && (e.controls = pt(s.controls, t), s.controls.includes("visibility") && e.controls.push("visibilityButton"), (s.controls.length !== 1 || s.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        o.layerId ? r.children.push(ki(o)) : r.children.push(Xt(o));
      }), e.children.push(r);
    } else
...
var ot = { major: "4", minor: "14", patch: "0-beta", timestamp: "Wed Sep 10 10:43:50 2025 -0400", hash: "6142c9bdc96e85625e66c068c311996d752cb95b" };
console.info(
...
const Hl = (s, e, t) => new Ka(s, e, t), We = new zs();
export {
  H as $,
  Gr as A,
  yt as B,
