...
import { _ as H, d as L, F as X, G as ee } from "./main-q2NIGqKY.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-lu1tPzIG.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-0LGYRMBQ.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-BDMRQ-Ir.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DBYCUg1J.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BHQQwKdj.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-B-yaSHiL.js")))
      }), s;
    }), n = (s) => {
