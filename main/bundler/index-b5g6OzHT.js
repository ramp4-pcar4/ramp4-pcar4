...
import { _ as C, d as A, F as j, G } from "./main-DM5sTA3s.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-DFLoLPNj.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-CRhhOPbD.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-DhNoVdza.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-ClEJe31G.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-D_Ik2f2q.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-C7UlZuN5.js")))
      }), a;
    }), n = (a) => {
