...
import { _ as H, d as L, F as X, G as ee } from "./main-WIxxyInf.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-C9PyFmqR.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CqHjP-1x.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-Saj8NdvX.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BdQCoGOD.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DROY-KQt.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CcX3EXDo.js")))
      }), s;
    }), n = (s) => {
