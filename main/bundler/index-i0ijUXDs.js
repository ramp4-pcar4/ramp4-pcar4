...
import { _ as C, d as A, F as j, G } from "./main-0AjGBmTy.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-CTCWtj_a.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-SC60Jsfe.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-X9jJ0oBX.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-cEq4MxJK.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-Cp0CafRF.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-CSOp2FF9.js")))
      }), a;
    }), n = (a) => {
