...
import { _ as H, d as L, F as X, G as ee } from "./main-CDBGYV0n.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CVUrQp7F.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-D8lLwO6O.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DqjlSw79.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BqXW5ZmM.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BJfasBQt.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CNcORAWe.js")))
      }), s;
    }), n = (s) => {
