...
import "tiny-emitter";
import { G as re, L as ve, F as be } from "./main-0AjGBmTy.js";
...
class ut extends xe {
  async init() {
    ...
    this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(r.childNodes[0]), Object.entries(Pe).forEach((t) => this.$iApi.$i18n.mergeLocaleMessage(...t)), this._parseConfig(this.config), Y(this.$vApp.$pinia).supportedTypes.forEach((t) => {
      const n = `${t.type}-icon`;
      this.$iApi.component(n, fe(Ae(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-cEq4MxJK.js"), "./icons/edit-icon.vue": () => import("./edit-icon-CSOp2FF9.js"), "./icons/point-icon.vue": () => import("./point-icon-CTCWtj_a.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-X9jJ0oBX.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-SC60Jsfe.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-Cp0CafRF.js") }), `./icons/${t.type}-icon.vue`, 3)));
    });
  }
  async added() {
