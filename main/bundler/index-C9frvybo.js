...
import { _ as H, d as L, F as X, G as ee } from "./main-CyMXTjZO.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CFHQaceB.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Dq9dY47I.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-EQHlif60.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-G2Pn71kM.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DquVtw0X.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-GvUk8LLA.js")))
      }), s;
    }), n = (s) => {
