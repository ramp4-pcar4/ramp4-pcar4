...
import { _ as H, d as L, F as K, G as X } from "./main-DMg3xXUL.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DSqEJBJ9.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DeUwPXwe.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DYvTBCtw.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-CWGrmod7.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DZOdB0Ag.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-B1yonEwm.js")))
      }), s;
    }), n = (s) => {
