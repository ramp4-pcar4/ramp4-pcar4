...
export declare class LayerSource extends APIScope {
     ...
     * @returns {Promise<LayerInfo | undefined>} LayerInfo object
     */
    fetchServiceInfo(url: string, serviceType: string, nested: boolean, signal?: AbortSignal): Promise<LayerInfo | undefined>;
    ...
    getWfsInfo(url: string, signal?: AbortSignal): Promise<LayerInfo>;
    /**
