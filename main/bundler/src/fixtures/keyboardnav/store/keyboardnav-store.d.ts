...
export declare const useKeyboardnavStore: import('pinia').StoreDefinition<"keyboardnav", import('pinia')._UnwrapAll<Pick<KeyboardnavStore, "activeNamespace" | "namespaces" | "helpVisible" | "keyChain" | "lastAction" | "chainState">>, Pick<KeyboardnavStore, never>, Pick<KeyboardnavStore, "register" | "unregister" | "trigger" | "activate" | "deactivate" | "setHelpVisible" | "resetChain" | "setChain" | "appendKey" | "popChain" | "setLastAction" | "setChainState" | "finalizeChain">>;
