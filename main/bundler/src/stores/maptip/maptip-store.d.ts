...
export declare const useMaptipStore: import('pinia').StoreDefinition<"maptip", Pick<{
    ...
    maptipPoint: import('../../../vue/dist/vue.esm-bundler.js').Ref<{
        ...
        readonly flavour: import('../../geo/api').GeometryFlavour;
        x: number;
        y: number;
        toArray: () => Array<number>;
        toESRI: () => import('@arcgis/core/geometry/Point').default;
        ...
        sr: {
            ...
            toESRI: () => import('@arcgis/core/geometry/SpatialReference').default;
