...
import { Point, ScaleSet, GraphicHitResult, IdentifyGeometryProvider, LayerTimes, MapClick, RampMapConfig, ScreenPoint, Screenshot } from '../api';
import { EsriUserSettings } from '../esri';
...
export declare class MapAPI extends CommonMapAPI {
     ...
     */
    takeScreenshot(options: Partial<EsriUserSettings>): Promise<Screenshot>;
    /**
     ...
     */
    private getIdentifyProviderGeometry;
    /**
