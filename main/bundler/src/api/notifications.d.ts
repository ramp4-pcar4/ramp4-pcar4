...
export declare class NotificationGroup extends APIScope {
    notificationStore: import('pinia').Store<"notification", Pick<import('../stores/notification').NotificationStore, "notificationStack" | "groups">, Pick<import('../stores/notification').NotificationStore, "notificationNumber">, Pick<import('../stores/notification').NotificationStore, "showNotification" | "removeNotification" | "registerGroup" | "addToGroup" | "clearAll" | "removeGroup">>;
    readonly id: string;
