...
import "tiny-emitter";
import { G as re, L as ve, F as be } from "./main-Bo2LIhTV.js";
...
class ut extends xe {
  async init() {
    ...
    this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(r.childNodes[0]), Object.entries(Pe).forEach((t) => this.$iApi.$i18n.mergeLocaleMessage(...t)), this._parseConfig(this.config), Y(this.$vApp.$pinia).supportedTypes.forEach((t) => {
      const n = `${t.type}-icon`;
      this.$iApi.component(n, fe(Ae(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-DVKLJPQ6.js"), "./icons/edit-icon.vue": () => import("./edit-icon-Cs1hD_cS.js"), "./icons/point-icon.vue": () => import("./point-icon-56zf57QB.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-DZxN6Pju.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-DbZTj_jq.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-Con2f_sS.js") }), `./icons/${t.type}-icon.vue`, 3)));
    });
  }
  async added() {
