...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-mgxqA_dp.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-lIUbMRfr.js"), "./icons/edit-icon.vue": () => import("./edit-icon-V-k0qbjK.js"), "./icons/point-icon.vue": () => import("./point-icon-DLb-vilR.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-D_oDfHK_.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-CS-bEpWg.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-BiNtCU3w.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
