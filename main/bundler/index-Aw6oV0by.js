...
import { _ as H, d as L, F as X, G as ee } from "./main-Ca1uw4W0.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-B6f5Bg4M.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-ByTLkaH1.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-uv2W2LEL.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-Bq8QJ1he.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BJmFg7Gp.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-dor2Przf.js")))
      }), s;
    }), n = (s) => {
