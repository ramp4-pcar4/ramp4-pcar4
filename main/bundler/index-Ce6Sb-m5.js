...
import { _ as H, d as L, k as X, F as ee, G as te } from "./main-BAZ9S_nQ.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Buz-oAAX.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BvtjQaLb.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CJ9-l1uF.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-Bv2-X24O.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BH0fccVD.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BnqbJ4K9.js")))
      }), s;
    }), n = (s) => {
