...
var u = "ramp4-draw-shapes", d = "json", f = (e) => typeof e == "object" && !!e && !Array.isArray(e), p = (e) => JSON.parse(JSON.stringify(e)), m = (e, t) => f(e) ? e : f(t) ? t : {}, h = (e) => {
	...
	if (!e.length) throw Error("Invalid draw shape file.");
	let t = [];
	for (let n of e) {
		let e;
		try {
		...
		let r = S(e);
		if (!r) throw Error("Invalid draw shape file.");
		if (!r.length) continue;
		let i = w(e);
		if (!i.length) throw Error("Invalid draw shape file.");
		t.push(...i);
	}
	return t;
};
//#endregion
export { S as a, _ as i, b as n, w as o, x as r, T as s, y as t };
