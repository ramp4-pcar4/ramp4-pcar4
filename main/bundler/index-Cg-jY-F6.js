...
import { _ as H, d as L, F as X, G as ee } from "./main-MXZmlokj.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Dv-P3x2G.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-1kYY1tMD.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-TZpInjgj.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-D6OS0-Fn.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CK5BJCP6.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-C4Wbd8b2.js")))
      }), s;
    }), n = (s) => {
