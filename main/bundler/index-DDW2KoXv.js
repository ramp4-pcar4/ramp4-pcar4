...
import "tiny-emitter";
import { G as re, L as ve, F as be } from "./main-CP5xzpAc.js";
...
class ut extends xe {
  async init() {
    ...
    this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(r.childNodes[0]), Object.entries(Pe).forEach((t) => this.$iApi.$i18n.mergeLocaleMessage(...t)), this._parseConfig(this.config), Y(this.$vApp.$pinia).supportedTypes.forEach((t) => {
      const n = `${t.type}-icon`;
      this.$iApi.component(n, fe(Ae(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-BQPJ9vlC.js"), "./icons/edit-icon.vue": () => import("./edit-icon-Cf_Gqoi8.js"), "./icons/point-icon.vue": () => import("./point-icon-C26An6ZD.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-DvXUufaL.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-goYi_knL.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-BOLuYvAf.js") }), `./icons/${t.type}-icon.vue`, 3)));
    });
  }
  async added() {
