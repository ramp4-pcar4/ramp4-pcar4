...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-MXZmlokj.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-D6OS0-Fn.js"), "./icons/edit-icon.vue": () => import("./edit-icon-C4Wbd8b2.js"), "./icons/point-icon.vue": () => import("./point-icon-Dv-P3x2G.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-TZpInjgj.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-1kYY1tMD.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-CK5BJCP6.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
