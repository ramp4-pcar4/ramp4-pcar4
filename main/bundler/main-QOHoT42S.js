...
var Qa = class e {
	...
	async createMap(e, t) {
		...
		}), this._basemapStore = a, e.labelsDefault && (this.labelsDefault.visible = e.labelsDefault.visible), this.esriMap = O(await m.Map({})), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
	}
	destroyMap() {
...
var uo = class extends Z {
	...
	extractLayerMetadata() {
		...
		this.supportsFeatures = !0, this.geomType = this.$iApi.geo.geom.clientGeomTypeToRampGeomType(e.geometryType), this.scaleSet.minScale = e.minScale || 0, this.scaleSet.maxScale = e.maxScale || 0, this.extent = this.extent ?? xt.fromESRI(e.fullExtent, this.id + "_extent"), this.fields = O(e.fields.slice()).map((e) => ({
			name: e.name,
			alias: e.alias,
			type: e.type,
			length: e.length
	...
	"../fixtures/appbar/index.ts": () => import("./appbar-DpnPGu6W.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-uicQsUqP.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-B-0NCCFe.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-CqJ4kG9o.js"),
	"../fixtures/details/index.ts": () => import("./details-BCV01120.js"),
	"../fixtures/draw/index.ts": () => import("./draw-BICiZTSR.js"),
	"../fixtures/export/index.ts": () => import("./export-l2I_Pdoh.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-DifVKI_V.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-BNEqQGg9.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-CkI4l3k4.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-CUH4CRpc.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-CoeVCAxH.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-wHfC8grP.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-D9_zl03T.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-DSnN-nPr.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-CYrDy1Ji.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-BZkbwXeP.js"),
	"../fixtures/grid/index.ts": () => import("./grid-BmxkXf51.js"),
	"../fixtures/help/index.ts": () => import("./help-Bl07PsE_.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-DhvBuIEA.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-DwwrlJqZ.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-CfqWYar6.js"),
	"../fixtures/legend/index.ts": () => import("./legend-DtrDeQM0.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-BtCDQtph.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-C-f9JDYm.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-CcH6iSd9.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-bPhlk5xq.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-Bkp8GFv7.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-C2B7YE-2.js"),
	"../fixtures/settings/index.ts": () => import("./settings-Dnqnspt2.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-D6v-hfAb.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-CiFZ932R.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-DvuefoBu.js")
}), ds = class extends Z {
	constructor(e) {
		super(e);
	}
...
var _s = /* @__PURE__ */ te(hs, [["render", gs], ["__scopeId", "data-v-a3c61802"]]), vs = /* @__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-0kB6PdAu.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-CecNqNOc.js"),
	"../fixtures/export/screen.vue": () => import("./screen-C3dOJIHK.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-DSNtqOuT.js"),
	"../fixtures/grid/screen.vue": () => import("./screen-BjwmkTXg.js"),
	"../fixtures/help/screen.vue": () => import("./screen-CYkky8X1.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-BEE3_z90.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-MEGUvKyh.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-dIX8-1Tv.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-BMw3JANZ.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-limEC56W.js")
}), ys = class extends Z {
	id;
	screens;
	loadedScreens = [];
...
console.info(`RAMP v${{
	...
	minor: "21",
	patch: "0-beta",
	timestamp: "Tue May 19 13:26:22 2026 -0400",
	hash: "ee07d75a72281343d62787dc8ff1bcb911ae04f3"
}.major}.${{
	major: "4",
	minor: "21",
	patch: "0-beta",
