...
import { _ as H, d as L, F as K, G as X } from "./main-BXw0XojD.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-x9vZ8Zsm.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-onejx0nC.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-BIkyFokZ.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-MMSrYZuf.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-fcovXiWu.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CUcwpiRJ.js")))
      }), s;
    }), n = (s) => {
