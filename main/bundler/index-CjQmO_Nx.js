...
import { _ as H, d as L, F as K, G as X } from "./main-CK3Sv6fv.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-C3OaWQ2c.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DT7lMG32.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-FabEhQBN.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-c4hacocp.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CmGlbBuP.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BtiB-Mxj.js")))
      }), s;
    }), n = (s) => {
