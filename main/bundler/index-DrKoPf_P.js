...
import { _ as H, d as L, F as K, G as X } from "./main-CP5xzpAc.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-C26An6ZD.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-goYi_knL.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DvXUufaL.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BQPJ9vlC.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BOLuYvAf.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-Cf_Gqoi8.js")))
      }), s;
    }), n = (s) => {
