...
import { _ as H, d as L, F as X, G as ee } from "./main-CBWdV-Iy.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon--X5qB7oB.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Cqo8HeF3.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-Bpn-skL1.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-9OCnoyVg.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DdvN3BcM.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-D7dOvXPj.js")))
      }), s;
    }), n = (s) => {
