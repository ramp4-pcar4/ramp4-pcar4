...
import { _ as H, d as L, F as X, G as ee } from "./main-mgxqA_dp.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DLb-vilR.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CS-bEpWg.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-D_oDfHK_.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-lIUbMRfr.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BiNtCU3w.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-V-k0qbjK.js")))
      }), s;
    }), n = (s) => {
