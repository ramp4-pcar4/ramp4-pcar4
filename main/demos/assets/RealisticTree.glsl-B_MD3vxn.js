import{c as e,r as t}from"./Emissions.glsl-B_mIpYFn.js";import{n,t as r}from"./glsl-CXvSXY75.js";import{t as i}from"./Float3PassUniform-CmfAE3yk.js";import{t as a}from"./FloatPassUniform-D6ArRZe3.js";import{t as o}from"./Texture2DPassUniform-BsoMa898.js";import{t as s}from"./ShaderBuilder-BoqE5F3y.js";import{n as c}from"./MaterialUtil-B8x4K8d_.js";import{t as l}from"./Float4PassUniform-BLGpD4hu.js";import{a as u,t as d}from"./AlphaCutoff-BuZgig4m.js";import{a as f,i as p,t as m}from"./VisualVariables.glsl-Bhi7W2yG.js";import{n as h,t as g}from"./View.glsl-BI7CtvMJ.js";import{t as _}from"./MixExternalColor.glsl-DCSVZw-S.js";import{t as v}from"./TerrainDepthTest.glsl-Bpi73Lk3.js";import{t as y}from"./OutputColorHighlightOLID.glsl-Ck5hCOVi.js";import{r as b}from"./VerticalOffset.glsl-tiKEJ1xW.js";import{t as x}from"./Transform.glsl-CfvgOo8k.js";import{t as S}from"./VertexColor.glsl-eOffJJdR.js";import{a as C,i as w,n as T,o as E,r as D,t as O,u as k}from"./DefaultMaterialAuxiliaryPasses.glsl-eTsNHbsZ.js";import{a as A,i as j,n as ee,o as M,r as N,t as P}from"./SnowCover.glsl-sGLxsLCC.js";import{a as F,c as I,n as L,s as R,t as z}from"./ReadShadowMap.glsl-DOFzcc6W.js";function B(B){let V=new s,{attributes:H,vertex:U,fragment:W,varyings:G}=V,{output:K,offsetBackfaces:q,pbrMode:J,snowCover:Y,spherical:X}=B,Z=J===1||J===2;if(h(U,B),H.add(`position`,`vec3`),G.add(`vpos`,`vec3`,{invariant:!0}),V.include(m,B),V.include(w,B),V.include(b,B),V.include(v,B),!e(K))return V.include(O,B),V;g(V.vertex,B),V.include(k,B),V.include(x),q&&V.include(E),G.add(`vNormalWorld`,`vec3`),G.add(`localvpos`,`vec3`,{invariant:!0}),V.include(t,B),V.include(D,B),V.include(C,B),V.include(S,B),U.include(f),U.include(p),U.uniforms.add(new l(`externalColor`,e=>e.externalColor,{supportsNaN:!0})),G.add(`vcolorExt`,`vec4`),V.include(B.instancedDoublePrecision?L:z,B),U.main.add(n`
    forwardVertexColor();
