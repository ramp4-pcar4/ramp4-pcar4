import{wg as e}from"./store-TEwW3sPL.js";import{M as t}from"./decorators-D2aC5xmm.js";import{G as n,X as r}from"./BufferView-D9s1lKs5.js";import{n as i,t as a}from"./glsl-D85RBwKC.js";import{t as o}from"./Uniform-FnPH-ujw.js";import{t as s}from"./ShaderBuilder-B4XLodJj.js";import{At as c,B as l,M as u,N as d,n as f,nn as p,q as m,rn as h,t as g,tt as _,wt as v,z as y}from"./VertexColor.glsl-CGCZmPas.js";import{a as ee,c as b,i as x,l as S}from"./AlphaCutoff-Dm0bYlmh.js";import{a as C}from"./FloatArray-Z7rI42Jt.js";import{t as w}from"./TextureBackedBufferLayout-Ca2C2AEs.js";var T=class extends v{constructor(){super(...arguments),this.cullFace=0,this.style=0,this.hasVertexColors=!1,this.polygonOffset=!1,this.hasOccludees=!1,this.enableOffset=!0,this.terrainDepthTest=!1,this.cullAboveTerrain=!1,this.hasVVColor=!1,this.draped=!1,this.textureCoordinateType=0,this.emissionSource=0,this.discardInvisibleFragments=!0,this.writeDepth=!0,this.occlusionPass=!1,this.hasVVInstancing=!1,this.hasVVSize=!1,this.hasVVOpacity=!1,this.overlayEnabled=!1,this.snowCover=!1}};function E(e,t,n,r){return e.draped?null:e.hasVVColor?r:e.hasVertexColors?n:t}e([S({count:3})],T.prototype,`cullFace`,void 0),e([S({count:6})],T.prototype,`style`,void 0),e([S()],T.prototype,`hasVertexColors`,void 0),e([S()],T.prototype,`polygonOffset`,void 0),e([S()],T.prototype,`hasOccludees`,void 0),e([S()],T.prototype,`enableOffset`,void 0),e([S()],T.prototype,`terrainDepthTest`,void 0),e([S()],T.prototype,`cullAboveTerrain`,void 0),e([S()],T.prototype,`hasVVColor`,void 0),e([S()],T.prototype,`draped`,void 0);function te(e){let t=C().vec3f(`position`).vec4f(`uvMapSpace`);return e.draped?e.hasVVColor?t.f32(`colorFeatureAttribute`):e.hasVertexColors&&t.vec4u8(`color`,{glNormalized:!0}):t.u32(`textureElementIndex`,{integer:!0}),c()&&t.vec4u8(`olidColor`),t.freeze()}var D=[{type:`mat3f32`,name:`boundingRect`}],O=new w(D),k=new w([...D,{type:`vec4unorm8`,name:`color`}]),A=new w([...D,{type:`f32`,name:`colorFeatureAttribute`}]);function j(e){return E(e,O,k,A)}function M(e){switch(e.elementType){case`float`:switch(e.elementCount){case 1:return i`float`;case 2:return i`vec2`;case 3:return i`vec3`;case 4:return i`vec4`;case 9:return i`mat3`;default:e.elementCount}break;case`int`:switch(e.elementCount){case 1:return i`int`;case 2:return i`ivec2`;case 3:return i`ivec3`;case 4:return i`ivec4`;case 9:throw Error(`Invalid element count 9 for type int`);default:e.elementCount}break;case`uint`:switch(e.elementCount){case 1:return i`uint`;case 2:return i`uvec2`;case 3:return i`uvec3`;case 4:return i`uvec4`;case 9:throw Error(`Invalid element count 9 for type uint`);default:e.elementCount}break;default:e.elementType}throw Error(`unsupported field`)}var N=new p(`const_NaN`,()=>NaN,{supportsNaN:!0}),P=class extends b{constructor(e){super(),this.supportNaN=e}};function ne(e,t){let n=t?.supportNaN;n&&(e.uniforms.add(N),e.code.add(i`bool bitsEncodeFloat16NaN(highp uint bits) {
