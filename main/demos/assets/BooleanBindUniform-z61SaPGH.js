import{Fi as e,If as t,Ji as n,Si as r,a_ as i,k_ as a}from"./store-DqDAc_Fp.js";import{l as o}from"./screenUtils-BjEA_qFF.js";import{C as s,Et as c,L as l,T as u}from"./TriangleTechniqueConfiguration-CZtz6Ys9.js";import{a as d,d as f,f as p}from"./SceneLighting-C1eOk2PG.js";import{f as m,u as h}from"./oitResolution.glsl-BuRgfwx5.js";import{t as g}from"./NoParameters-ZDc3QXO4.js";function _(e){e.uniforms.add(new s(`zProjectionMap`,e=>v(e.camera))),e.code.add(m`float linearizeDepth(float depth, vec2 zProjectionConstants) {
...
}`)}function v(e){let n=e.projectionMatrix;return t(y,n[14],n[10])}var y=n();function b(e){e.fragment.uniforms.add(new d(`projInfo`,e=>x(e.camera))),e.fragment.uniforms.add(new s(`zScale`,e=>C(e.camera))),e.fragment.code.add(m`vec3 reconstructPosition(vec2 fragCoord, float depth) {
return vec3((fragCoord * projInfo.xy + projInfo.zw) * (zScale.x * depth + zScale.y), depth);
}`)}function x(t){let n=t.projectionMatrix;return n[11]===0?e(S,2/(t.fullWidth*n[0]),2/(t.fullHeight*n[5]),(1+n[12])/n[0],(1+n[13])/n[5]):e(S,-2/(t.fullWidth*n[0]),-2/(t.fullHeight*n[5]),(1-n[8])/n[0],(1-n[9])/n[5])}var S=r();function C(e){return e.projectionMatrix[11]===0?t(w,0,1):t(w,1,0)}var w=n(),T=class extends h{constructor(e,t,n){super(e,`mat4`,1,(r,i,a)=>r.setUniformMatrix4fv(e,t(i,a),n))}},E=class{constructor(e){this.screenLength=o(e.screenLength),this.minWorldLength=e.minWorldLength??0,this.maxWorldLength=e.maxWorldLength??1/0}};function D(e,t){let n=e.vertex;t.hasVerticalOffset?(k(n),t.hasScreenSizePerspective&&(e.include(p),f(n),u(e.vertex,t)),n.code.add(m`
