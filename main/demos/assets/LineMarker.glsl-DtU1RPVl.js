import{a as e,f as t,m as n,o as r,p as i}from"./GridLocalOriginFactory-lOGJhttS.js";import{A as a,C as o,D as s,E as c,L as l,O as u,W as d,g as f,j as p,v as m,w as h}from"./TriangleTechniqueConfiguration-CZtz6Ys9.js";import{a as g}from"./SceneLighting-C1eOk2PG.js";import{c as _,d as v,f as y}from"./oitResolution.glsl-BuRgfwx5.js";import{t as b}from"./ShaderBuilder-CWcV0kuW.js";function x(x){let S=new b,{space:C,anchor:w,hasTip:T,hasScreenSizePerspective:E}=x,D=C===2,O=C===1;S.attributes.add(`position`,`vec3`),S.vertex.inputs.add(`position`,()=>`position`),S.include(n,x),S.include(r,x);let{vertex:k,fragment:A,varyings:j}=S;c(k,x),S.attributes.add(`previousDelta`,`vec4`),S.attributes.add(`uv0`,`vec2`),j.add(`vColor`,`vec4`),j.add(`vpos`,`vec3`,{invariant:!0}),j.add(`vUV`,`vec2`),j.add(`vSize`,`float`),T&&j.add(`vLineWidth`,`float`),k.uniforms.add(new o(`nearFar`,({camera:e})=>e.nearFar),new g(`viewport`,({camera:e})=>e.fullViewport)).code.add(y`vec4 projectAndScale(vec4 pos) {
