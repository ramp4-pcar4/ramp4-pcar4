import{n as e}from"./glsl-D85RBwKC.js";import{t}from"./ShaderBuilder-B4XLodJj.js";import{B as n,M as r,n as i,rn as a,t as o}from"./VertexColor.glsl-CGCZmPas.js";import{a as s}from"./AlphaCutoff-Dm0bYlmh.js";function c(c){let l=new t,{vertex:u,fragment:d,varyings:f}=l;return l.fragment.include(s,c),l.include(i),l.include(o,c),l.include(r,c),n(u,c),l.attributes.add(`position`,`vec3`),f.add(`vpos`,`vec3`,{invariant:!0}),u.main.add(e`vpos = position;
forwardVertexColor();
