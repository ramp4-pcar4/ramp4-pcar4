import{n as e}from"./glsl-cCMnAovS.js";import{t}from"./FloatPassUniform-Br1Hnc1v.js";import{t as n}from"./Texture2DPassUniform-9kttYuW8.js";import{t as r}from"./ShaderBuilder-XiUqTHez.js";import{t as i}from"./HighlightCellGridScreenSpacePass.glsl-DoCkzlRb.js";import{t as a}from"./IntegerPassUniform-Dx1qtnmn.js";import{a as o,s}from"./HighlightDownsample.glsl-ZU1aGNBk.js";import{t as c}from"./HighlightReadBitmap.glsl-BCj20VVu.js";import{t as l}from"./Float2DrawUniform-CqOyi9iZ.js";function u(){let u=new r;u.include(i);let{fragment:d}=u;return d.uniforms.add(new n(`blurInput`,e=>e.highlightBlurTexture),new l(`blurSize`,e=>e.blurSize),new s(`highlightTexture`,e=>e.highlightTexture),new n(`highlightOptionsTexture`,e=>e.highlightOptionsTexture),new a(`highlightLevel`,e=>e.highlightLevel),new t(`occludedIntensityFactor`,e=>e.occludedFactor)),d.constants.add(`inner`,`float`,1-(9-o)/9),u.include(c),d.main.add(e`vec2 highlightTextureSize = vec2(textureSize(highlightTexture,0));
vec2 uv = sUV;
