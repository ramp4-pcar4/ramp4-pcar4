import{n as e}from"./glsl-BgsHvHfn.js";import{t}from"./FloatPassUniform-Tzg3-nNy.js";import{t as n}from"./Float4BindUniform-BC0d6gbx.js";import{t as r}from"./Texture2DBindUniform-axEjUMhA.js";import{t as i}from"./FloatBindUniform-OLJJHxgW.js";import{n as a,t as o}from"./ScreenSizePerspective.glsl-CL-Rtwtz.js";import{i as s,n as c,r as l,t as u}from"./View.glsl-DXY3WEB3.js";import{n as d}from"./VerticalOffset.glsl-CpUKQVPA.js";import{t as f}from"./BooleanBindUniform-DPETR89u.js";var p=.5;function m(r,f){r.include(a),r.attributes.add(`position`,`vec3`),r.attributes.add(`normal`,`vec3`),r.attributes.add(`centerOffsetAndDistance`,`vec4`);let p=r.vertex;c(p,f),u(p,f),p.uniforms.add(new n(`viewport`,e=>e.camera.fullViewport),new t(`polygonOffset`,e=>e.shaderPolygonOffset),new i(`aboveGround`,e=>e.camera.aboveGround?1:-1)),f.hasVerticalOffset&&d(p),p.code.add(e`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
