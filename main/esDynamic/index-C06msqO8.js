import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-CU3_vBTl.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-BDqPxjJk.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-DZL4ffAE.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-Dio_jzsh.js")).default, n = (await import("./index-hPMVO-x6.js")).default, a = (await import("./index-1vFiPJHw.js")).default, w = (await import("./index-BPpEW_Lo.js")).default, p = (await import("./index-C7qtOtFY.js")).default, r = (await import("./index-DxGC2UbO.js")).default, b = (await import("./index-CRIGRDwj.js")).default;
...
//# sourceMappingURL=index-C06msqO8.js.map
