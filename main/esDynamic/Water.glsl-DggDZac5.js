import{r as e}from"./Ellipsoid-Djc5R-AQ.js";import{y as t}from"./vec2-Ct_ybxJk.js";import{l as n}from"./vec3f64-AlvO6xQn.js";import{i as r}from"./vec2f64-BxrAN9V8.js";import{l as i}from"./vec4-B53Z0Xys.js";import{i as a}from"./vec4f64-BgMl3sDy.js";import{i as o,m as s,n as c,s as l}from"./Emissions.glsl-DHYGZCki.js";import{n as u}from"./glsl-C3kp6zqV.js";import{t as d}from"./Uniform-CUdn9KGj.js";import{t as f}from"./ShaderBuilder-BteJty_U.js";import{B as p,M as m,N as h,Rt as g,an as _,h as v,in as y,ln as b,n as x,nn as S,rn as C,tt as w,un as T,z as E}from"./VertexColor.glsl-B6NvE-zG.js";import{t as D}from"./Texture2DBindUniform-CV4og1sD.js";import{a as O,i as k,n as A,t as j}from"./AlphaCutoff-Bp9xYXyU.js";import{l as M}from"./ColorMaterial-CMTAmWz2.js";import{S as N,f as P,g as F,h as I,m as L,o as R,p as z,x as B}from"./RealisticTree.glsl-nypjKKTQ.js";import{t as V}from"./NormalUtils.glsl-CwL1Jn9O.js";function H(e){e.code.add(u`float normals2FoamIntensity(vec3 n, float waveStrength){
...
}`)}var G=a(),K=r();function q(e,t){if(!t.screenSpaceReflections)return;let n=e.fragment;n.include(b),n.uniforms.add(new T(`nearFar`,e=>e.camera.nearFar),new D(`depthMap`,e=>e.depth?.attachment),new g(`proj`,e=>e.camera.projectionMatrix),new S(`invResolutionHeight`,e=>1/e.camera.height),new g(`reprojectionMatrix`,e=>e.ssr.reprojectionMatrix)).code.add(u`
...
return s;
}`)}var Y=class extends d{constructor(e,t){super(e,`sampler2DArray`,0,(n,r)=>n.bindTexture(e,t(r)))}};function X(e){let t=e.fragment;t.constants.add(`radiusCloudsSquared`,`float`,Z).code.add(u`vec3 intersectWithCloudLayer(vec3 dir, vec3 cameraPosition, vec3 spherePos) {
float B = 2.0 * dot(cameraPosition, dir);
float C = dot(cameraPosition, cameraPosition) - radiusCloudsSquared;
float det = B * B - 4.0 * C;
float pointIntDist = max(0.0, 0.5 *(-B + sqrt(det)));
return (cameraPosition + dir * pointIntDist) - spherePos;
}`),t.uniforms.add(new S(`radiusCurvatureCorrection`,({clouds:e})=>e.parallax.radiusCurvatureCorrection)).code.add(u`vec3 correctForPlanetCurvature(vec3 dir) {
dir.z = dir.z * (1.0 - radiusCurvatureCorrection) + radiusCurvatureCorrection;
return dir;
}`),t.code.add(u`vec3 rotateDirectionToAnchorPoint(mat4 rotMat, vec3 inVec) {
return (rotMat * vec4(inVec, 0.0)).xyz;
}`),I(t),L(t),t.constants.add(`RIM_COLOR`,`vec3`,n(.28,.175,.035)),t.constants.add(`sunsetTransitionFactor`,`float`,.3),t.constants.add(`rimScattering`,`float`,140),t.constants.add(`backlightFactor`,`float`,.2),t.constants.add(`backlightScattering`,`float`,10),t.constants.add(`backlightTransition`,`float`,.3),t.code.add(u`vec3 calculateCloudColor(vec3 cameraPosition, vec3 worldSpaceRay, vec4 clouds) {
...
}`),e.include(J),t.uniforms.add(new v(`readChannelsRG`,e=>e.clouds.readChannels===0),new Y(`cubeMap`,e=>e.clouds.data?.cubeMap?.colorTexture)).code.add(u`vec4 sampleCloud(vec3 rayDir, bool readOtherChannel) {
vec4 s = lookupCloudsFromTextureArray(cubeMap, rayDir);
bool readRG = readChannelsRG ^^ readOtherChannel;
s = readRG ? vec4(vec3(s.r), s.g) : vec4(vec3(s.b), s.a);
return length(s) == 0.0 ? vec4(s.rgb, 1.0) : s;
}`),t.uniforms.add(new y(`anchorPoint`,e=>e.clouds.parallax.anchorPoint),new y(`anchorPointNew`,e=>e.clouds.parallaxNew.anchorPoint),new g(`rotationClouds`,e=>e.clouds.parallax.transform),new g(`rotationCloudsNew`,e=>e.clouds.parallaxNew.transform),new S(`cloudsOpacity`,e=>e.clouds.opacity),new S(`fadeFactor`,e=>e.clouds.fadeFactor),new v(`crossFade`,e=>e.clouds.fadeState===3)).code.add(u`vec4 renderClouds(vec3 worldRay, vec3 cameraPosition) {
...
}`)}var Z=(e.radius+M)**2;function Q(e,t){let n=e.fragment;n.include(z,t),n.include(l),n.include(U),t.cloudReflections&&e.include(X),e.include(q,t),n.include(P,t),n.constants.add(`fresnelSky`,`vec3`,[.02,1,15]),n.constants.add(`fresnelMaterial`,`vec2`,[.02,.1]),n.constants.add(`roughness`,`float`,.015),n.constants.add(`foamIntensityExternal`,`float`,1.7),n.constants.add(`ssrIntensity`,`float`,.65),n.constants.add(`ssrHeightFadeStart`,`float`,B),n.constants.add(`ssrHeightFadeEnd`,`float`,N),n.constants.add(`waterDiffusion`,`float`,.92),n.constants.add(`waterSeaColorMod`,`float`,.8),n.constants.add(`correctionViewingPowerFactor`,`float`,.4),n.constants.add(`skyZenitColor`,`vec3`,[.52,.68,.9]),n.constants.add(`skyColor`,`vec3`,[.67,.79,.9]),n.constants.add(`cloudFresnelModifier`,`vec2`,[1.2,.01]),n.code.add(u`PBRShadingWater shadingInfo;
