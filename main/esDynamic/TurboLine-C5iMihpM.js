import { af as le, hX as ue } from "./main-CU3_vBTl.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-JHWVOfLd.js").then((i) => i.l) : await import("./libtess-C-hquqzl.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-C5iMihpM.js.map
