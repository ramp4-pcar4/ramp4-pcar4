import{n as e}from"./glsl-BgsHvHfn.js";import{t}from"./FloatPassUniform-Tzg3-nNy.js";import{t as n}from"./Texture2DPassUniform-CGa-LtRS.js";import{t as r}from"./ShaderBuilder-uXIdT_oE.js";import{t as i}from"./HighlightCellGridScreenSpacePass.glsl-BEl2MItG.js";import{t as a}from"./IntegerPassUniform-S6Pc4k8x.js";import{a as o,s}from"./HighlightDownsample.glsl-Du4K-DOs.js";import{t as c}from"./HighlightReadBitmap.glsl-Cou-1kKv.js";import{t as l}from"./Float2DrawUniform-bcI9cAX3.js";function u(){let u=new r;u.include(i);let{fragment:d}=u;return d.uniforms.add(new n(`blurInput`,e=>e.highlightBlurTexture),new l(`blurSize`,e=>e.blurSize),new s(`highlightTexture`,e=>e.highlightTexture),new n(`highlightOptionsTexture`,e=>e.highlightOptionsTexture),new a(`highlightLevel`,e=>e.highlightLevel),new t(`occludedIntensityFactor`,e=>e.occludedFactor)),d.constants.add(`inner`,`float`,1-(9-o)/9),u.include(c),d.main.add(e`vec2 highlightTextureSize = vec2(textureSize(highlightTexture,0));
vec2 uv = sUV;
