import{E as m}from"./BufferObject-D-l7gUEn.js";import{r as c}from"./Program-JbkvDHcz.js";import{x as p,s as l}from"./Program-JbkvDHcz.js";import{cy as u}from"./main-BhjdTE9H.js";import{t as $}from"./NestedMap-Ddo7BfvO.js";import{e as d,a as h}from"./ProgramTemplate-ByHfbE-f.js";import{o as x}from"./VertexArrayObject-SuW9B4VD.js";class b{constructor(e){this._rctx=e,this._store=new $}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,r,t,i){const o=this._store.get(e,r);if(o!=null)return o.ref(),o;const s=new c(this._rctx,e,r,t,i);return s.ref(),this._store.set(e,r,s),s}get test(){}}function y(n){const{options:e,value:r}=n;return typeof e[r]=="number"}function _(n){let e="";for(const r in n){const t=n[r];if(typeof t=="boolean")t&&(e+=`#define ${r}
