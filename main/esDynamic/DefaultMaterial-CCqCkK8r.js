import{o as L,H as Ue,s as Zt,A as $t,c as Me,r as Xt,g as ke,P as Kt,N as Qt}from"./vec32-tK8oAMbp.js";import{g0 as Te,aw as x,cQ as A,cX as _e,_ as c,T as D,U as Ye,L as ea,dg as ta,go as aa,ll as oa,hS as ra,o1 as Je,o2 as ia,o3 as na,hJ as $,hI as Se,gu as qe,gm as sa,o4 as j,hR as ie,f6 as ne,as as la,eA as ca,aG as da,dX as ua,cR as ha}from"./main-CX1EfQb_.js";import{a6 as V,i as se,d as le,a7 as O,a as Ze,a8 as ce,a9 as $e,aa as Xe,ab as ma,ac as B,ad as pa,ae as fa,af as va,f as ga,ag as X,r as I,a2 as K,D as H,E as W,ah as U,G as Q,b as y,I as k,ai as xa,H as ba,aj as wa,ak as Ke,q as de,al as Qe,o as et,am as tt,g as ya,j as Ce,k as ue,s as at,an as Ma,ao as Ta,u as _a,v as ot,ap as Sa,aq as _,ar as ze,as as Ca,at as za,c as ee,au as Fa,X as te,av as Na,M as Oa,aw as rt,ax as he,F as it,L as nt,K as st,ay as lt,J as ct,N as Ia,T as La,O as Va,P as Ra,Q as Ea,R as Pa,U as Ga,V as Aa,W as Da,Y as ja,x as m,A as Ba,az as Fe,aA as Ne,a1 as Ha,aB as Wa,B as Ua,aC as ka,a3 as Ya,aD as Ja}from"./OutputColorHighlightOID.glsl-pat-XR9A.js";import{n as dt,r as qa}from"./vec4f64-DD-nkcCV.js";import{t as Oe,Q as Ie}from"./InterleavedLayout-k1kCzFJj.js";import{t as i,n as p}from"./glsl-CfY1Aoj6.js";import{s as S,T as ut,g as me,I as ht}from"./BufferView-Cf1yn8de.js";import{r as Za}from"./VertexBuffer-DPyv-SZh.js";import{c as $a}from"./mat4-Di7c9l3m.js";import{g as Xa}from"./plane-w_t9WdCs.js";import{a as Ka,n as mt}from"./vec2f64-CkowXrDb.js";import{s as pe}from"./ShaderBuilder-BUbBVDBP.js";import{T as Le,d as Ve,_ as Qa}from"./renderState-CsafAKLy.js";import{n as eo}from"./enums-DDJfd4_p.js";import{h as to,A as ao}from"./Texture-B36GKzGR.js";import{s as C}from"./vec42-DNH8AGg_.js";import{t as oo}from"./VertexAttributeLocations-DBgVVQz-.js";function fe(e,t){switch(e.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
}`)}function Ge(e,t){e.include(ze),t.pbrMode!==1&&t.pbrMode!==2&&t.pbrMode!==5&&t.pbrMode!==6||(e.code.add(i`float normalDistribution(float NdotH, float roughness)
{
...
}`)}function we(e){e.constants.add("ambientBoostFactor","float",za)}function ye(e){e.uniforms.add(new V("lightingGlobalFactor",t=>t.lighting.globalFactor))}function Ae(e,t){const a=e.fragment,{pbrMode:r,spherical:o,hasColorTexture:s}=t;a.include(be,t),r!==0&&a.include(Ge,t),e.include(Rt,t),a.include(ze),a.include(Pt,t);const n=!(r===2&&!s);switch(n&&a.include(Po),a.code.add(i`
...
return outColor;
}`)}}function Gt(e,t){const a=e.fragment;switch(a.code.add(i`struct ShadingNormalParameters {
vec3 normalView;
vec3 viewDirection;
...
}`);break;default:Te(t.doubleSidedMode);case 3:}}function De(e,t){const a=t.pbrMode,r=e.fragment;if(a!==2&&a!==0&&a!==1)return void r.code.add(i`void applyPBRFactors() {}`);if(a===0)return void r.code.add(i`void applyPBRFactors() {}
...
float occlusion;`),o&&r.uniforms.add(d===1?new y("texMetallicRoughness",u=>u.textureMetallicRoughness):new de("texMetallicRoughness",u=>u.textureMetallicRoughness)),n&&r.uniforms.add(d===1?new y("texOcclusion",u=>u.textureOcclusion):new de("texOcclusion",u=>u.textureOcclusion)),r.uniforms.add(d===1?new ee("mrrFactors",u=>u.mrrFactors):new Fa("mrrFactors",u=>u.mrrFactors)),r.code.add(i`
  ...
  `)}function Go(e,t){const a=te(t.output)&&t.receiveShadows;a&&Mo(e,!0),e.vertex.code.add(i`
    void forwardLinearDepthToReadShadowMap() { ${p(a,"forwardLinearDepth(gl_Position.w);")} }
  `)}let Ao=class extends se{constructor(e,t,a,r){super(e,"mat4",2,(o,s,n,l)=>o.setUniformMatrices4fv(e,t(s,n,l),r),a)}},Do=class extends se{constructor(e,t,a,r){super(e,"mat4",1,(o,s,n)=>o.setUniformMatrices4fv(e,t(s,n),r),a)}};function jo(e){e.fragment.uniforms.add(new Do("shadowMapMatrix",(t,a)=>a.shadowMap.getShadowMapMatrices(t.origin),4)),At(e)}function Bo(e){e.fragment.uniforms.add(new Ao("shadowMapMatrix",(t,a)=>a.shadowMap.getShadowMapMatrices(t.origin),4)),At(e)}function At(e){const{fragment:t}=e;t.uniforms.add(new _("cascadeDistances",a=>a.shadowMap.cascadeDistances),new Na("numCascades",a=>a.shadowMap.numCascades)),t.code.add(i`const vec3 invalidShadowmapUVZ = vec3(0.0, 0.0, -1.0);
...
}`)}let Wo=class extends se{constructor(e,t){super(e,"sampler2DShadow",0,(a,r)=>a.bindTexture(e,t(r)))}};function Dt(e,t){t.receiveShadows&&e.include(jo),jt(e,t)}function je(e,t){t.receiveShadows&&e.include(Bo),jt(e,t)}function jt(e,t){e.fragment.uniforms.add(new V("lightingGlobalFactor",o=>o.lighting.globalFactor));const{receiveShadows:a,spherical:r}=t;e.include(Go,t),a&&Uo(e),e.fragment.code.add(i`
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
    ...
    vpos = subtractOrigin(vpos);
    ${p(G,"vNormalWorld = dpNormal(vvLocalNormal(normalModel()));")}
    vpos = addVerticalOffset(vpos, localOrigin);
    ${p(N,"vTangent = dpTransformVertexTangent(tangent);")}
    gl_Position = transformPosition(proj, view, vpos);
    ${p(G&&d,"gl_Position = offsetBackfacingClipPosition(gl_Position, vpos, vNormalWorld, cameraPosition);")}
  ...
  `),t.include(Ae,e),o.include(be,e),t.include(J,e),o.include(k,e),t.include(ct,e),he(o,e),o.uniforms.add(r.uniforms.get("localOrigin"),new ee("ambient",w=>w.ambient),new ee("diffuse",w=>w.diffuse),new I("opacity",w=>w.opacity),new I("layerOpacity",w=>w.layerOpacity)),R&&o.uniforms.add(new y("tex",w=>w.texture)),t.include(De,e),o.include(Ge,e),o.include(Bt),t.include(Gt,e),o.include(Be,e),we(o),ye(o),q(o),o.main.add(i`
    discardBySlice(vpos);
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:F}=e;return t.include(Ae,e),o.include(be,e),t.include(J,e),o.include(k,e),t.include(ct,e),he(o,e),re(o),we(o),ye(o),o.uniforms.add(r.uniforms.get("localOrigin"),r.uniforms.get("view"),new ee("ambient",f=>f.ambient),new ee("diffuse",f=>f.diffuse),new I("opacity",f=>f.opacity),new I("layerOpacity",f=>f.layerOpacity)),M&&o.uniforms.add(new y("tex",f=>f.texture)),t.include(De,e),o.include(Ge,e),o.include(Bt),o.include(Be,e),q(o),o.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();
