import { hX as K, bh as D } from "./main-DTp7aoS1.js";
import { y as X } from "./DoubleArray-DFXFtlFg.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-yd8T_QC8.js";
import { n as Z, s as ee } from "./vec3-D7PkW_ov.js";
import "./sphere-FofXEKiL.js";
import "./I3SUtil-CB7ZvAED.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-Dv66felA.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-DTp7aoS1.js").then((d) => d.qK), import("./main-DTp7aoS1.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-C9Fl1SDW.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-D7YjnMJK.js.map
