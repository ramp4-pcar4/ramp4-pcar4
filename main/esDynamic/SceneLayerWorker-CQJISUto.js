import { hX as K, bh as D } from "./main-CU3_vBTl.js";
import { y as X } from "./DoubleArray-42jokqha.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-BGvlsnvH.js";
import { n as Z, s as ee } from "./vec3-ZJo2Rwa5.js";
import "./sphere-Cwkk070u.js";
import "./I3SUtil-BzCJFDpQ.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-DEFMtfCi.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-CU3_vBTl.js").then((d) => d.qK), import("./main-CU3_vBTl.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-B5vIToUU.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-CQJISUto.js.map
