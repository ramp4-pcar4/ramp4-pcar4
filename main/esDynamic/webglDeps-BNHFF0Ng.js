import{E as m,o as p}from"./VertexArrayObject-DTKu-4Q0.js";import{R as l,s as u}from"./FramebufferObject-YRGlklaH.js";import{a as c}from"./ProgramTemplate-C8toXIkz.js";import{e as d,b as $}from"./ProgramTemplate-C8toXIkz.js";import"./main-DEL9KTOT.js";import{t as b}from"./NestedMap-DL9KstBd.js";import{S as h}from"./Texture-CM_RaiEy.js";class x{constructor(e){this._rctx=e,this._store=new b}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,r,i){const s=this._store.get(e,t);if(s!=null)return s.ref(),s;const o=new c(this._rctx,e,t,r,i);return o.ref(),this._store.set(e,t,o),o}get test(){}}function _(n){const{options:e,value:t}=n;return typeof e[t]=="number"}function g(n){let e="";for(const t in n){const r=n[t];if(typeof r=="boolean")r&&(e+=`#define ${t}
