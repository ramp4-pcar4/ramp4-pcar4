import{E as m}from"./BufferObject-DDl5qP0O.js";import{r as c}from"./Program-fFBpoi-0.js";import{x as p,s as l}from"./Program-fFBpoi-0.js";import"./main-Dr7xMPVG.js";import{t as u}from"./NestedMap-Ddo7BfvO.js";import{e as $,a as d}from"./ProgramTemplate-DXKUVDVC.js";import{m as b}from"./Texture-mYbfawXF.js";import{o as h}from"./VertexArrayObject-BZmVLF70.js";class x{constructor(e){this._rctx=e,this._store=new u}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,r,t,i){const o=this._store.get(e,r);if(o!=null)return o.ref(),o;const s=new c(this._rctx,e,r,t,i);return s.ref(),this._store.set(e,r,s),s}get test(){}}function _(n){const{options:e,value:r}=n;return typeof e[r]=="number"}function y(n){let e="";for(const r in n){const t=n[r];if(typeof t=="boolean")t&&(e+=`#define ${r}
