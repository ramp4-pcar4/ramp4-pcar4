import{P as e}from"./typedArrayUtil-xhTyVct8.js";import{t}from"./Error-Cn9vOwr6.js";import{r as n}from"./tslib.es6-CVTII-xV.js";import{r,s as i}from"./vec3f64-AlvO6xQn.js";import{t as a}from"./mat4f64-CfZSfBjp.js";import{x as o}from"./mat4-DSO-PSgk.js";import{j as s,r as c,x as l,y as u}from"./vec3-BvdLhmU_.js";import{o as d}from"./Emissions.glsl-DHYGZCki.js";import{n as f}from"./glsl-C3kp6zqV.js";import{t as p}from"./Uniform-CUdn9KGj.js";import{t as m}from"./Texture2DBindUniform-CV4og1sD.js";import{t as h}from"./NoParameters-CWYi4J7C.js";import{t as g}from"./HighlightReadBitmap.glsl-BqTbLoiU.js";var _=class{constructor(e){this._bits=[...e]}equals(t){return e(this._bits,t.bits)}get code(){return this._code??=String.fromCharCode(...this._bits),this._code}get bits(){return this._bits}},v=class extends h{constructor(){super(),this._parameterBits=this._parameterBits?.map(()=>0)??[],this._parameterNames??=[]}get key(){return this._key??=new _(this._parameterBits),this._key}decode(e=this.key){let t=this._parameterBits;this._parameterBits=[...e.bits];let n=this._parameterNames.map(e=>`    ${e}: ${this[e]}`).join(`
