import{P as e}from"./typedArrayUtil-DYSyCOD_.js";import{t}from"./Error-BqTd97mZ.js";import{r as n}from"./tslib.es6-D23imAM7.js";import{r,s as i}from"./vec3f64-CG5ySZkG.js";import{t as a}from"./mat4f64-B3SVWMa-.js";import{x as o}from"./mat4-DKlWb7nH.js";import{j as s,r as c,x as l,y as u}from"./vec3-DxYpf0me.js";import{n as d}from"./glsl-BgsHvHfn.js";import{t as f}from"./Uniform-7hXEBJFC.js";import{t as p}from"./Float3DrawUniform-R1mzpNMr.js";import{t as m}from"./Texture2DBindUniform-axEjUMhA.js";import{t as h}from"./NoParameters-BB6oVGYE.js";import{t as g}from"./HighlightReadBitmap.glsl-Cou-1kKv.js";var _=class{constructor(e){this._bits=[...e]}equals(t){return e(this._bits,t.bits)}get code(){return this._code??=String.fromCharCode(...this._bits),this._code}get bits(){return this._bits}},v=class extends h{constructor(){super(),this._parameterBits=this._parameterBits?.map(()=>0)??[],this._parameterNames??=[]}get key(){return this._key??=new _(this._parameterBits),this._key}decode(e=this.key){let t=this._parameterBits;this._parameterBits=[...e.bits];let n=this._parameterNames.map(e=>`    ${e}: ${this[e]}`).join(`
