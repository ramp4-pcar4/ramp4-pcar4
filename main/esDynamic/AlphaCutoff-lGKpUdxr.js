import{P as e}from"./typedArrayUtil-DYSyCOD_.js";import{t}from"./Error-ndV5rHvq.js";import{r as n}from"./tslib.es6-D23imAM7.js";import{r,s as i}from"./vec3f64-CG5ySZkG.js";import{t as a}from"./mat4f64-B3SVWMa-.js";import{x as o}from"./mat4-C2gx1S7R.js";import{j as s,r as c,x as l,y as u}from"./vec3-D0JSMCWt.js";import{n as d}from"./glsl-EDZkDhgF.js";import{t as f}from"./Uniform-Dp2mgLmf.js";import{t as p}from"./Float3DrawUniform-CLaN-1NK.js";import{t as m}from"./Texture2DBindUniform-BjIiNL3v.js";import{t as h}from"./NoParameters-DvFAVXX5.js";import{t as g}from"./HighlightReadBitmap.glsl-O45u9_r0.js";var _=class{constructor(e){this._bits=[...e]}equals(t){return e(this._bits,t.bits)}get code(){return this._code??=String.fromCharCode(...this._bits),this._code}get bits(){return this._bits}},v=class extends h{constructor(){super(),this._parameterBits=this._parameterBits?.map(()=>0)??[],this._parameterNames??=[]}get key(){return this._key??=new _(this._parameterBits),this._key}decode(e=this.key){let t=this._parameterBits;this._parameterBits=[...e.bits];let n=this._parameterNames.map(e=>`    ${e}: ${this[e]}`).join(`
