import { am as m, au as d, a2 as u, K as w, s as p } from "./main-HRT6IzE_.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-CWIYa4DD.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-CFtEayaR.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-B1VKxCEc.js.map
