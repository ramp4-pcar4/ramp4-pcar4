import{n as e}from"./glsl-BgsHvHfn.js";import{t}from"./ShaderBuilder-Dy-kUWY5.js";import{t as n}from"./Float4PassUniform-DsukPcOl.js";import{a as r,i}from"./AlphaCutoff-CuHez9y6.js";import{t as a}from"./ObjectAndLayerIdColor.glsl-CmAKBg45.js";import{t as o}from"./VisualVariables.glsl-DHId4inM.js";import{n as s}from"./View.glsl-DXY3WEB3.js";import{t as c}from"./TerrainDepthTest.glsl-DaP2filK.js";import{t as l}from"./OutputColorHighlightOLID.glsl-CII2xE3L.js";import{t as u}from"./Transform.glsl-Dc4LVo-U.js";import{t as d}from"./VertexColor.glsl-wJbZIFoT.js";function f(f){let p=new t,{vertex:m,fragment:h,attributes:g,varyings:_}=p,{hasVVColor:v,hasVertexColors:y}=f;return s(m,f),p.include(u),p.include(d,f),p.include(o,f),p.include(a,f),h.include(r,f),p.include(l,f),p.include(c,f),g.add(`position`,`vec3`),v&&g.add(`colorFeatureAttribute`,`float`),y||_.add(`vColor`,`vec4`),_.add(`vpos`,`vec3`,{invariant:!0}),m.uniforms.add(new n(`uColor`,e=>e.color)),m.main.add(e`
      vpos = position;
      forwardVertexColor();
