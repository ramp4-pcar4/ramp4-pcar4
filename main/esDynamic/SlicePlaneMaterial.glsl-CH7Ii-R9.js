import{E as e,L as t,g as n,w as r,x as i}from"./TriangleTechniqueConfiguration-AC7R9w2G.js";import{d as a,f as o,l as s}from"./oitResolution.glsl-CICnBLk1.js";import{t as c}from"./ShaderBuilder-M5PWHQdC.js";function l(l){let u=new c,{vertex:d,fragment:f,attributes:p,varyings:m}=u;return e(d,l),u.include(n,l),f.include(i),f.include(r),p.add(`position`,`vec3`),p.add(`uv0`,`vec2`),m.add(`vUV`,`vec2`),d.main.add(o`vUV = uv0;
