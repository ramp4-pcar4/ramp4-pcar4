import { af as le, hX as ue } from "./main-HRT6IzE_.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-Cy3BqUiH.js").then((i) => i.l) : await import("./libtess-D9z2uAM7.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-CD6rbdbh.js.map
