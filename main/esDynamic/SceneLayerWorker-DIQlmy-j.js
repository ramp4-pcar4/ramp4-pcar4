import { hX as K, bh as D } from "./main-HRT6IzE_.js";
import { y as X } from "./DoubleArray-DXP659Qh.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-DeMEVuDL.js";
import { n as Z, s as ee } from "./vec3-DByVV_fb.js";
import "./sphere-CoDZwITw.js";
import "./I3SUtil-CPOXnuP7.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-BkssXFkm.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-HRT6IzE_.js").then((d) => d.qK), import("./main-HRT6IzE_.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-DmzlW6Zs.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-DIQlmy-j.js.map
