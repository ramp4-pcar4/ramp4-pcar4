import { af as le, hX as ue } from "./main-DTp7aoS1.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-DE_yMDFS.js").then((i) => i.l) : await import("./libtess-TWhfPtRv.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-DRkgIzpl.js.map
