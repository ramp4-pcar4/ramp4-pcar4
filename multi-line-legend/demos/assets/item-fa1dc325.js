...
const _withScopeId = (n) => (pushScopeId("data-v-3f26c0d8"), n = n(), popScopeId(), n);
...
const _hoisted_5 = /* @__PURE__ */ createStaticVNode('<path d="M0 0h24v24H0V0z" fill="none" data-v-3f26c0d8></path><path d="M0 0h24v24H0V0z" fill="none" data-v-3f26c0d8></path><circle cx="15.5" cy="9.5" r="1.5" data-v-3f26c0d8></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-3f26c0d8></circle><circle cx="15.5" cy="9.5" r="1.5" data-v-3f26c0d8></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-3f26c0d8></circle><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-2.5c2.33 0 4.32-1.45 5.12-3.5h-1.67c-.69 1.19-1.97 2-3.45 2s-2.75-.81-3.45-2H6.88c.8 2.05 2.79 3.5 5.12 3.5z" data-v-3f26c0d8></path>', 7);
const _hoisted_12 = [
  _hoisted_5
];
const _hoisted_13 = {
...
const _hoisted_14 = /* @__PURE__ */ createStaticVNode('<path d="M0 0h24v24H0V0z" fill="none" data-v-3f26c0d8></path><path d="M0 0h24v24H0V0z" fill="none" data-v-3f26c0d8></path><circle cx="15.5" cy="9.5" r="1.5" data-v-3f26c0d8></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-3f26c0d8></circle><circle cx="15.5" cy="9.5" r="1.5" data-v-3f26c0d8></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-3f26c0d8></circle><path d="M 20,12C 20,7.6 16.4,4 12,4C 7.6,4 4,7.6 4,12C 4,16.4 7.6,20 12,20C 16.4,20 20,16.4 20,12 Z M 22,12C 22,17.5 17.5,22 12,22C 6.5,22 2,17.5 2,12C 2,6.5 6.5,2.00001 12,2.00001C 17.5,2.00001 22,6.5 22,12 Z M 15.5,8C 16.3,8 17,8.7 17,9.5C 17,10.3 16.3,11 15.5,11C 14.7,11 14,10.3 14,9.5C 14,8.7 14.7,8 15.5,8 Z M 10,9.5C 10,10.3 9.3,11 8.5,11C 7.7,11 7,10.3 7,9.5C 7,8.7 7.7,8 8.5,8C 9.3,8 10,8.7 10,9.5 Z M 12,14C 13.7524,14 15.2943,14.7212 16.1871,15.8129L 14.7697,17.2302C 14.3175,16.5078 13.2477,16 12,16C 10.7523,16 9.68254,16.5078 9.23024,17.2302L 7.81291,15.8129C 8.7057,14.7212 10.2476,14 12,14 Z" data-v-3f26c0d8></path>', 7);
const _hoisted_21 = [
  _hoisted_14
];
...
const _hoisted_27 = { class: "line-clamp-2 h-auto text-ellipsis" };
const _hoisted_28 = {
  key: 4,
...
const _hoisted_41 = { class: "flex p-8" };
const _hoisted_42 = {
  key: 0,
...
const item_vue_vue_type_style_index_0_scoped_3f26c0d8_lang = '';

const item = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3f26c0d8"]]);
