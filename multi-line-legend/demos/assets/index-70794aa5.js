import { bB as FixtureInstance, i6 as useLegendStore, iD as SectionItem, iE as LayerItem, iF as LegendItem, iG as LayerType, iH as LayerInstance, bG as defineComponent, bH as useI18n, bI as inject, bK as resolveComponent, bM as openBlock, bN as createBlock, bO as withCtx, bR as unref, fE as createBaseVNode, he as markRaw, hf as useAppbarStore, hg as useMapnavStore } from './main-ea2ac364.js';
import { _ as _sfc_main$1 } from './screen.vue_vue_type_script_setup_true_lang-bc05aee3.js';
...
class LegendAPI extends FixtureInstance {
  ...
  _parseConfig(legendConfig) {
    ...
    useLegendStore(this.$vApp.$pinia).multilineItems = legendConfig.root?.multilineItems ?? false;
