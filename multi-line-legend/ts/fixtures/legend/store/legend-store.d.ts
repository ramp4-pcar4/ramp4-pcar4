...
export declare const useLegendStore: import("pinia").StoreDefinition<"legend", import("pinia")._UnwrapAll<Pick<LegendStore, "children" | "legendConfig" | "headerControls" | "multilineItems">>, Pick<LegendStore, never>, Pick<LegendStore, "addItem" | "removeItem" | "replaceItem">>;
export {};
