...
class ClientSideData extends LayerBlueprintMixin {
    ...
    async loadData(): Promise<BaseLayer> {
...
class FeatureServiceSource extends mixins(BlueprintBase, ServerSideData) {
    ...
    get layerRecordFactory(): LayerRecordFactory {
        return api.geoapi.layers.createFeatureLayer  // TODO: gapiService.gapi.layer.createFeatureRecord;
    }
...
class MapImageServiceSource extends mixins(BlueprintBase, ServerSideData) {
    ...
    get layerRecordFactory(): LayerRecordFactory {
        return api.geoapi.layers.createMapImageLayer  // TODO: gapiService.gapi.layer.createMapImageRecord;
    }
...
class WFSServiceSource extends mixins(BlueprintBase, ClientSideData) {
     ...
     * @memberof WFSServiceSource
     */
    async loadData(): Promise<BaseLayer> {  // TODO make this return type 'WFSLayer' when implemented
    ...
    get layerRecordFactory(): LayerRecordFactory {
        return api.geoapi.layers.createGeoJSONLayer;  // TODO: gapiService.gapi.layer.createFeatureRecord;
    }
