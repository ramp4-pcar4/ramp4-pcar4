<template>
    <div class="legend-item">
        <div class="relative">
            <div class="default-focus-style p-5 flex items-center hover:bg-gray-200 cursor-pointer h-44" @click="toggleGrid" v-focus-item>
                <!-- symbology stack toggle-->
                <div class="relative w-32 h-32">
                    <button
                        @click.stop="toggleSymbology"
                        tabindex="-1"
                        :class="{ 'cursor-default': !legendItem._controlAvailable('symbology') }"
                        :disabled="!legendItem._controlAvailable('symbology')"
                    >
                        <symbology-stack
                            :class="{ 'pointer-events-none': !legendItem._controlAvailable('symbology') }"
                            class="w-32 h-32"
                ...
                <div @click.stop class="options hidden cursor-auto">
                    <dropdown-menu position="right">
                        ...
                        <a
                            ...
                            :class="{ disabled: !legendItem._controlAvailable(`metadata`) }"
                        ...
                        <a
                            ...
                            :class="{ disabled: !legendItem._controlAvailable(`settings`) }"
                        ...
                        <a
                            href="#"
                            class="flex leading-snug items-center w-auto"
                            :class="{ disabled: !legendItem._controlAvailable(`datatable`) }"
                            @click="toggleGrid"
                        >
                            <svg class="fill-current w-18 h-18 mr-10" viewBox="0 0 23 21">
                                <path
                        ...
                        <a
                            href="#"
                            class="flex leading-snug items-center w-auto"
                            :class="{ disabled: !legendItem._controlAvailable(`symbology`) }"
