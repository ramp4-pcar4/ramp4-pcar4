...
export default class CheckboxV extends Vue {
    ...
    toggleVisibility(): void {
        if (
            this.value instanceof LegendGroup ||
            this.value instanceof LegendEntry ||
            this.value instanceof LegendSet ||
            this.value instanceof LegendItem
        ) {
            ...
            if (this._noSymbolsVisible()) {
                ...
                this.legendItem._layer?.getLegend().forEach(item => {
                    ...
                    item.definitionVisibility = false;
                });

                this.value.visibility = true;
                this.value.definitionVisibility = true;
                ...
                this.value.definitionVisibility = !this.value
                    .definitionVisibility;
                this.value.visibility = this.value.definitionVisibility;
            }
        ...
        this.legendItem.layer?.setSqlFilter(
            ...
            this.legendItem.layer
                ?.getLegend()
                .filter(item => item.definitionVisibility === true)
