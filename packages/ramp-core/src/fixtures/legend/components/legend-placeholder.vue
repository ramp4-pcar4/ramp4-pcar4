...
export default class LegendPlaceholder extends Vue {
    ...
    mounted() {
        // Check to see if the layer has been loaded.

        // Note: I don't think this is the most optimal way of doing this. If there's a way to "watch" the
        // layers list that would probably be a better way of solving htis.
        let loader = setInterval(() => {
            this.layer = this.layers.find((layer: BaseLayer) => layer.id === this.legendItem.id);
