...
export default class TableComponent extends Vue {
    ...
    @Get('layer/getLayerByUid') getLayerByUid!: (id: string) => FeatureLayer | undefined;
    ...
    beforeMount() {
        ...
        const fancyLayer: FeatureLayer | undefined = this.getLayerByUid(this.layerUid);
        ...
        if (col.field === 'rvInteractive') {
            ...
            let zoomDef = {
                ...
                onCellClicked: (cell: any) => {
                    const layer: FeatureLayer | undefined = this.getLayerByUid(this.layerUid);
