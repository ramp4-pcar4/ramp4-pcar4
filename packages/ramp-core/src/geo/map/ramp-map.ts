...
export class MapAPI extends CommonMapAPI {
    ...
    */
    ...
    /**
     * Get current con for maptips
     *
     * @returns the maptip content
     */
    getMaptipContent(): any {
        return this.$iApi.$vApp.$store.get(MaptipStore.content)!;
    }
     ...
     *
     * @param content the new maptip html content
     */
     ...
     *
     * @param content the new default maptip html content
     */
