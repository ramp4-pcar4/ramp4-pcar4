    ...
    */
    ...
    updateAttribution(newAttribution: Attribution) {
        ...
        let attribution: Attribution = {
            text: { enabled: true, value: 'Powered by ESRI' },
            logo: {
                enabled: true,
                altText: 'ESRI logo',
        ...
        if (newAttribution.text.enabled) {
            attribution.text.value = newAttribution.text.value;
        }

        if (newAttribution.logo.enabled) {
            attribution.logo.altText = newAttribution.logo.altText;
            attribution.logo.link = newAttribution.logo.link;
            attribution.logo.value = newAttribution.logo.value;
        }
