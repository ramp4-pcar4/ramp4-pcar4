...
import { _ as H, d as L, F as X, G as ee } from "./main-CPv_0f0u.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-D1l57N4z.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BpI2_Y4b.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CCihgxtr.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-dbZtpE5C.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CFsr41mv.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BDLydApk.js")))
      }), s;
    }), n = (s) => {
