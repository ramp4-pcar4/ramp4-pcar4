...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-CPv_0f0u.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-dbZtpE5C.js"), "./icons/edit-icon.vue": () => import("./edit-icon-BDLydApk.js"), "./icons/point-icon.vue": () => import("./point-icon-D1l57N4z.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-CCihgxtr.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-BpI2_Y4b.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-CFsr41mv.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
