const r=(s,i,e)=>{const t={id:"dataJson",name:"Tasty Eats",layerType:"data-json",rawData:'{"fields":["Resto Name","Resto Type","Stars"],"data":[["Grouse Burgers","Burger",5],["Greasy Patties","Burger",2],["Big Dirty Slice","Pizza",3]]}',nameField:"Resto-Name",fixtures:{details:{template:"Tasty-Template"}}},a={id:"table",name:"JOSM Theme Count",layerType:"data-esri-table",url:"https://section917.canadacentral.cloudapp.azure.com/arcgis/rest/services/TestData/Oilsands/MapServer/5"};return e.addLayerLegend(t),e.addLayerLegend(a),{config:s,options:i}},n=(s,i)=>{s.$element.component("Tasty-Template",{props:["identifyData"],template:`
