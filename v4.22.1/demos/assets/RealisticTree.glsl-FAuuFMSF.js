const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./SSAOBlur.glsl-CUtsIP50.js","./SceneLighting-C1eOk2PG.js","./store-DqDAc_Fp.js","./preload-helper-C6XEuiEO.js","./store-CGbH87qM.css","./decorators-CY_9aKAW.js","./Accessor-B3p-rFkt.js","./scheduling-COgD-3vL.js","./reactiveUtils-CtpcLdlt.js","./Evented-Doo2IgTS.js","./SpatialReference-DuM17WPC.js","./JSONSupport-4s7EVpxl.js","./Extent-D1l1ZCG-.js","./aaBoundingRect-rKtgQWGy.js","./Polygon-DuWAT_DH.js","./zmUtils-od9S__wu.js","./curveExtent-NVlIa-VA.js","./ellipticArc7Utils-DaOkjZg_.js","./plane-Bq-rdEiK.js","./sphere-plXZDjIl.js","./projectPointToVector-C6t0P5dB.js","./projectionUtils-ChU9zlYw.js","./Multipoint-bPeReMFy.js","./Polyline-BvND5KYh.js","./spatialReferenceEllipsoidUtils-BDTv7UbS.js","./GeographicTransformation-LtyVG7Oj.js","./Clonable-Cr3jOZCn.js","./computeTranslationToOriginAndRotation-CMxibBAm.js","./localRotationUtils-D2C2YcxI.js","./BufferView-DLHsH9re.js","./TriangleTechniqueConfiguration-CZtz6Ys9.js","./screenUtils-BjEA_qFF.js","./Indices-CuO6nnRi.js","./frustum-bkvq2BKy.js","./Attribute-DyLIUiq7.js","./lineSegment-CtfXp8cW.js","./checkWebGLError-DXByBTnT.js","./enums-CsvnPRfA.js","./renderState-EnrTw9Zp.js","./VertexAttributeLocations-BG2o2gIs.js","./VertexElementDescriptor-DVcI4qMB.js","./oitResolution.glsl-BuRgfwx5.js","./NoParameters-ZDc3QXO4.js","./Emissions.glsl-BXpXENNO.js","./Texture-BIdFiB7o.js","./Cyclical-DT-IfQDa.js","./projectVectorToVector-DzWdvvV0.js","./HUDIntersectorResult-Cd1QzwP4.js","./orientedBoundingBox-Ck1gYE4u.js","./quat-Eyc5D2y3.js","./normalizeUtils-BylaQEnW.js","./jsonUtils-CjSPXO6l.js","./utils-DT-4dfEH.js","./utils-zUpM_lWC.js","./normalizeUtilsCommon-ElXC5YX5.js","./densifyCurvedGeometry-BuzZRt-M.js","./RenderingContext-C40IIuzn.js","./VertexArrayObject-DqELAzFt.js","./ProgramCache-BhA7tsmN.js","./VertexBuffer-C3N8awHE.js","./DebugRendererInfo-IzJAyK7D.js","./videoUtils-Bf4CqIbX.js","./image-LoojD4qW.js","./ShaderBuilder-CWcV0kuW.js","./BooleanBindUniform-z61SaPGH.js","./SSAO.glsl-r4FkdixM.js","./GlobalIlluminationBlur.glsl-CLXdrZOW.js","./GlobalIlluminationColorQuantization.glsl-DXkBN-QF.js","./GlobalIlluminationWeights.glsl-C4xUJTBH.js","./GlobalIllumination.glsl-C4df0PY-.js","./ScreenSpaceRayMarching.glsl-CrAKl2rA.js","./GlobalIlluminationUpscale.glsl-Cs0hxRJa.js"])))=>i.map(i=>d[i]);
import{Bu as e,If as t,Jg as n,Ji as r,Kd as i,Mg as a,O_ as o,Si as s,Wd as c,Xi as l,Yu as u,Zu as d,du as f,k_ as p,qu as m,su as h,tf as g,uy as _}from"./store-DqDAc_Fp.js";import{t as v}from"./preload-helper-C6XEuiEO.js";import{n as y,t as b}from"./decorators-CY_9aKAW.js";import{c as x,s as S}from"./reactiveUtils-CtpcLdlt.js";import{A as C,B as w,C as T,D as ee,Dt as te,E,H as ne,It as D,L as re,M as ie,N as O,Ot as ae,P as k,R as oe,Rt as A,S as se,T as ce,V as j,W as M,_ as le,b as ue,g as de,j as N,v as fe,x as pe,xt as P,y as F,z as me}from"./TriangleTechniqueConfiguration-CZtz6Ys9.js";import{s as he,t as ge}from"./Texture-BIdFiB7o.js";import{_ as _e,a as ve,g as ye,h as I,i as be,m as xe,o as Se,t as Ce,u as we,v as L}from"./SceneLighting-C1eOk2PG.js";import{g as Te,n as R}from"./enums-CsvnPRfA.js";import{n as z,o as B}from"./renderState-EnrTw9Zp.js";import{a as Ee,c as V,d as H,f as U,i as W,l as G,o as De,r as K,s as q,t as Oe,u as ke}from"./oitResolution.glsl-BuRgfwx5.js";import{t as J}from"./NoParameters-ZDc3QXO4.js";import{t as Y}from"./ShaderBuilder-CWcV0kuW.js";import{i as Ae,m as je,n as Me,r as X}from"./Emissions.glsl-BXpXENNO.js";import{c as Ne,l as Z,o as Pe,s as Fe,t as Ie,u as Le}from"./BooleanBindUniform-z61SaPGH.js";import{a as Re,i as ze,n as Q,o as Be,r as Ve,s as He,t as Ue}from"./VertexColor.glsl-CYdsgBys.js";import{i as We,n as Ge,r as Ke,t as qe}from"./ScreenSpaceRayMarching.glsl-CrAKl2rA.js";import{t as Je}from"./GlobalIlluminationColorQuantization.glsl-DXkBN-QF.js";import{t as Ye}from"./GlobalIlluminationWeights.glsl-C4xUJTBH.js";function Xe(e,t){switch(e.fragment.code.add(U`vec3 screenDerivativeNormal(vec3 positionView) {
...
}`);break;case 2:e.vertex.code.add(U`void forwardNormal() {}`);break;default:t.normalType;case 3:}}var Qe=class extends Re{constructor(){super(...arguments),this.transformNormalViewFromGlobal=c()}},$e=class extends ze{constructor(){super(...arguments),this.toMapSpace=s()}};function et({normalTexture:e,metallicRoughnessTexture:t,metallicFactor:n,roughnessFactor:r,emissiveTexture:i,emissiveFactor:a,occlusionTexture:o}){return e==null&&t==null&&i==null&&(a==null||f(a,m))&&o==null&&(r==null||r===1)&&(n==null||n===1)}var tt=u(1,1,.5),nt=u(0,.6,.2),rt=u(0,1,.2);function it(e){e.vertex.code.add(U`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
return color;
}`)}var ot=c();function st(t,n){let{hasModelTransformation:r,instancedDoublePrecision:i,instanced:a,output:o,hasVertexTangents:s}=n;r&&(t.vertex.uniforms.add(new Fe(`model`,e=>e.modelTransformation??h)),t.vertex.uniforms.add(new k(`normalLocalOriginFromModel`,e=>(g(ot,e.modelTransformation??h),ot)))),a&&i&&(t.attributes.add(`instanceModelOriginHi`,`vec3`),t.attributes.add(`instanceModelOriginLo`,`vec3`),t.attributes.add(`instanceModel`,`mat3`),t.attributes.add(`instanceModelNormal`,`mat3`));let c=t.vertex;i&&(c.include(Be),c.uniforms.add(new ie(`viewOriginHi`,t=>te(e(ct,t.camera.viewInverseTransposeMatrix[3],t.camera.viewInverseTransposeMatrix[7],t.camera.viewInverseTransposeMatrix[11]),ct)),new ie(`viewOriginLo`,t=>ae(e(ct,t.camera.viewInverseTransposeMatrix[3],t.camera.viewInverseTransposeMatrix[7],t.camera.viewInverseTransposeMatrix[11]),ct)))),c.code.add(U`
    ...
    }`)}var ct=d();function lt(e,t){e.varyings.add(`colorMixMode`,`int`),e.varyings.add(`opacityMixMode`,`int`),e.vertex.uniforms.add(new ye(`symbolColorMixMode`,e=>P[e.colorMixMode])),t.hasSymbolColors?(e.vertex.include(j),e.vertex.include(me),e.vertex.include(oe),e.attributes.add(`symbolColor`,`vec4`),e.vertex.code.add(U`
...
forwardTextureCoordinates();`),r.include(M,t),e.include($,t),e.include(fe,t),r.main.add(U`
        ...
        ${H(s,U`vec4 texColor = texture(tex, ${u?`colorUV`:`vuv0`});
                discardOrAdjustAlpha(texColor);`)}
        calculateOcclusionAndOutputHighlight();`)}}function pt(e,t){return mt(e,t)}function mt(e,t){let n=e.fragment,{hasVertexTangents:r,doubleSidedMode:a,hasNormalTexture:o,textureCoordinateType:s,bindType:c,hasNormalTextureTransform:u}=t;r?(e.attributes.add(`tangent`,`vec4`),e.varyings.add(`vTangent`,`vec4`),a===2?n.code.add(U`mat3 computeTangentSpace(vec3 normal) {
...
}`),o&&s!==0&&(e.include(Me,t),n.uniforms.add(c===1?new V(`normalTexture`,e=>e.textureNormal):new q(`normalTexture`,e=>e.textureNormal)),u&&(n.uniforms.add(c===1?new be(`scale`,e=>e.scale??l):new xe(`scale`,e=>e.scale??l)),n.uniforms.add(new k(`normalTextureTransformMatrix`,e=>e.normalTextureTransformMatrix??i))),n.code.add(U`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
vec3 rawNormal = textureLookup(normalTexture, uv).rgb * 2.0 - 1.0;`),u&&n.code.add(U`mat3 normalRotation = mat3(normalTextureTransformMatrix[0][0]/scale[0], normalTextureTransformMatrix[0][1]/scale[1], 0.0,
...
}`))}var ht=3e5,gt=5e5,_t=16;function vt(){let e=new Y,n=e.fragment;return e.include(I),e.include(Ne),n.include(Z),n.include(K),n.uniforms.add(new N(`radius`,e=>yt(e.camera))).code.add(U`vec3 sphere[16] = vec3[16](
...
}`),n.code.add(U`float aoValueFromPositionsAndNormal(vec3 C, vec3 n_C, vec3 Q) {
vec3 v = Q - C;
float vv = dot(v, v);
float vn = dot(normalize(v), n_C);
return fallOffFunction(vv, vn, 0.1);
}`),e.outputs.add(`fragOcclusion`,`float`),n.uniforms.add(new V(`normalMap`,e=>e.normalTexture),new V(`depthMap`,e=>e.depthTexture),new G(`projScale`,e=>e.projScale),new V(`rnm`,e=>e.noiseTexture),new be(`rnmScale`,(e,n)=>t(bt,n.camera.fullWidth/e.noiseTexture.descriptor.width,n.camera.fullHeight/e.noiseTexture.descriptor.height)),new G(`intensity`,e=>e.intensity),new T(`screenSize`,e=>t(bt,e.camera.fullWidth,e.camera.fullHeight))).main.add(U`
...
return readShadowMaps(uvzShadow);
  ...
  `)}function Qn(){return new Gn(`shadowMap`,({shadowMap:e})=>e.getOutput(5)??e.getOutput(7))}function $n(e,t){t.hasColorTextureTransform?(e.varyings.add(`colorUV`,`vec2`),e.vertex.uniforms.add(new k(`colorTextureTransformMatrix`,e=>e.colorTextureTransformMatrix??i)).code.add(U`void forwardColorUV(){
colorUV = (colorTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(U`void forwardColorUV(){}`)}function er(e,t){t.hasNormalTextureTransform&&t.textureCoordinateType!==0?(e.varyings.add(`normalUV`,`vec2`),e.vertex.uniforms.add(new k(`normalTextureTransformMatrix`,e=>e.normalTextureTransformMatrix??i)).code.add(U`void forwardNormalUV(){
normalUV = (normalTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(U`void forwardNormalUV(){}`)}function tr(e,t){t.hasEmissionTextureTransform&&t.textureCoordinateType!==0?(e.varyings.add(`emissiveUV`,`vec2`),e.vertex.uniforms.add(new k(`emissiveTextureTransformMatrix`,e=>e.emissiveTextureTransformMatrix??i)).code.add(U`void forwardEmissiveUV(){
emissiveUV = (emissiveTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(U`void forwardEmissiveUV(){}`)}function nr(e,t){t.hasOcclusionTextureTransform&&t.textureCoordinateType!==0?(e.varyings.add(`occlusionUV`,`vec2`),e.vertex.uniforms.add(new k(`occlusionTextureTransformMatrix`,e=>e.occlusionTextureTransformMatrix??i)).code.add(U`void forwardOcclusionUV(){
occlusionUV = (occlusionTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(U`void forwardOcclusionUV(){}`)}function rr(e,t){t.hasMetallicRoughnessTextureTransform&&t.textureCoordinateType!==0?(e.varyings.add(`metallicRoughnessUV`,`vec2`),e.vertex.uniforms.add(new k(`metallicRoughnessTextureTransformMatrix`,e=>e.metallicRoughnessTextureTransformMatrix??i)).code.add(U`void forwardMetallicRoughnessUV(){
