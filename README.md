...
There is **full support** for modern versions of Chromium-based browsers (Google Chrome, Edge, etc.) and Firefox. We suggest keeping your browser up-to-date to ensure full functionality.
