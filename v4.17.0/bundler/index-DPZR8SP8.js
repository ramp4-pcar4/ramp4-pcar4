...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-2rKSs2tc.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-Fs9UEdc-.js"), "./icons/edit-icon.vue": () => import("./edit-icon-a61EnKB8.js"), "./icons/point-icon.vue": () => import("./point-icon-CnhGOPcI.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-DY9Lv71C.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-j9e0CBrm.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-Cph32xrU.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
