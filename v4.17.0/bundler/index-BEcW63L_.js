...
import { _ as H, d as L, F as X, G as ee } from "./main-2rKSs2tc.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CnhGOPcI.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-j9e0CBrm.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DY9Lv71C.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-Fs9UEdc-.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-Cph32xrU.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-a61EnKB8.js")))
      }), s;
    }), n = (s) => {
