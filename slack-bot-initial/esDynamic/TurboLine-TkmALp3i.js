import { af as le, hX as ue } from "./main-3gzXighg.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-B7cxkWnH.js").then((i) => i.l) : await import("./libtess-Dz4CG3-3.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-TkmALp3i.js.map
