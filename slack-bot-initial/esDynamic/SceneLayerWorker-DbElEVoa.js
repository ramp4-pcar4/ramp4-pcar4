import { hX as K, bh as D } from "./main-3gzXighg.js";
import { y as X } from "./DoubleArray-D_NE8TpV.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CAjN5lKk.js";
import { n as Z, s as ee } from "./vec3-BSHwSkSj.js";
import "./sphere-DeLIo8OS.js";
import "./I3SUtil-CVNFaKEa.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-BkFkshw0.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-3gzXighg.js").then((d) => d.qK), import("./main-3gzXighg.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-DzyzN0dK.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-DbElEVoa.js.map
