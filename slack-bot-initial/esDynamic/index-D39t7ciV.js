import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-3gzXighg.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-CBSU5HIt.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-BQEeYaXj.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-DaN54Ktc.js")).default, n = (await import("./index-DdXlA5Qx.js")).default, a = (await import("./index-w3cLlI5u.js")).default, w = (await import("./index-vC8O833F.js")).default, p = (await import("./index-XRQ5u3ra.js")).default, r = (await import("./index-CqMjhaqQ.js")).default, b = (await import("./index-BmwZbGRN.js")).default;
...
//# sourceMappingURL=index-D39t7ciV.js.map
