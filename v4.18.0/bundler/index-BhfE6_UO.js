...
import { _ as H, d as L, F as X, G as ee } from "./main-DEZKkTlX.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), re = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-MsSbKDAo.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Ii-ZaOTW.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-C_Ky_yCD.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DkHSjf8A.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-Bz450hZF.js")))
      }
    ], a = A(() => {
      const r = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return r.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-jvioZPRS.js")))
      }), r;
    }), n = (r) => {
