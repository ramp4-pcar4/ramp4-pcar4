...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-DEZKkTlX.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-DkHSjf8A.js"), "./icons/edit-icon.vue": () => import("./edit-icon-jvioZPRS.js"), "./icons/point-icon.vue": () => import("./point-icon-MsSbKDAo.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-C_Ky_yCD.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-Ii-ZaOTW.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-Bz450hZF.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
