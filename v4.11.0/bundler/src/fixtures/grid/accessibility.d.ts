 ...
 */
export declare function tabToNextHeaderHandler(params: TabToNextHeaderParams): HeaderPosition | null;
 ...
 */
export declare function tabToNextCellHandler(params: TabToNextCellParams): CellPosition | null;
export {};
