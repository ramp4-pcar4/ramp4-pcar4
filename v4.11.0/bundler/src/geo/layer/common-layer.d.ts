...
import { DefPromise, DrawState, Extent, Graphic, InitiationState, LayerState, TreeNode, AttributeSet, GetGraphicParams, RampLayerConfig, TabularAttributeSet } from '../api';
