import { hX as K, bh as D } from "./main-BEi6lHs4.js";
import { y as X } from "./DoubleArray-c_DBvqhO.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-3FunpxNt.js";
import { n as Z, s as ee } from "./vec3-X3QUgxJw.js";
import "./sphere-B68TK5m3.js";
import "./I3SUtil-D1BOIA8b.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-BqSWM9By.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-BEi6lHs4.js").then((d) => d.qK), import("./main-BEi6lHs4.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-mUxkUI5i.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-B4PjfMSk.js.map
