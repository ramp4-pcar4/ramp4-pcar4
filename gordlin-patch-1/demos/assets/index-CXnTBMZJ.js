const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-bf_7xNiJ.js","./main-BpBTVFw9.js","./preload-helper-dJJaZANz.js","./main-BjH693uE.css","./table-state-manager-BxhJ2X4c.js","./screen-BHmI98jY.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bA as FixtureInstance, hh as useGridStore, he as markRaw, hf as useAppbarStore } from './main-BpBTVFw9.js';
    ...
    this.$iApi.panel.register(
      {
        grid: {
          screens: {
            "grid-screen": () => markRaw(__vitePreload(() => import('./screen-bf_7xNiJ.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0,import.meta.url))
          },
          style: {
            width: "450px"
          },
