...
Like other fixtures, the datatable has multiple options that can be configured directly through the main configuration file. The current configuration options include
