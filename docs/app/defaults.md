...
| LAYER_LOADSTATECHANGE<br>'layer/loadstatechange'   | _state_: new value, layer: LayerInstance object                | The layer load state changed |
| LAYER_LAYERSTATECHANGE<br>'layer/layerstatechange' | _state_: new value, layer: LayerInstance object                | The layer layer state changed                 |
