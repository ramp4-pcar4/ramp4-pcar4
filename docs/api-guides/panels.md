...
* `isRegistered(panelId: string | string[]): Promise<PanelInstance[]>` - provides a promise that resolves to the array of `PanelInstance` objects when panels with the specified panel ID(s) have completed registration.
