...
* `registerHTML(html: string | HTMLElement, id: string, style?: PanelConfigStyle, alertName?: string, options?: PanelRegistrationOptions)` - Registers a new panel containing a screen of HTML content and returns the PanelInstance.
