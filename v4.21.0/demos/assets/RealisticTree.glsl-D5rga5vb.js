import{c as e,r as t}from"./Emissions.glsl-CYr6jxOz.js";import{n,t as r}from"./glsl-D86mb9IV.js";import{t as i}from"./Float3PassUniform-DRIztCoa.js";import{t as a}from"./FloatPassUniform-C6m-xC7A.js";import{t as o}from"./Texture2DPassUniform-oRvBo8gb.js";import{t as s}from"./ShaderBuilder-YAIKAIG9.js";import{n as c}from"./MaterialUtil-Dm_4iJZS.js";import{t as l}from"./Float4PassUniform-D8WiTMD5.js";import{a as u,t as d}from"./AlphaCutoff-BNpSqC1y.js";import{a as f,i as p,t as m}from"./VisualVariables.glsl-B_6jUlIw.js";import{n as h,t as g}from"./View.glsl-DWX0DbcR.js";import{t as _}from"./MixExternalColor.glsl-Dztei9Gr.js";import{t as v}from"./TerrainDepthTest.glsl-CSomnash.js";import{t as y}from"./OutputColorHighlightOLID.glsl-CVrZ7Q_7.js";import{r as b}from"./VerticalOffset.glsl-B1xUKIAT.js";import{t as x}from"./Transform.glsl-DGF0YYNI.js";import{t as S}from"./VertexColor.glsl-Cdi6ziPx.js";import{a as C,i as w,n as T,o as E,r as D,t as O,u as k}from"./DefaultMaterialAuxiliaryPasses.glsl-hJPuC5nw.js";import{a as A,i as j,n as ee,o as M,r as N,t as P}from"./SnowCover.glsl-DVPwO9KI.js";import{a as F,c as I,n as L,s as R,t as z}from"./ReadShadowMap.glsl-BOOiD1JQ.js";function B(B){let V=new s,{attributes:H,vertex:U,fragment:W,varyings:G}=V,{output:K,offsetBackfaces:q,pbrMode:J,snowCover:Y,spherical:X}=B,Z=J===1||J===2;if(h(U,B),H.add(`position`,`vec3`),G.add(`vpos`,`vec3`,{invariant:!0}),V.include(m,B),V.include(w,B),V.include(b,B),V.include(v,B),!e(K))return V.include(O,B),V;g(V.vertex,B),V.include(k,B),V.include(x),q&&V.include(E),G.add(`vNormalWorld`,`vec3`),G.add(`localvpos`,`vec3`,{invariant:!0}),V.include(t,B),V.include(D,B),V.include(C,B),V.include(S,B),U.include(f),U.include(p),U.uniforms.add(new l(`externalColor`,e=>e.externalColor,{supportsNaN:!0})),G.add(`vcolorExt`,`vec4`),V.include(B.instancedDoublePrecision?L:z,B),U.main.add(n`
    forwardVertexColor();
