import{n as e,t}from"./glsl-D86mb9IV.js";import{t as n}from"./Texture2DPassUniform-oRvBo8gb.js";import{t as r}from"./ShaderBuilder-YAIKAIG9.js";import{t as i}from"./Float2BindUniform-CwNQquqs.js";import{t as a}from"./Float4BindUniform-edhjzkvR.js";import{t as o}from"./Float4PassUniform-D8WiTMD5.js";import{t as s}from"./FloatBindUniform-BSRjXuYs.js";import{a as c,i as l,n as u}from"./AlphaCutoff-BNpSqC1y.js";import{t as d}from"./Matrix4BindUniform-smGDQR0U.js";import{i as f,n as p,r as m}from"./View.glsl-DWX0DbcR.js";import{c as h,l as g,s as _,t as v}from"./MarkerSizing.glsl-CiIXH7yb.js";import{t as y}from"./PositionOutsideClipSpace-BrIG2r2p.js";import{t as b}from"./TerrainDepthTest.glsl-CSomnash.js";import{t as x}from"./OutputColorHighlightOLID.glsl-CVrZ7Q_7.js";function S(S){let C=new r,{space:w,anchor:T,hasTip:E,hasScreenSizePerspective:D}=S,O=w===2,k=w===1;C.include(g,S),C.include(v,S),C.include(b,S);let{vertex:A,fragment:j,varyings:M}=C;p(A,S),C.attributes.add(`position`,`vec3`),C.attributes.add(`previousDelta`,`vec4`),C.attributes.add(`uv0`,`vec2`),M.add(`vColor`,`vec4`),M.add(`vpos`,`vec3`,{invariant:!0}),M.add(`vUV`,`vec2`),M.add(`vSize`,`float`),E&&M.add(`vLineWidth`,`float`),A.uniforms.add(new i(`nearFar`,({camera:e})=>e.nearFar),new a(`viewport`,({camera:e})=>e.fullViewport)).code.add(e`vec4 projectAndScale(vec4 pos) {
