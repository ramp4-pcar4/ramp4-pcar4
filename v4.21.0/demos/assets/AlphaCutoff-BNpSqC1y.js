import{P as e}from"./typedArrayUtil-DxTGOhzQ.js";import{t}from"./Error-_QwNfXD7.js";import{r as n}from"./tslib.es6-CQRs8sXx.js";import{r,s as i}from"./vec3f64-AstwQ_2i.js";import{t as a}from"./mat4f64-CR6tgU3J.js";import{x as o}from"./mat4-CPohtlak.js";import{j as s,r as c,x as l,y as u}from"./vec3-PQmvgJ1Y.js";import{n as d}from"./glsl-D86mb9IV.js";import{t as f}from"./Uniform-BmjhDcXW.js";import{t as p}from"./Float3DrawUniform-sgeWoG_i.js";import{t as m}from"./Texture2DBindUniform-B5HV6_RW.js";import{t as h}from"./NoParameters-G0F6dSS2.js";import{t as g}from"./HighlightReadBitmap.glsl-BBDaZPRE.js";var _=class{constructor(e){this._bits=[...e]}equals(t){return e(this._bits,t.bits)}get code(){return this._code??=String.fromCharCode(...this._bits),this._code}get bits(){return this._bits}},v=class extends h{constructor(){super(),this._parameterBits=this._parameterBits?.map(()=>0)??[],this._parameterNames??=[]}get key(){return this._key??=new _(this._parameterBits),this._key}decode(e=this.key){let t=this._parameterBits;this._parameterBits=[...e.bits];let n=this._parameterNames.map(e=>`    ${e}: ${this[e]}`).join(`
