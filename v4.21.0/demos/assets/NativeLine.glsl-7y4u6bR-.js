import{n as e}from"./glsl-D86mb9IV.js";import{t}from"./ShaderBuilder-YAIKAIG9.js";import{t as n}from"./Float4PassUniform-D8WiTMD5.js";import{a as r}from"./AlphaCutoff-BNpSqC1y.js";import{n as i}from"./View.glsl-DWX0DbcR.js";import{t as a}from"./OutputColorHighlightOLID.glsl-CVrZ7Q_7.js";import{t as o}from"./Transform.glsl-DGF0YYNI.js";import{t as s}from"./VertexColor.glsl-Cdi6ziPx.js";function c(c){let l=new t,{vertex:u,fragment:d,varyings:f}=l;return l.fragment.include(r,c),l.include(o),l.include(s,c),l.include(a,c),i(u,c),l.attributes.add(`position`,`vec3`),f.add(`vpos`,`vec3`,{invariant:!0}),u.main.add(e`vpos = position;
forwardVertexColor();
