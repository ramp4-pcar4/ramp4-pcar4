import{n as e}from"./glsl-D86mb9IV.js";import{t}from"./FloatPassUniform-C6m-xC7A.js";import{t as n}from"./Texture2DPassUniform-oRvBo8gb.js";import{t as r}from"./ShaderBuilder-YAIKAIG9.js";import{t as i}from"./HighlightCellGridScreenSpacePass.glsl-4C0Du2Ys.js";import{t as a}from"./IntegerPassUniform-BeYMPpze.js";import{a as o,s}from"./HighlightDownsample.glsl-CtYarkji.js";import{t as c}from"./HighlightReadBitmap.glsl-BBDaZPRE.js";import{t as l}from"./Float2DrawUniform-HyCH2UR1.js";function u(){let u=new r;u.include(i);let{fragment:d}=u;return d.uniforms.add(new n(`blurInput`,e=>e.highlightBlurTexture),new l(`blurSize`,e=>e.blurSize),new s(`highlightTexture`,e=>e.highlightTexture),new n(`highlightOptionsTexture`,e=>e.highlightOptionsTexture),new a(`highlightLevel`,e=>e.highlightLevel),new t(`occludedIntensityFactor`,e=>e.occludedFactor)),d.constants.add(`inner`,`float`,1-(9-o)/9),u.include(c),d.main.add(e`vec2 highlightTextureSize = vec2(textureSize(highlightTexture,0));
vec2 uv = sUV;
