import{n as e}from"./glsl-D86mb9IV.js";import{t}from"./FloatPassUniform-C6m-xC7A.js";import{t as n}from"./Float4BindUniform-edhjzkvR.js";import{t as r}from"./Texture2DBindUniform-B5HV6_RW.js";import{t as i}from"./FloatBindUniform-BSRjXuYs.js";import{n as a,t as o}from"./ScreenSizePerspective.glsl-D6pyN86n.js";import{i as s,n as c,r as l,t as u}from"./View.glsl-DWX0DbcR.js";import{n as d}from"./VerticalOffset.glsl-B1xUKIAT.js";import{t as f}from"./BooleanBindUniform-CDcoqkX1.js";var p=.5;function m(r,f){r.include(a),r.attributes.add(`position`,`vec3`),r.attributes.add(`normal`,`vec3`),r.attributes.add(`centerOffsetAndDistance`,`vec4`);let p=r.vertex;c(p,f),u(p,f),p.uniforms.add(new n(`viewport`,e=>e.camera.fullViewport),new t(`polygonOffset`,e=>e.shaderPolygonOffset),new i(`aboveGround`,e=>e.camera.aboveGround?1:-1)),f.hasVerticalOffset&&d(p),p.code.add(e`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
