...
import { m as m$a, a as u$b, e as e$n, c as a$h } from './Texture-ykeXEf6b.js';
import { H as H$4 } from './InterleavedLayout-BYqYDwcV.js';
...
function t$i(){if(null==s$b){const t=t=>n$9(`esri/libs/basisu/${t}`);s$b=__vitePreload(() => import('./basis_transcoder-BSMLL46R.js'),true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url).then((e=>e.b)).then((({default:e})=>e({locateFile:t}).then((e=>(e.initializeBasis(),delete e.then,e)))));}return s$b}let s$b;
