import { hX as K, bh as D } from "./main-CmejC-so.js";
import { y as X } from "./DoubleArray-t2TjfJ77.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CvC0F2d3.js";
import { n as Z, s as ee } from "./vec3-_MrnRoFn.js";
import "./sphere-DrUmWFBl.js";
import "./I3SUtil-C85R9XTM.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-CCMJlN_o.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-CmejC-so.js").then((d) => d.qK), import("./main-CmejC-so.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-Ds2dnQo8.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-C6gqc572.js.map
