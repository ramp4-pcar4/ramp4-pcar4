import { af as le, hX as ue } from "./main-CmejC-so.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-C_SY9uFr.js").then((i) => i.l) : await import("./libtess-M4AjIMkO.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-DZ9BiFT0.js.map
