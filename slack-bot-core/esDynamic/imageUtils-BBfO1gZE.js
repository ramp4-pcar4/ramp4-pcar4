import { am as m, au as d, a2 as u, K as w, s as p } from "./main-CmejC-so.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-BZcxgqhH.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-CRqz8U0E.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-BBfO1gZE.js.map
