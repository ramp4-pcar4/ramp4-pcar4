...
import { co as defineComponent, cq as inject, cs as resolveComponent, cu as openBlock, cv as createBlock, cw as withCtx, fG as createBaseVNode, iN as normalizeStyle, cx as createTextVNode, cp as useI18n, cy as toDisplayString, cz as unref, cj as FixtureInstance, hv as markRaw } from './main-8822140d.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-b31aa144.js'),true?["./p2-screen-1-b31aa144.js","./main-8822140d.js","./preload-helper-a4975f27.js","./main-4fa92696.css"]:void 0,import.meta.url).then(
                    (data) => {
                      resolve(data);
                    }
                  ),
