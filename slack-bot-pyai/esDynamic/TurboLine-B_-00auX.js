import { af as le, hX as ue } from "./main-DhLeoxL5.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-DEZJqG_4.js").then((i) => i.l) : await import("./libtess-BsmCks80.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-B_-00auX.js.map
