import { am as m, au as d, a2 as u, K as w, s as p } from "./main-DhLeoxL5.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-BplKnkrF.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-DkMj2rHZ.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-BysCBpc6.js.map
