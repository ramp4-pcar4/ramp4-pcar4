...
import { _ as H, d as L, F as X, G as ee } from "./main-C0pPTYkB.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DCAdlksZ.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-qKiHvnqa.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-BtdLHJHX.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DrSayfR1.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-D_l_CL1h.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-D5wUe3FJ.js")))
      }), s;
    }), n = (s) => {
