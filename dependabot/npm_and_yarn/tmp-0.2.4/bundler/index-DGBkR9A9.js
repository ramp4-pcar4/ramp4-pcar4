...
import { _ as H, d as L, F as K, G as X } from "./main-Ctn9sJn-.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-FRNXdKzN.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-D_OFAyqC.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DqfqGuAX.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-B0CLzige.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BQZVI0b-.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BCy6Nuj9.js")))
      }), s;
    }), n = (s) => {
