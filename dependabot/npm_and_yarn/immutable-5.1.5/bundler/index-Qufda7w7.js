...
import { _ as H, d as L, F as X, G as ee } from "./main-Ch62iPPQ.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-B8ND3aZD.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BQmWBqIV.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-D6XVgmag.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-B_6a7g6Z.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-7gkH2ZO2.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-QqN_fC9s.js")))
      }), s;
    }), n = (s) => {
