import{E as e,H as t,L as n,W as r,g as i}from"./TriangleTechniqueConfiguration-AC7R9w2G.js";import{f as a}from"./oitResolution.glsl-CICnBLk1.js";import{t as o}from"./ShaderBuilder-M5PWHQdC.js";import{n as s,t as c}from"./VertexColor.glsl-BNpcXIEa.js";function l(l){let u=new o,{vertex:d,fragment:f,varyings:p}=u;return u.fragment.include(r,l),u.include(s),u.include(c,l),u.include(t,l),u.include(i,l),e(d,l),u.attributes.add(`position`,`vec3`),p.add(`vpos`,`vec3`,{invariant:!0}),d.main.add(a`vpos = position;
forwardVertexColor();
