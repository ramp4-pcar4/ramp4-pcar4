...
export declare const usePanelStore: import('pinia').StoreDefinition<"panel", Pick<PanelStore, "pinned" | "priority" | "stackWidth" | "remWidth" | "mobileView" | "reorderable" | "pinable" | "items" | "regPromises" | "orderedItems" | "teleported" | "visible" | "opacity">, Pick<PanelStore, "getRemainingWidth">, Pick<PanelStore, "open" | "close" | "move" | "remove" | "getVisible" | "getRegPromises" | "openPanel" | "closePanel" | "movePanel" | "removePanel" | "setOpacity" | "setStackWidth" | "setMobileView" | "updateVisible" | "registerPanel" | "addRegPromise">>;
