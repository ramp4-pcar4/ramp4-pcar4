...
export declare class PanelAPI extends APIScope {
    panelStore: import('pinia').Store<"panel", Pick<import('../stores/panel').PanelStore, "pinned" | "priority" | "stackWidth" | "remWidth" | "mobileView" | "reorderable" | "pinable" | "items" | "regPromises" | "orderedItems" | "teleported" | "visible" | "opacity">, Pick<import('../stores/panel').PanelStore, "getRemainingWidth">, Pick<import('../stores/panel').PanelStore, "open" | "close" | "move" | "remove" | "getVisible" | "getRegPromises" | "openPanel" | "closePanel" | "movePanel" | "removePanel" | "setOpacity" | "setStackWidth" | "setMobileView" | "updateVisible" | "registerPanel" | "addRegPromise">>;
