...
export declare const useDetailsStore: import('pinia').StoreDefinition<"details", Pick<{
    ...
    lastestDetailView: import('../../../../vue/dist/vue.esm-bundler.js').Ref<number, number>;
...
}, "payload" | "properties" | "defaultTemplates" | "currentFeatureId" | "activeGreedy" | "lastestDetailView" | "lastHilight" | "hilightToggle" | "origin">, Pick<{
    payload: import('../../../../vue/dist/vue.esm-bundler.js').Ref<{
        items: {
            data: any;
            format: import('../../../geo/api').IdentifyResultFormat;
