...
import { FieldType, LayerType, CsvOptions, GeoJsonField, GeoJsonOptions, RampLayerConfig } from '../../api';
export declare class FileUtils extends APIScope {
     ...
     */
    geoJsonToEsriJson(geoJson: any, options: GeoJsonOptions): Promise<EsriFeatureLayerProperties>;
