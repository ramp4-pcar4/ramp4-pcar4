...
var r = (e, t) => {
	...
	function d(t) {
		let n = e.value.filter((e) => e.id !== t.id || e.uid !== t.uid);
		if (e.value = n, t.mapLayer) {
			let e = i.value.filter((e) => e !== t.id);
			i.value = e;
		}
	}
	function f(e) {
		let t = n.value.filter((t) => t.id !== e);
		n.value = t;
	}
	return {
		layers: e,
	...
	function l(t) {
		...
		if (e.value = n, Array.isArray(e.value.layers)) {
			let t = i();
