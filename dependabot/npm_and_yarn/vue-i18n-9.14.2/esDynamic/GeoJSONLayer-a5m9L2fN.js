...
let i = class extends q(P(T(k(D(G(C(Q(Z(z(L(de))))))))))) {
  ...
  async applyEdits(e, t) {
    const { applyEdits: o } = await import("./editingSupport-BMh7p3mw.js");
    await this.load();
...
//# sourceMappingURL=GeoJSONLayer-a5m9L2fN.js.map
