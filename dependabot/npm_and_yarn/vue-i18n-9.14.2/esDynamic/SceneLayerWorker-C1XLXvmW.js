import { fq as q, bx as v, cy as K } from "./main-uCo5F72j.js";
import { y as Q } from "./DoubleArray-BVVPIBFK.js";
import { i as W, a as X } from "./MeshLocalVertexSpace-CI0yOdvD.js";
import { f as Z, l as ee } from "./vec3-BLlK2NIY.js";
import "./sphere-BNcnZdE3.js";
import "./I3SUtil-cz_q-URu.js";
var U, D;
(function(e) {
...
function te() {
  return _ || (_ = new Promise((e) => import("./i3s-BvuVxKXO.js").then((t) => t.i).then(({ default: t }) => {
...
async function pe(e) {
  ...
  let s;
  const [{ projectBuffer: I }, { initializeProjection: M }] = await Promise.all([import("./main-uCo5F72j.js").then((a) => a.r9), import("./main-uCo5F72j.js").then((a) => a.ra)]);
  await M(c, l);
  const g = [0, 0, 0];
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    ...
    const a = i.type === "georeferenced" ? W.fromJSON(i) : X.fromJSON(i), { project: m } = await import("./projection-CFWVRG3J.js"), d = m({ positions: f, transform: t ? { localMatrix: t } : void 0, vertexSpace: a, inSpatialReference: c, outSpatialReference: l, localMode: u });
...
//# sourceMappingURL=SceneLayerWorker-C1XLXvmW.js.map
