import { a9 as Et, fq as bt } from "./main-uCo5F72j.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-BL0Ked-g.js").then((i) => i.l) : await import("./libtess-DvAtqTgg.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-l6J9AAlz.js.map
