...
import "tiny-emitter";
import { G as re, L as ve, F as be } from "./main-Bd1iWz-H.js";
...
class ut extends xe {
  async init() {
    ...
    this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(r.childNodes[0]), Object.entries(Pe).forEach((t) => this.$iApi.$i18n.mergeLocaleMessage(...t)), this._parseConfig(this.config), Y(this.$vApp.$pinia).supportedTypes.forEach((t) => {
      const n = `${t.type}-icon`;
      this.$iApi.component(n, fe(Ae(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-BLASQ2t2.js"), "./icons/edit-icon.vue": () => import("./edit-icon-BL38Lyqu.js"), "./icons/point-icon.vue": () => import("./point-icon-V5jeAo4I.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-uX2f_7KV.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-DlbXztMu.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-Bn6iaRG0.js") }), `./icons/${t.type}-icon.vue`, 3)));
    });
  }
  async added() {
