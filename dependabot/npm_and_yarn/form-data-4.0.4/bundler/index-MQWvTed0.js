...
import { _ as H, d as L, F as K, G as X } from "./main-Bd1iWz-H.js";
...
const W = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ O({
  ...
  setup(b) {
    const i = S("iApi"), { t } = N(), o = ee(), p = [
      {
        type: "point",
        icon: f(g(() => import("./point-icon-V5jeAo4I.js")))
      },
      {
        type: "polyline",
        icon: f(g(() => import("./polyline-icon-DlbXztMu.js")))
      },
      {
        type: "polygon",
        icon: f(g(() => import("./polygon-icon-uX2f_7KV.js")))
      },
      {
        type: "circle",
        icon: f(g(() => import("./circle-icon-BLASQ2t2.js")))
      },
      {
        type: "rectangle",
        icon: f(g(() => import("./rectangle-icon-Bn6iaRG0.js")))
      }
    ], a = E(() => {
      const s = p.filter((v) => o.supportedTypes.some((x) => x.type === v.type));
      return s.push({
        type: "edit",
        icon: f(g(() => import("./edit-icon-BL38Lyqu.js")))
      }), s;
    }), n = (s) => {
