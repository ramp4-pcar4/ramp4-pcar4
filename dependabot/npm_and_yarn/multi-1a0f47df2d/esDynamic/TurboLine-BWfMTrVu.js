import { af as le, hX as ue } from "./main-Bajc7zzQ.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-D9KyVZRP.js").then((i) => i.l) : await import("./libtess-BgJkGJsk.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-BWfMTrVu.js.map
