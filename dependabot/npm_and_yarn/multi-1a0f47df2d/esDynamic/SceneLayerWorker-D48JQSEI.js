import { hX as K, bh as D } from "./main-Bajc7zzQ.js";
import { y as X } from "./DoubleArray-C3HfAbBK.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-BActsQfx.js";
import { n as Z, s as ee } from "./vec3-DGXI1T7c.js";
import "./sphere-CMFsE_Es.js";
import "./I3SUtil-D2vu91JN.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-CR72XTNf.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-Bajc7zzQ.js").then((d) => d.qK), import("./main-Bajc7zzQ.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-CoblMcxJ.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-D48JQSEI.js.map
