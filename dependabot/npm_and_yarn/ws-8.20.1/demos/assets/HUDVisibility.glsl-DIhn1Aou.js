import{n as e}from"./glsl-cCMnAovS.js";import{t}from"./FloatPassUniform-Br1Hnc1v.js";import{t as n}from"./Float4BindUniform-DRIvXGlb.js";import{t as r}from"./Texture2DBindUniform-DP7g1ua2.js";import{t as i}from"./FloatBindUniform-DXpZdha5.js";import{n as a,t as o}from"./ScreenSizePerspective.glsl-oNkF5d9c.js";import{i as s,n as c,r as l,t as u}from"./View.glsl-Qqa5BQUH.js";import{n as d}from"./VerticalOffset.glsl-BX98JPuv.js";import{t as f}from"./BooleanBindUniform-BGqkhRT_.js";var p=.5;function m(r,f){r.include(a),r.attributes.add(`position`,`vec3`),r.attributes.add(`normal`,`vec3`),r.attributes.add(`centerOffsetAndDistance`,`vec4`);let p=r.vertex;c(p,f),u(p,f),p.uniforms.add(new n(`viewport`,e=>e.camera.fullViewport),new t(`polygonOffset`,e=>e.shaderPolygonOffset),new i(`aboveGround`,e=>e.camera.aboveGround?1:-1)),f.hasVerticalOffset&&d(p),p.code.add(e`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
