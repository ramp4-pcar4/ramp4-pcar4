import { A as e, O as t, d as n, k as r, l as i, r as a, s as o, u as s, y as c } from "./esri-C6orwzKs.js";
...
var p = "draw-settings", m = "draw-shape-details", h = "draw-import", g = [{
	...
	let e = 0, t = f([]), n = f(!1), r = f(null), i = d([]), a = f(null), o = f(null), s = f(!1), c = f(null), l = f(null), p = f(null), m = f(null), h = f(!1), g = f(!1), _ = f(!1), v = f("details"), y = f(0), b = f(0), x = f(0), S = f(0), w = f(0), T = f(!0), A = f(0), P = f(!1), F = f(0), I = f(0), R = f(null), z = f(0), B = f(null), V = f(0), H = f([]), U = f(null), W = d(O()), G = d(k()), K = f("shape-buffer"), q = d({}), ee = u(() => c.value ?? l.value), te = u(() => p.value ?? m.value);
	function ne(e) {
	...
	function ae(e) {
		...
		t !== -1 && (i.splice(t, 1), delete q[e], a.value === e && (a.value = null), i.length === 0 && (h.value = !1, g.value = !1, _.value = !1, v.value = "details"), Q());
	}
	function J(e) {
		a.value !== e && Q(), a.value = e;
	}
	function oe() {
		a.value = null, Q();
	}
	...
	function Ce(e) {
		let t = Number(e);
		X({ opacity: Number.isFinite(t) ? Math.min(100, Math.max(0, Math.round(t))) : 0 });
	}
	function Z(e) {
		Y((t) => {
	...
	function we(e) {
		let t = Number(e);
		Z({ distance: Number.isFinite(t) ? Math.max(0, t) : 0 });
	}
	function Te(e) {
		Z({ unit: e });
	}
	...
	return {
		...
		setSupportedTypes: ne,
		setActiveTool: re,
		addGraphic: ie,
		removeGraphic: ae,
		selectGraphic: J,
		clearSelection: oe,
		requestDeleteSelectedGraphic: se,
		requestEditSelectedGraphic: ce,
		requestIdentifySelectedGraphic: le,
		requestStopEditMode: ue,
		requestCancelEditMode: de,
		requestRefreshSelectedGraphicFeatureCounts: fe,
		requestShapePanelFocus: pe,
		requestImportShapes: me,
		clearImportShapes: he,
		getSelectedGraphic: ge,
		updateGraphicGeometry: _e,
		updateGraphic: ve,
		setGraphicMapLabelSettings: ye,
		setSelectedGraphicStyleSettings: X,
		setSelectedGraphicFillColor: be,
		setSelectedGraphicBorderColor: xe,
		setSelectedGraphicBufferColor: Se,
		setSelectedGraphicOpacity: Ce,
		setSelectedGraphicBufferSettings: Z,
		setSelectedGraphicBufferDistance: we,
		setSelectedGraphicBufferUnit: Te,
		setSelectedGraphicIdentifyBufferMode: Ee,
		setMeasurementsEnabled: De,
		toggleMeasurements: Oe,
		setHoveredSegmentKey: ke,
		setSelectedSegmentKey: Ae,
		setHoveredVertexKey: je,
		setSelectedVertexKey: Me,
		clearMeasurementInteraction: Q,
		setShapeDetailsPickEnabled: Ne,
		setShapeDetailsLabelsVisible: Pe,
...
//#endregion
export { R as _, m as a, j as c, U as d, B as f, F as g, C as h, p as i, G as l, L as m, g as n, M as o, H as p, h as r, N as s, q as t, K as u, I as v, P as y };
