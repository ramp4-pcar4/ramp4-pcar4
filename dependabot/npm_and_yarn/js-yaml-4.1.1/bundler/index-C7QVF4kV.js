...
import { _ as H, d as L, F as X, G as ee } from "./main-D_jTOJ0v.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DbjjPmiY.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CSfh73Tb.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CI3_HH-a.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-C4OdAlL5.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-UuyO0-6n.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-GmgnjHtR.js")))
      }), s;
    }), n = (s) => {
