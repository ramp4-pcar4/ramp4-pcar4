...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-C_bHinLl.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-B3_yrBCe.js"), "./icons/edit-icon.vue": () => import("./edit-icon-BsIy5OiN.js"), "./icons/point-icon.vue": () => import("./point-icon-Blg4OwGm.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-Breu1r2x.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-p2KQ4GXS.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-DzQMxHOh.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
