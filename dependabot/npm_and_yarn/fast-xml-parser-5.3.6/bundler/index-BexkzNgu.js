...
import { _ as H, d as L, F as X, G as ee } from "./main-C_bHinLl.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Blg4OwGm.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-p2KQ4GXS.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-Breu1r2x.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-B3_yrBCe.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DzQMxHOh.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BsIy5OiN.js")))
      }), s;
    }), n = (s) => {
