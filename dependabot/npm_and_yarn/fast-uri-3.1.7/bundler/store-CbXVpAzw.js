...
var p = "draw-settings", m = "draw-shape-details", h = "draw-import", g = [{
	...
	function ne() {
		h.value = !1, g.value = !1, _.value = !1, v.value = "details";
	}
	function re(e) {
		let t = i.findIndex((t) => t.id === e);
		t !== -1 && (i.splice(t, 1), delete q[e], a.value === e && (a.value = null), i.length === 0 && ne(), $());
	}
	function ie() {
		for (; i.length;) {
			let e = i.at(-1).id;
			B.value = e, z.value++, delete q[e], i.pop();
		}
		ne(), oe();
	}
	function ae(e) {
	...
	function we(e) {
		let t = Number(e);
		be({ opacity: Number.isFinite(t) ? Math.min(100, Math.max(0, Math.round(t))) : 0 });
	}
	function Q(e) {
		Z((t) => {
	...
	return {
		...
		setBorderColor: Be,
		setBufferColor: Ve,
		setBufferDistance: We,
		setBufferSettings: Ke,
		setBufferUnit: Ge,
		setFillColor: ze,
		setGraphicMapLabelSettings: ye,
		setHoveredSegmentKey: Ae,
		setHoveredVertexKey: Me,
		setIdentifyBufferMode: qe,
		setIdentifyGeometryGraphicId: Je,
		setMeasurementsEnabled: Oe,
		setOpacity: He,
		setSelectedGraphicBorderColor: Se,
		setSelectedGraphicBufferColor: Ce,
		setSelectedGraphicBufferDistance: Te,
		setSelectedGraphicBufferSettings: Q,
		setSelectedGraphicBufferUnit: Ee,
		setSelectedGraphicFillColor: xe,
		setSelectedGraphicIdentifyBufferMode: De,
		setSelectedGraphicOpacity: we,
		setSelectedGraphicStyleSettings: be,
		setSelectedSegmentKey: je,
		setSelectedVertexKey: Ne,
		setShapeDetailsActiveTab: Le,
		setShapeDetailsLabelsUseSettings: Ie,
		setShapeDetailsLabelsVisible: Fe,
		setShapeDetailsPickEnabled: Pe,
		setShapeFeatureCounts: Ye,
		setShapeFeatureCountsLoading: Xe,
		setStyleSettings: Ue,
		setSupportedTypes: X,
		toggleMeasurements: ke,
		toggleShapeDetailsPickEnabled: Re,
		updateGraphic: ve,
		updateGraphicGeometry: _e
	};
});
//#endregion
export { P as S, L as _, h as a, R as b, M as c, A as d, G as f, H as g, B as h, g as i, N as l, U as m, Y as n, p as o, K as p, J as r, m as s, X as t, j as u, C as v, I as x, F as y };
