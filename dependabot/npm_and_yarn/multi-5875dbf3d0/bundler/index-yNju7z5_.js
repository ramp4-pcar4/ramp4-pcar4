...
import { _ as H, d as L, F as X, G as ee } from "./main-C2zdjohd.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), re = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DXLmKTBl.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DH27utL4.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CELVxegb.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-Cqf0DF9s.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-D0VlgKGc.js")))
      }
    ], a = A(() => {
      const r = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return r.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CHAGu1rh.js")))
      }), r;
    }), n = (r) => {
