...
import { _ as H, d as L, F as X, G as ee } from "./main-BcsjjIWs.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-B5Xx8Lg0.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BVLLCBKI.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-D-3h1ABH.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BdliSm38.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DOJjyMo4.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DJyP-wuR.js")))
      }), s;
    }), n = (s) => {
