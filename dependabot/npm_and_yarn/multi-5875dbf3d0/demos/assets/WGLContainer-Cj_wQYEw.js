import{h$ as Ne,hZ as le,ia as at,ib as rt,ic as st,hS as lt,lq as ct,am as H,a$ as ge,mP as ft,a9 as oe,kv as Fe,i as ve,eE as ut,i1 as ye,s as Be,hX as dt,aw as _t}from"./main-BpgZ6rSj.js";import{$ as vt,d as xe,f as ht,g as Ue,s as z,t as mt,n as q,e as X,h as Ye}from"./Utils-jveQUSlZ.js";import{e as pt,a as ee}from"./ProgramTemplate-CghzqSzm.js";import{_ as A,R as M}from"./enums-DQOO6RKE.js";import{h as $}from"./VertexArrayObject-DZJIVbLC.js";import{n as gt}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as te}from"./VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./VertexBuffer-D7-L9gxu.js";import{n as ce}from"./mat2df32-Dpt2CT5P.js";import{e as k,l as yt,o as xt}from"./MapView-C4HYyEY5.js";import{r as St,e as Tt}from"./mat2d-Dht2CGe3.js";import{o as It,N as bt}from"./vec32-C65GOtSA.js";import{n as Et}from"./vec3f32-WCVSSNPR.js";import{o as ne,f as Ot,g as At,h as Pt,i as Mt,Y as N,$ as Ge,Z as Se}from"./definitions-Bxxl7NsE.js";import{e as He,n as Ct}from"./Container-Cyczj5dv.js";import{e as Lt}from"./TileKey-Bz8KZlmf.js";import{n as zt}from"./memoryEstimations-CG3Ti56z.js";import{o as fe}from"./BufferObject-D1km3fn0.js";import{h as Dt,A as Rt}from"./Texture-B8JFKZKs.js";import{n as Vt,r as wt}from"./vec2f32-CaVKkSa6.js";import{e as Te}from"./config-BOD8--da.js";import{e as Nt}from"./earcut-D9gy186-.js";import{n as Ie}from"./vec2f64-Cgb6qxNH.js";import{t as Ft,X as Bt}from"./featureConversionUtils-U1gVvzyE.js";import{e as be}from"./OptimizedGeometry-DGI7mFr1.js";function ke(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return ke()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function Xe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),Ht=Ze(),kt=je(),$t=Ke(),Wt=Xe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:Ht,UNIT_Y:kt,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:ke,fromValues:B,ones:We,unitW:Xe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
