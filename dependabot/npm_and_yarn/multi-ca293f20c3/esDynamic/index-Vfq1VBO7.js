import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-kHuLBII5.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-DHPPoKne.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-CCE08MUv.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-C_qGmpqf.js")).default, n = (await import("./index-DXfg_m4Z.js")).default, a = (await import("./index-rZ_nu_63.js")).default, w = (await import("./index-BWrSET7U.js")).default, p = (await import("./index-HK-UMUsj.js")).default, r = (await import("./index-DZrThY0u.js")).default, b = (await import("./index-e0HlPjVz.js")).default;
...
//# sourceMappingURL=index-Vfq1VBO7.js.map
