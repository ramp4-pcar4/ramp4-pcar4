import { af as le, hX as ue } from "./main-kHuLBII5.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-Blo_EiSA.js").then((i) => i.l) : await import("./libtess-oagJ5ZXi.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-CuppCHO1.js.map
