import { hX as K, bh as D } from "./main-kHuLBII5.js";
import { y as X } from "./DoubleArray-V0utnW-7.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-OrePyvzS.js";
import { n as Z, s as ee } from "./vec3-CNGAl9ZL.js";
import "./sphere-BZ2Tcn3A.js";
import "./I3SUtil-CIUtkIHK.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-BNWvqGuM.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-kHuLBII5.js").then((d) => d.qK), import("./main-kHuLBII5.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-Bmlgp91z.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-BgcfR_M4.js.map
