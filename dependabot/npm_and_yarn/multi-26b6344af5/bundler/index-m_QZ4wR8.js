import { defineComponent as l, inject as a, resolveComponent as h, createBlock as m, openBlock as c, unref as u, withCtx as v, createElementVNode as i, markRaw as d } from "vue";
import "tiny-emitter";
import { F as f, j as r, G as g, d as x } from "./main-BAAB394T.js";
    ...
    this.$iApi.component("help-nav-button", _), this.$iApi.panel.register(
      {
        help: {
          screens: {
            "help-screen": () => d(import("./screen-B4s9jUk3.js"))
          },
          style: {
            "flex-grow": "1",
            "max-width": "750px"
