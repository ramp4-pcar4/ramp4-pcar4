import { defineComponent as A, inject as H, ref as O, computed as T, reactive as C, onMounted as j, watch as R, onBeforeUnmount as X, resolveComponent as V, createBlock as F, openBlock as s, withCtx as k, createElementBlock as i, createElementVNode as g, toDisplayString as c, unref as h, createTextVNode as B } from "vue";
import { r as D, G as q } from "./main-BAAB394T.js";
import "pinia";
  ...
  setup(r) {
    ...
    return (t, e) => {
      ...
      return s(), F(n, {
        ...
        header: k(() => [
          B(c(h(l)("metadata.title")) + ": " + c(r.payload.layerName), 1)
        ]),
        content: k(() => [
          b.value ? (s(), i("div", J, [
            g("div", K, [
              f.value == "loading" ? (s(), i("div", Q, c(h(l)("metadata.loading")), 1)) : r.payload.type === "xml" && f.value == "success" ? (s(), i("div", {
                key: 1,
                innerHTML: v.value,
                ...
                e[0] || (e[0] = g("img", { src: "https://i.imgur.com/fA5EqV6.png" }, null, -1)),
                g("span", et, c(h(l)("metadata.error")), 1)
              ]))
            ])
          ])) : (s(), i("div", nt, [
            g("span", null, c(h(l)("metadata.label.no.layer")), 1)
          ]))
        ]),
        _: 1
      }, 8, ["panel"]);
