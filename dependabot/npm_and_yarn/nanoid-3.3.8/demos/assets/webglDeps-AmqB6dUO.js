import{E as _}from"./BufferObject-pvZKZVCf.js";import{r as c}from"./Program-CH16LeUV.js";import{x as y,s as j}from"./Program-CH16LeUV.js";import{cA as v}from"./main-TimRU6cf.js";import{t as p}from"./NestedMap-CImDozOA.js";import{e as O,a as P}from"./ProgramTemplate-C1y8BVKt.js";import{o as C}from"./VertexArrayObject-CPJuQqeP.js";import"./preload-helper-ExcqyqRp.js";class ${constructor(e){this._rctx=e,this._store=new p}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function l(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function d(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
