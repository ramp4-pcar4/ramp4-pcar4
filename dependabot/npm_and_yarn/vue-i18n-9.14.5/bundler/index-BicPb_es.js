...
import { _ as H, d as L, F as K, G as X } from "./main-BO6_iskk.js";
...
const W = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ O({
  ...
  setup(b) {
    const i = S("iApi"), { t } = N(), o = ee(), p = [
      {
        type: "point",
        icon: f(g(() => import("./point-icon-BJ3L9g1G.js")))
      },
      {
        type: "polyline",
        icon: f(g(() => import("./polyline-icon-AoIQpvS9.js")))
      },
      {
        type: "polygon",
        icon: f(g(() => import("./polygon-icon-DiendJoA.js")))
      },
      {
        type: "circle",
        icon: f(g(() => import("./circle-icon-Bh2CeMsU.js")))
      },
      {
        type: "rectangle",
        icon: f(g(() => import("./rectangle-icon-DiXm_xXv.js")))
      }
    ], a = E(() => {
      const s = p.filter((v) => o.supportedTypes.some((x) => x.type === v.type));
      return s.push({
        type: "edit",
        icon: f(g(() => import("./edit-icon-Cl9ds2CS.js")))
      }), s;
    }), n = (s) => {
