...
import { EsriCollection, EsriGraphic } from '../esri';
export interface AttributeLoaderDetails {
    supportsLimit?: boolean;
    attribs?: string;
    serviceUrl?: string;
    sourceGraphics?: EsriCollection<EsriGraphic>;
 ...
 * @internal
 */
declare class AsynchAttribController {
    loadedCount: number;
 ...
 * @internal
 */
declare class AttributeLoaderBase extends APIScope {
...
export declare class QuickCache {
     ...
     */
    getGeom(key: number, scale?: number | undefined): BaseGeometry | undefined;
    /**
