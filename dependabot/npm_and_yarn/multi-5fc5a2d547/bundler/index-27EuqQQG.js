...
import { _ as H, d as L, F as K, G as X } from "./main-ET6vaqQa.js";
...
const W = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ O({
  ...
  setup(b) {
    const i = S("iApi"), { t } = N(), o = ee(), p = [
      {
        type: "point",
        icon: f(g(() => import("./point-icon-BRu9Xfmm.js")))
      },
      {
        type: "polyline",
        icon: f(g(() => import("./polyline-icon-CITqYZA6.js")))
      },
      {
        type: "polygon",
        icon: f(g(() => import("./polygon-icon-BMkTQ__3.js")))
      },
      {
        type: "circle",
        icon: f(g(() => import("./circle-icon-Dup5TGqC.js")))
      },
      {
        type: "rectangle",
        icon: f(g(() => import("./rectangle-icon-Cbc4WOrT.js")))
      }
    ], a = E(() => {
      const s = p.filter((v) => o.supportedTypes.some((x) => x.type === v.type));
      return s.push({
        type: "edit",
        icon: f(g(() => import("./edit-icon-B0VL8tUO.js")))
      }), s;
    }), n = (s) => {
