...
import { _ as H, d as L, F as K, G as X } from "./main-DPbqnb2x.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-BXLULJLC.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-D-TZcMSl.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-BChzJIoG.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BbuBKnyM.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DooS3d8D.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-C4_jVQZM.js")))
      }), s;
    }), n = (s) => {
