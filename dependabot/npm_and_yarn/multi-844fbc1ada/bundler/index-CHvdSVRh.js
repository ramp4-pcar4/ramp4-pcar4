...
import { _ as H, d as L, F as K, G as X } from "./main-CTTAD7Pl.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-D1km150o.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CBjCsxf2.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CrR1FoNm.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-D_kYZrZq.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CvjZgPRO.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-omPH__d9.js")))
      }), s;
    }), n = (s) => {
