import { O as u, P as f, gt as _t, eH as Dt, e9 as Pt, Q as z, bX as ve, ev as _e, cp as Ae, bW as Et, aM as Ke, cs as De, D as le, aa as be, s as oe, gh as Ut, jc as F, bq as Wt, le as zt, fL as he, nK as ce, nL as Ht, bB as Vt, nM as kt, b8 as Qe, a4 as Bt, dG as Gt, dJ as Yt, aG as S, aH as Se, hi as et, dK as we, a3 as O, R as Xt, nN as qt, mJ as Zt, jT as Jt, ma as Kt, jx as Qt, V as er, bi as tr, cA as Re, aF as rr, nO as tt, m6 as nr, cC as $e, cD as rt, nP as nt, g7 as ot, nQ as st, nR as it, cz as or, jb as sr, en as ir, dI as ar, fa as lr, k8 as cr, S as ur, b5 as pr, nS as hr, eU as fr } from "./main-C4pF0E7B.js";
import { u as Pe, y as mr, h as dr, b as at, N as se, c as lt, d as fe, k as ct, w as gr } from "./MeshTransform-blS2Ryai.js";
import { c as yr } from "./imageUtils-B1KQfGWp.js";
import { c as xr, l as me } from "./MeshVertexAttributes-AtSRJZD7.js";
import { a as Me, i as de } from "./MeshLocalVertexSpace-Dx6k4fVM.js";
import { a as ie, s as ge, g as ut, u as Ee } from "./meshVertexSpaceUtils-DckI93UJ.js";
import { i as vr } from "./earcut-CLU1OM7e.js";
import { a as wr, e as $r, t as pt } from "./DoubleArray-BQAmseu8.js";
import { t as ht } from "./Indices-LdhD6v7z.js";
import { E as br, F as Tr, X as Ar } from "./plane-DEowYbo2.js";
import { e as Ue } from "./deduplicate-C7ws9QLe.js";
import { project as Sr, logProjectionError as b, loadProjectErrorMessage as E, projectToPCPF as ft, projectNormalToPCPF as mt, projectTangentToPCPF as dt, projectFromPCPF as gt, projectNormalFromPCPF as yt, projectTangentFromPCPF as xt } from "./projection-DZLC4pmp.js";
import { c as _, M as Fe, X as Rr, N as vt } from "./vertexSpaceConversion-BDB8iBSZ.js";
import { e as wt } from "./mat3f64-Dh9_zhFu.js";
import { e as Le } from "./mat4f64-Dn1WEGBx.js";
import { I as Mr } from "./quat-B5xJQUKj.js";
import { e as Fr, o as Ir } from "./quatf64-DxbQqBtW.js";
import { a as $t } from "./spatialReferenceEllipsoidUtils-D8TeGUPE.js";
import { u as Cr } from "./computeTranslationToOriginAndRotation-dZmhvdHy.js";
var G;
...
async function qr(e, t, n) {
  const { source: r } = t, { loadGLTFMesh: o } = await et(import("./loadGLTFMesh-C1rSpJ21.js"), n), s = await Jr(r, n);
  we(n);
...
let $ = M = class extends lr.LoadableMixin(cr(fr)) {
  ...
  async toBinaryGLTF(e) {
    const [{ toBinaryGLTF: t }] = await Promise.all([import("./gltfexport-bEBxlxu9.js"), this.load(e)]);
  ...
  static async createFromGLTF(e, t, n) {
    ...
    const { loadGLTFMesh: r } = await et(import("./loadGLTFMesh-C1rSpJ21.js"), n);
...
//# sourceMappingURL=Mesh-CVBizaf7.js.map
