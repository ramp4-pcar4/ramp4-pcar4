import { C as x, a1 as C, bn as J, bo as K, bp as E, bx as I, Z as M, eU as W, eY as Q, eZ as U } from "./main-C4pF0E7B.js";
import { a as G, b as u, r as c, I as j, m as P, G as w, ab as V, P as Z, N as T, U as v, A as H, E as D, X as k, w as X, v as Y, ac as _, ad as F, ae as z } from "./arcadeUtils-Bxiihihf.js";
import { l as B } from "./portalUtils-DoiDq_g2.js";
import { p as L, n as O } from "./project-D7vYnXHa.js";
import { s as $, m as nn, t as tn, p as en, c as an } from "./GraphQueryStreaming-CfpDqf8G.js";
let f = null;
async function rn(n) {
...
async function q(n, t) {
  ...
  return await a.load(), f === null && (f = await import("./knowledgeGraphService-UkCbm0re.js").then((i) => i.k)), await f.fetchKnowledgeGraph(a.url);
}
...
function pn(n) {
  n.mode === "async" && (n.functions.knowledgegraphbyportalitem = function(t, a) {
    ...
    return n.standardFunctionAsync(t, a, async (i, s, e) => {
      ...
      f === null && (f = await import("./knowledgeGraphService-UkCbm0re.js").then((o) => o.k));
      let p = null;
      const m = Z(e[2], null);
...
//# sourceMappingURL=knowledgegraph-DDMDdBKo.js.map
