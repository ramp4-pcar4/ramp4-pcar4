import { jr as A, js as y, bY as M, fU as $, hG as O, g1 as D, hH as j } from "./main-C4pF0E7B.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-B9eDuS7e.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-UCM-wN5M.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-DMqDFV3Q.js")).default, n = (await import("./index-BiQm4aMm.js")).default, a = (await import("./index-CybEn_Ko.js")).default, w = (await import("./index-C2IfgSPB.js")).default, p = (await import("./index-wV8AK60c.js")).default, r = (await import("./index-BXyvzNen.js")).default, b = (await import("./index-CbYK-J0n.js")).default;
...
//# sourceMappingURL=index-BQKvwLSH.js.map
