import { a9 as Et, fq as bt } from "./main-C4pF0E7B.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-D6jP2U5n.js").then((i) => i.l) : await import("./libtess-CWkVGHKU.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-eDM3jLhv.js.map
