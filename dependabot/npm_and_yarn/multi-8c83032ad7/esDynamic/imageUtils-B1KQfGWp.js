import { ag as m, aJ as d, $ as u, M as w, s as p } from "./main-C4pF0E7B.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-B9Vx19B0.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-D0WasX4D.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-B1KQfGWp.js.map
