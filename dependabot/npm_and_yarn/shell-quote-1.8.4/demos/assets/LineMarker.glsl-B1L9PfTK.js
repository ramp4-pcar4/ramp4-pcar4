import{n as e,t}from"./glsl-CXvSXY75.js";import{t as n}from"./Texture2DPassUniform-BsoMa898.js";import{t as r}from"./ShaderBuilder-BoqE5F3y.js";import{t as i}from"./Float2BindUniform-CF0KtCPy.js";import{t as a}from"./Float4BindUniform-DfIW_vVB.js";import{t as o}from"./Float4PassUniform-BLGpD4hu.js";import{t as s}from"./FloatBindUniform-xUZZ6pJ8.js";import{a as c,i as l,n as u}from"./AlphaCutoff-BuZgig4m.js";import{t as d}from"./Matrix4BindUniform-BQEehiFa.js";import{i as f,n as p,r as m}from"./View.glsl-BI7CtvMJ.js";import{c as h,l as g,s as _,t as v}from"./MarkerSizing.glsl-CN79wdBt.js";import{t as y}from"./PositionOutsideClipSpace-CB50LwWV.js";import{t as b}from"./TerrainDepthTest.glsl-Bpi73Lk3.js";import{t as x}from"./OutputColorHighlightOLID.glsl-Ck5hCOVi.js";function S(S){let C=new r,{space:w,anchor:T,hasTip:E,hasScreenSizePerspective:D}=S,O=w===2,k=w===1;C.include(g,S),C.include(v,S),C.include(b,S);let{vertex:A,fragment:j,varyings:M}=C;p(A,S),C.attributes.add(`position`,`vec3`),C.attributes.add(`previousDelta`,`vec4`),C.attributes.add(`uv0`,`vec2`),M.add(`vColor`,`vec4`),M.add(`vpos`,`vec3`,{invariant:!0}),M.add(`vUV`,`vec2`),M.add(`vSize`,`float`),E&&M.add(`vLineWidth`,`float`),A.uniforms.add(new i(`nearFar`,({camera:e})=>e.nearFar),new a(`viewport`,({camera:e})=>e.fullViewport)).code.add(e`vec4 projectAndScale(vec4 pos) {
