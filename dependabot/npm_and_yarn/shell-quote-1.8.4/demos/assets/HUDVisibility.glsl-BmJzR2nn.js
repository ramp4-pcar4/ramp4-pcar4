import{n as e}from"./glsl-CXvSXY75.js";import{t}from"./FloatPassUniform-D6ArRZe3.js";import{t as n}from"./Float4BindUniform-DfIW_vVB.js";import{t as r}from"./Texture2DBindUniform-CUzjbMEd.js";import{t as i}from"./FloatBindUniform-xUZZ6pJ8.js";import{n as a,t as o}from"./ScreenSizePerspective.glsl-BZERBf4c.js";import{i as s,n as c,r as l,t as u}from"./View.glsl-BI7CtvMJ.js";import{n as d}from"./VerticalOffset.glsl-tiKEJ1xW.js";import{t as f}from"./BooleanBindUniform-AvvbTOOz.js";var p=.5;function m(r,f){r.include(a),r.attributes.add(`position`,`vec3`),r.attributes.add(`normal`,`vec3`),r.attributes.add(`centerOffsetAndDistance`,`vec4`);let p=r.vertex;c(p,f),u(p,f),p.uniforms.add(new n(`viewport`,e=>e.camera.fullViewport),new t(`polygonOffset`,e=>e.shaderPolygonOffset),new i(`aboveGround`,e=>e.camera.aboveGround?1:-1)),f.hasVerticalOffset&&d(p),p.code.add(e`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
