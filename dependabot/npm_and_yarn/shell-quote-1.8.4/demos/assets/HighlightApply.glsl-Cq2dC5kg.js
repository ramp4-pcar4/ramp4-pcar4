import{n as e}from"./glsl-CXvSXY75.js";import{t}from"./FloatPassUniform-D6ArRZe3.js";import{t as n}from"./Texture2DPassUniform-BsoMa898.js";import{t as r}from"./ShaderBuilder-BoqE5F3y.js";import{t as i}from"./HighlightCellGridScreenSpacePass.glsl-QVnL8X_S.js";import{t as a}from"./IntegerPassUniform-C2c6eRyQ.js";import{a as o,s}from"./HighlightDownsample.glsl-DqJ1yCSE.js";import{t as c}from"./HighlightReadBitmap.glsl-CyDCJrf1.js";import{t as l}from"./Float2DrawUniform-mVeriyQl.js";function u(){let u=new r;u.include(i);let{fragment:d}=u;return d.uniforms.add(new n(`blurInput`,e=>e.highlightBlurTexture),new l(`blurSize`,e=>e.blurSize),new s(`highlightTexture`,e=>e.highlightTexture),new n(`highlightOptionsTexture`,e=>e.highlightOptionsTexture),new a(`highlightLevel`,e=>e.highlightLevel),new t(`occludedIntensityFactor`,e=>e.occludedFactor)),d.constants.add(`inner`,`float`,1-(9-o)/9),u.include(c),d.main.add(e`vec2 highlightTextureSize = vec2(textureSize(highlightTexture,0));
vec2 uv = sUV;
