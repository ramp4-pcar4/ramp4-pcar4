import{n as e}from"./glsl-CXvSXY75.js";import{t}from"./ShaderBuilder-BoqE5F3y.js";import{t as n}from"./Float4PassUniform-BLGpD4hu.js";import{a as r,i}from"./AlphaCutoff-BuZgig4m.js";import{t as a}from"./ObjectAndLayerIdColor.glsl-DCe-Cdir.js";import{t as o}from"./VisualVariables.glsl-Bhi7W2yG.js";import{n as s}from"./View.glsl-BI7CtvMJ.js";import{t as c}from"./TerrainDepthTest.glsl-Bpi73Lk3.js";import{t as l}from"./OutputColorHighlightOLID.glsl-Ck5hCOVi.js";import{t as u}from"./Transform.glsl-CfvgOo8k.js";import{t as d}from"./VertexColor.glsl-eOffJJdR.js";function f(f){let p=new t,{vertex:m,fragment:h,attributes:g,varyings:_}=p,{hasVVColor:v,hasVertexColors:y}=f;return s(m,f),p.include(u),p.include(d,f),p.include(o,f),p.include(a,f),h.include(r,f),p.include(l,f),p.include(c,f),g.add(`position`,`vec3`),v&&g.add(`colorFeatureAttribute`,`float`),y||_.add(`vColor`,`vec4`),_.add(`vpos`,`vec3`,{invariant:!0}),m.uniforms.add(new n(`uColor`,e=>e.color)),m.main.add(e`
      vpos = position;
      forwardVertexColor();
