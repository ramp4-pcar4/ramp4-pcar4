const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./fabric-BMDBM9m_.js","./main-BVpNLj1j.js","./preload-helper-dJJaZANz.js","./main-C4TGYCrz.css","./index-DQPzznSY.js","./index-B9w2kCyh.js","./index-BoxLhs-s.js","./index-D-4DT4wz.js","./index-BpKFle9f.js","./index-m6ZIKV3a.js","./index-CZEHQxF3.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { iS as commonjsGlobal, iT as getDefaultExportFromCjs, bA as FixtureInstance, fF as useExportStore, he as markRaw, fO as GlobalEvents, hf as useAppbarStore } from './main-BVpNLj1j.js';
import { _ as _sfc_main } from './screen.vue_vue_type_script_setup_true_lang-DQnf1ZKO.js';
...
class ExportAPI extends FixtureInstance {
  ...
  async make(canvas, panelWidth) {
    const { fabric } = await __vitePreload(async () => { const { fabric } = await import('./fabric-BMDBM9m_.js').then(n => n.f);return { fabric }},true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url);
...
class ExportFixture extends ExportAPI {
  ...
  async needed() {
    const exportTitle = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-DQPzznSY.js');return { default: __vite_default__ }},true?__vite__mapDeps([4,0,1,2,3]):void 0,import.meta.url)).default;
    const exportMap = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-B9w2kCyh.js');return { default: __vite_default__ }},true?__vite__mapDeps([5,0,1,2,3]):void 0,import.meta.url)).default;
    const exportLegend = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-BoxLhs-s.js');return { default: __vite_default__ }},true?__vite__mapDeps([6,1,2,3,0]):void 0,import.meta.url)).default;
    const exportNorthArrow = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-D-4DT4wz.js');return { default: __vite_default__ }},true?__vite__mapDeps([7,0,1,2,3]):void 0,import.meta.url)).default;
    const exportScalebar = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-BpKFle9f.js');return { default: __vite_default__ }},true?__vite__mapDeps([8,0,1,2,3]):void 0,import.meta.url)).default;
    const exportTimestamp = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-m6ZIKV3a.js');return { default: __vite_default__ }},true?__vite__mapDeps([9,0,1,2,3]):void 0,import.meta.url)).default;
    const exportFootnote = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-CZEHQxF3.js');return { default: __vite_default__ }},true?__vite__mapDeps([10,0,1,2,3]):void 0,import.meta.url)).default;
