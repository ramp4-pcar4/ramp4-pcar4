import { af as le, hX as ue } from "./main-0_0aEuXM.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-Boo4cXUX.js").then((i) => i.l) : await import("./libtess-CuH8rLpv.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-XeKfzdbL.js.map
