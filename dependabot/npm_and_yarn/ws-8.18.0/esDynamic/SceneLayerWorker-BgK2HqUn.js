import { hX as K, bh as D } from "./main-0_0aEuXM.js";
import { y as X } from "./DoubleArray-DDXyZkdh.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-B66slu60.js";
import { n as Z, s as ee } from "./vec3-BGLVwCkc.js";
import "./sphere-DYCZLDRH.js";
import "./I3SUtil-B0zA49oo.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-DsGjAXWS.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-0_0aEuXM.js").then((d) => d.qK), import("./main-0_0aEuXM.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-Dhr2Y5tp.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-BgK2HqUn.js.map
