import { jr as A, js as y, bY as M, fU as $, hG as O, g1 as D, hH as j } from "./main-DMoCLB29.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-CPrqr0NL.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-B-5Noftx.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-CSVt84Hb.js")).default, n = (await import("./index-BWNrphxr.js")).default, a = (await import("./index-CUgajAWH.js")).default, w = (await import("./index-C46_ue4B.js")).default, p = (await import("./index-C0rcb6jI.js")).default, r = (await import("./index-ikN2zEGw.js")).default, b = (await import("./index-CD9KtI83.js")).default;
...
//# sourceMappingURL=index-DAZDWwwu.js.map
