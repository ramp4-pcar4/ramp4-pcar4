import { fq as q, bx as v, cy as K } from "./main-DMoCLB29.js";
import { y as Q } from "./DoubleArray-BagHLB-p.js";
import { i as W, a as X } from "./MeshLocalVertexSpace-BoO99q49.js";
import { f as Z, l as ee } from "./vec3-C1GK1fa6.js";
import "./sphere-H4NRuewM.js";
import "./I3SUtil-DuhZRIhU.js";
var U, D;
(function(e) {
...
function te() {
  return _ || (_ = new Promise((e) => import("./i3s-D01HLIPS.js").then((t) => t.i).then(({ default: t }) => {
...
async function pe(e) {
  ...
  let s;
  const [{ projectBuffer: I }, { initializeProjection: M }] = await Promise.all([import("./main-DMoCLB29.js").then((a) => a.r9), import("./main-DMoCLB29.js").then((a) => a.ra)]);
  await M(c, l);
  const g = [0, 0, 0];
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    ...
    const a = i.type === "georeferenced" ? W.fromJSON(i) : X.fromJSON(i), { project: m } = await import("./projection-D7ZxCsLf.js"), d = m({ positions: f, transform: t ? { localMatrix: t } : void 0, vertexSpace: a, inSpatialReference: c, outSpatialReference: l, localMode: u });
...
//# sourceMappingURL=SceneLayerWorker-Dxqma1EC.js.map
