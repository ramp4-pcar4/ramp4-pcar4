class e {
  ...
  peekLast() {
    return this.size === 0 ? null : this._buffer[(this._start + (this.size - 1)) % this.maxSize];
  }
  find(t) {
    if (this.size === 0) return null;
    for (const s of this._buffer) if (s != null && t(s)) return s;
    return null;
  }
  clear(t) {
    let s = this.dequeue();
    for (; s != null; ) t && t(s), s = this.dequeue();
  }
}
export {
  e as t
};
//# sourceMappingURL=CircularArray-DaQg3PQl.js.map
