...
let i = class extends q(P(T(k(D(G(C(Q(Z(z(L(de))))))))))) {
  ...
  async applyEdits(e, t) {
    const { applyEdits: o } = await import("./editingSupport-CLnINwyq.js");
    await this.load();
...
//# sourceMappingURL=GeoJSONLayer-D9GNOCNa.js.map
