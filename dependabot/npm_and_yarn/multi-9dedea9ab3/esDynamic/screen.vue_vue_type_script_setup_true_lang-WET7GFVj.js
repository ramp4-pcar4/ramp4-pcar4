import { c1 as b, c2 as x, c3 as L, c4 as A, c5 as B, c6 as C, c7 as I, c8 as j, c9 as i, ca as l, cb as p, cc as n, cd as w, ce as D, cf as c, cg as N, ch as T, ci as u, cj as V, ck as q, cl as d } from "./main-DMoCLB29.js";
const F = ["content"], M = /* @__PURE__ */ b({
  ...
  setup(v) {
    const m = d(() => import("./header-0oM5nV6C.js")), _ = d(() => import("./item-bCbvQfxu.js")), { t: s } = x(), f = L("iApi"), e = A(), r = () => {
      e.value._tippy.hide();
    }, a = (t) => {
...
//# sourceMappingURL=screen.vue_vue_type_script_setup_true_lang-WET7GFVj.js.map
