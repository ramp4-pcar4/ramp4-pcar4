...
let W = class extends ee {
  ...
  loadDependencies() {
    return Le({ icon: () => import("./calcite-icon-BnucmTMV.js") });
  }
  get capabilities() {
...
async function mr(t, e, i) {
  ...
  const c = s ? null : pr(n);
  return (await Promise.all(n.map(async (h, p) => ({ value: h, color: t.type === "opacity" ? await fr(h, t) : (await import("./main-DMoCLB29.js").then((m) => m.r8)).getColor(t, h), label: s ? r[p] : c?.[p] ?? "" })))).reverse();
}
async function fr(t, e, i) {
  const s = new Zi(hr), n = (await import("./main-DMoCLB29.js").then((r) => r.r8)).getOpacity(e, t);
...
let U = class extends ee {
  constructor(e, i) {
    super(e, i), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new Ie(), this.messages = null, this._disposeChart = (s) => {
      ...
      if (n || !r || !s) return;
      const { createRoot: a } = await import("./chartUtilsAm5-C9rS_jSS.js"), d = await a(s);
  ...
  async _getSeriesColors(e) {
    const { colorAm5: i } = await import("./chartCommon-DTLyyV2d.js"), s = /* @__PURE__ */ new Map();
    return e.forEach((n) => {
      n.color && s.set(n, i(n.color.toCss(!0)));
    }), s;
  }
  async _getRendererColors() {
    const { colorAm5: e } = await import("./chartCommon-DTLyyV2d.js"), i = /* @__PURE__ */ new Map(), s = this._getRenderer(), n = "default";
    if (!s) return i;
    const r = await yr(s);
  ...
  async _renderChart(e) {
    const { root: i, mediaInfo: s } = e, { value: n, type: r } = s, { ResponsiveThemeAm5: a, DarkThemeAm5: d, AnimatedThemeAm5: c, ColorSetAm5: h, ThemeAm5: p, esriChartColorSet: m } = await import("./chartCommon-DTLyyV2d.js"), f = p.new(i);
  ...
  async _customizeChartTooltip(e, i = "horizontal") {
    const { colorAm5: s } = await import("./chartCommon-DTLyyV2d.js");
  ...
  async _createPieChart(e, i) {
    const { TooltipAm5: s } = await import("./chartCommon-DTLyyV2d.js"), { PieChartAm5: n, PieSeriesAm5: r } = await import("./pieChart-sS2Lp4gY.js"), { mediaInfo: a, root: d } = e, { title: c } = a, h = 5, p = a?.altText || a?.title || "", m = d.container.children.push(n.new(d, { ariaLabel: p, focusable: !0, paddingBottom: h, paddingTop: h, paddingLeft: h, paddingRight: h })), f = `{category}: {valuePercentTotal.formatNumber('0.00')}%
 ({value})`, y = s.new(d, { labelText: f }), v = m.series.push(r.new(d, { name: c, valueField: We, categoryField: pe, tooltip: y }));
  ...
  async _createColumnChart(e, i, s) {
    const { TooltipAm5: n, ScrollbarAm5: r } = await import("./chartCommon-DTLyyV2d.js"), { CategoryAxisAm5: a, AxisRendererXAm5: d, ValueAxisAm5: c, AxisRendererYAm5: h, ColumnSeriesAm5: p } = await import("./xyChart-CdcEPDeB.js"), { mediaInfo: m, root: f } = i, { value: y, title: v } = m;
  ...
  async _createLineChart(e, i, s) {
    const { TooltipAm5: n, ScrollbarAm5: r } = await import("./chartCommon-DTLyyV2d.js"), { CategoryAxisAm5: a, AxisRendererXAm5: d, ValueAxisAm5: c, AxisRendererYAm5: h, LineSeriesAm5: p } = await import("./xyChart-CdcEPDeB.js"), { root: m, mediaInfo: f } = i, { value: y, title: v } = f;
    e.setAll({ wheelX: "panX", wheelY: "zoomX" });
  ...
  async _createXYChart(e, i) {
    const { XYChartAm5: s, XYCursorAm5: n } = await import("./xyChart-CdcEPDeB.js"), { root: r, mediaInfo: a } = e, { type: d } = a, c = a?.altText || a?.title || "", h = r.container.children.push(s.new(r, { ariaLabel: c, focusable: !0, panX: !0, panY: !0 }));
...
function gs() {
  return import("./arcade-Dpn_PlRw.js");
}
function zr(t) {
...
let rt = class extends ee {
  ...
  loadDependencies() {
    return Le({ loader: () => import("./calcite-loader-2qbqCZCy.js") });
  }
  destroy() {
...
let Q = class extends ee {
  ...
  loadDependencies() {
    return Le({ icon: () => import("./calcite-icon-BnucmTMV.js"), list: () => import("./calcite-list-Cw56Gke2.js"), "list-item": () => import("./calcite-list-item-B4A15xG5.js"), loader: () => import("./calcite-loader-2qbqCZCy.js"), notice: () => import("./calcite-notice-Dp9hCJxt.js") });
  }
  destroy() {
...
let q = Bt = class extends vs(ee) {
  ...
  loadDependencies() {
    return Le({ notice: () => import("./calcite-notice-Dp9hCJxt.js"), loader: () => import("./calcite-loader-2qbqCZCy.js") });
  }
  destroy() {
...
let be = class extends ee {
  ...
  loadDependencies() {
    return Le({ action: () => import("./calcite-action--Z3WL-dV.js"), "flow-item": () => import("./calcite-flow-item-BcP4OXlk.js") });
  }
  render() {
...
async function Ni(t, e) {
  ...
  const { getColor: d, getOpacity: c, getAllSizes: h, getRotationAngle: p } = await import("./main-DMoCLB29.js").then((w) => w.r8), m = [], f = [], y = [], v = [];
  ...
  constructor(t) {
    super(t), this._pendingPromises = new eo(), this._fetchFeaturesController = null, this._highlightSelectedFeaturePromise = null, this._highlightActiveFeaturePromise = null, this._selectedClusterFeature = null, this.actions = new Ae(), this.activeFeature = null, this.autoCloseEnabled = !1, this.browseClusterEnabled = !1, this.content = null, this.defaultPopupTemplateEnabled = !1, this.featurePage = null, this.featuresPerPage = 20, this.featureMenuOpen = !1, this.featureViewModelAbilities = null, this.featureViewModels = [], this.highlightEnabled = !0, this.includeDefaultActions = !0, this.selectedClusterBoundaryFeature = new De({ symbol: new ln({ outline: { width: 1.5, color: "cyan" }, style: "none" }) }), this.title = null, this.updateLocationEnabled = !1, this.view = null, this.visible = !1, this.zoomFactor = 4, this.zoomToLocation = null, this._debouncedLocationUpdate = it(async (e) => {
      ...
      if (s && s !== "mesh" && i && n && this.selectedFeature) if (s !== "point") try {
        ...
        if (a = dn(a, i), tt || (tt = await import("./geometryEngineAsync-CbGqCy7P.js")), !await tt.intersects(a, n)) {
...
let A = class extends vs(ee) {
  ...
  loadDependencies() {
    return Le({ action: () => import("./calcite-action--Z3WL-dV.js"), "action-bar": () => import("./calcite-action-bar-Dc182UxO.js"), "action-group": () => import("./calcite-action-group-CwHhYIkW.js"), button: () => import("./calcite-button-_cYACL3K.js"), flow: () => import("./calcite-flow-Blgp04qx.js"), "flow-item": () => import("./calcite-flow-item-BcP4OXlk.js"), list: () => import("./calcite-list-Cw56Gke2.js"), "list-item": () => import("./calcite-list-item-B4A15xG5.js"), "list-item-group": () => import("./calcite-list-item-group-BKeDitMZ.js"), loader: () => import("./calcite-loader-2qbqCZCy.js") });
  }
  destroy() {
...
//# sourceMappingURL=Popup-BJ6U_ZEp.js.map
