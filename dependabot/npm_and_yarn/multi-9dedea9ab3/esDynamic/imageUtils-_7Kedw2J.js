import { ag as m, aJ as d, $ as u, M as w, s as p } from "./main-DMoCLB29.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-BkoTXQ5T.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-BMhqM7lq.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-_7Kedw2J.js.map
