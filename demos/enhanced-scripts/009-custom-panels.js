...
- Tests the `persist` fixture property on the basemap and export fixtures, such that on a lang change (for which the configs 
  of each lang are different), the fixtures will not persist
 */
