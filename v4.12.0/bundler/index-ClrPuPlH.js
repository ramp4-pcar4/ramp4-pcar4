...
import "tiny-emitter";
import { G as re, L as ve, F as be } from "./main-QMUrUWN5.js";
...
class ut extends xe {
  async init() {
    ...
    this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(r.childNodes[0]), Object.entries(Pe).forEach((t) => this.$iApi.$i18n.mergeLocaleMessage(...t)), this._parseConfig(this.config), Y(this.$vApp.$pinia).supportedTypes.forEach((t) => {
      const n = `${t.type}-icon`;
      this.$iApi.component(n, fe(Ae(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-CXhZ8-Vi.js"), "./icons/edit-icon.vue": () => import("./edit-icon-9tskLLQk.js"), "./icons/point-icon.vue": () => import("./point-icon-BofSdn2M.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-DTu8ml-2.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-B9iB5wrD.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-DP1fKDYs.js") }), `./icons/${t.type}-icon.vue`, 3)));
    });
  }
  async added() {
