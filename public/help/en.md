...
- Attempting to add file layers through a remote URL may fail due to server configuration. In this case, downloading the file locally and then uploading to the application as a true file layer is recommended.
