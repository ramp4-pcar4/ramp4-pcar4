import { bB as FixtureInstance, i6 as useLegendStore, iD as SectionItem, iE as LayerItem, iF as LegendItem, iG as LayerType, iH as LayerInstance, bG as defineComponent, bH as useI18n, bI as inject, bK as resolveComponent, bM as openBlock, bN as createBlock, bO as withCtx, bR as unref, fE as createBaseVNode, he as markRaw, hf as useAppbarStore, hg as useMapnavStore } from './main-91ff489c.js';
import { _ as _sfc_main$1 } from './screen.vue_vue_type_script_setup_true_lang-c9d12e1e.js';
...
class LegendAPI extends FixtureInstance {
  ...
  _parseConfig(legendConfig) {
    ...
    useLegendStore(this.$vApp.$pinia).multilineItems = legendConfig.multilineItems ?? true;
    const lineClampValues = [1, 2, 3, 4, 5, 6];
    if (!legendConfig.itemMaxLines || !lineClampValues.includes(legendConfig.itemMaxLines)) {
      useLegendStore(this.$vApp.$pinia).itemMaxLines = 3;
    } else {
      useLegendStore(this.$vApp.$pinia).itemMaxLines = legendConfig.itemMaxLines;
    }
