...
const _hoisted_8 = { class: "relative h-48" };
const _hoisted_9 = { class: "font-bold text-blue-600" };
const _hoisted_10 = {
  key: 3,
  class: "rv-results-list flex-grow mb-5 border-t border-b border-gray-600 overflow-y-auto"
};
const _hoisted_11 = ["onClick"];
const _hoisted_12 = { class: "rv-result-description px-8" };
const _hoisted_13 = { class: "flex-1 text-left truncate font-bold leading-tight" };
        ...
        content: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [
            createBaseVNode("div", _hoisted_2, [
              ...
              badChars.value ? withDirectives((openBlock(), createElementBlock("div", {
                key: 0,
            ...
            failedServices.value.length > 0 && !loadingResults.value ? (openBlock(), createElementBlock("div", _hoisted_6, toDisplayString(unref(t)("geosearch.serviceError", {
              services: failedServices.value.join(", ")
            })), 1)) : createCommentVNode("", true),
            cleanedSearchVal.value && searchResults.value.length === 0 && !loadingResults.value ? (openBlock(), createElementBlock("div", _hoisted_7, [
              createBaseVNode("span", _hoisted_8, [
                createTextVNode(toDisplayString(unref(t)("geosearch.noResults")), 1),
                createBaseVNode("span", _hoisted_9, '"' + toDisplayString(cleanedSearchVal.value) + '"', 1)
              ])
            ])) : createCommentVNode("", true),
            searchResults.value.length > 0 ? withDirectives((openBlock(), createElementBlock("ul", _hoisted_10, [
                  ...
                  withDirectives((openBlock(), createElementBlock("button", {
                    ...
                    createBaseVNode("div", _hoisted_12, [
                      withDirectives((openBlock(), createElementBlock("div", _hoisted_13, [
                        ...
                        result.location.province ? (openBlock(), createElementBlock("span", _hoisted_15, toDisplayString(result.location.city ? " " + result.location.city + ", " + result.location.province.abbr : " " + result.location.province.abbr), 1)) : createCommentVNode("", true),
                        result.type ? (openBlock(), createElementBlock("span", _hoisted_16, "; ")) : createCommentVNode("", true),
                        result.type ? (openBlock(), createElementBlock("span", _hoisted_17, [
                          _hoisted_18,
