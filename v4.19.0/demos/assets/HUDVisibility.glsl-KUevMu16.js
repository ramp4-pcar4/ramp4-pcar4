import{n as e}from"./glsl-BlSepfbN.js";import{t}from"./FloatPassUniform-BPzXeigN.js";import{t as n}from"./Float4BindUniform-53grEBNh.js";import{t as r}from"./Texture2DBindUniform-y3Uo3EMP.js";import{t as i}from"./FloatBindUniform-CQkkuCDc.js";import{n as a,t as o}from"./ScreenSizePerspective.glsl-DiQVIky4.js";import{i as s,n as c,r as l,t as u}from"./View.glsl-DDYb2Tl9.js";import{n as d}from"./VerticalOffset.glsl-BoFiFID2.js";import{t as f}from"./BooleanBindUniform-D7A-A_iS.js";var p=.5;function m(r,f){r.include(a),r.attributes.add(`position`,`vec3`),r.attributes.add(`normal`,`vec3`),r.attributes.add(`centerOffsetAndDistance`,`vec4`);let p=r.vertex;c(p,f),u(p,f),p.uniforms.add(new n(`viewport`,e=>e.camera.fullViewport),new t(`polygonOffset`,e=>e.shaderPolygonOffset),new i(`aboveGround`,e=>e.camera.aboveGround?1:-1)),f.hasVerticalOffset&&d(p),p.code.add(e`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
