import{c as e,r as t}from"./Emissions.glsl-ClaXet58.js";import{n,t as r}from"./glsl-BlSepfbN.js";import{t as i}from"./Float3PassUniform-DsOh2hY-.js";import{t as a}from"./FloatPassUniform-BPzXeigN.js";import{t as o}from"./Texture2DPassUniform-Mr-K9FL9.js";import{t as s}from"./ShaderBuilder-DS-lb90Q.js";import{n as c}from"./MaterialUtil-5-zAtary.js";import{t as l}from"./Float4PassUniform-CGmatYpU.js";import{a as u,t as d}from"./AlphaCutoff-B5iH7Vka.js";import{a as f,i as p,t as m}from"./VisualVariables.glsl-D24--J0V.js";import{n as h,t as g}from"./View.glsl-DDYb2Tl9.js";import{t as _}from"./MixExternalColor.glsl-DNg1HVki.js";import{t as v}from"./TerrainDepthTest.glsl-C4cxUhZc.js";import{t as y}from"./OutputColorHighlightOLID.glsl-iHuYijyc.js";import{r as b}from"./VerticalOffset.glsl-BoFiFID2.js";import{t as x}from"./Transform.glsl-Czk5kVD-.js";import{t as S}from"./VertexColor.glsl-Bbkes2XF.js";import{a as C,i as w,n as T,o as E,r as D,t as O,u as k}from"./DefaultMaterialAuxiliaryPasses.glsl-DqMGBwzk.js";import{a as A,i as j,n as ee,o as M,r as N,t as P}from"./SnowCover.glsl-COB5ONx1.js";import{a as F,c as I,n as L,s as R,t as z}from"./ReadShadowMap.glsl-Bc2wV7mC.js";function B(B){let V=new s,{attributes:H,vertex:U,fragment:W,varyings:G}=V,{output:K,offsetBackfaces:q,pbrMode:J,snowCover:Y,spherical:X}=B,Z=J===1||J===2;if(h(U,B),H.add(`position`,`vec3`),G.add(`vpos`,`vec3`,{invariant:!0}),V.include(m,B),V.include(w,B),V.include(b,B),V.include(v,B),!e(K))return V.include(O,B),V;g(V.vertex,B),V.include(k,B),V.include(x),q&&V.include(E),G.add(`vNormalWorld`,`vec3`),G.add(`localvpos`,`vec3`,{invariant:!0}),V.include(t,B),V.include(D,B),V.include(C,B),V.include(S,B),U.include(f),U.include(p),U.uniforms.add(new l(`externalColor`,e=>e.externalColor,{supportsNaN:!0})),G.add(`vcolorExt`,`vec4`),V.include(B.instancedDoublePrecision?L:z,B),U.main.add(n`
    forwardVertexColor();
