<template>
    <div class="mapnav absolute right-0 bottom-0 pb-36 sm:pb-48 pr-12">
        ...
        <div
            ...
            class="absolute right-56 bottom-36 sm:bottom-48 mapnav-section flex flex-col flex-wrap gap-x-1 items-start z-50"
            :class="{
                'h-[198px]': windowHeight <= cutoffHeight - 85,
                'h-[165.1px]': windowHeight <= cutoffHeight - 120,
                'h-[132px]': windowHeight <= cutoffHeight - 154,
                'h-[99px]': windowHeight <= cutoffHeight - 185
            }"
            v-focus-list
            :content="t('panels.controls.items')"
            v-tippy="{
