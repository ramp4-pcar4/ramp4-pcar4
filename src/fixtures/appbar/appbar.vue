<template>
    <div
        class="absolute top-0 left-0 bottom-28 flex flex-col w-40 pointer-events-auto appbar bg-black-75 z-50 sm:w-64 sm:z-20 sm:bottom-38"
        v-focus-list
        ref="el"
    >
    ...
    updated() {
        this.$nextTick(() => {
            ...
            if (
                ...
                let index: number = 0;
                while (moreBottom <= bound - 48 || buttonsRemaining == 1) {
