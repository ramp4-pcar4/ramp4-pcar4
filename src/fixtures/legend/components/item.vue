    ...
    <div :key="legendItem.visibility" v-if="!legendItem.hidden">
        <div class="relative">
            ...
            >
                ...
                <div class="relative" v-if="isOffscale">
                    <button
                        type="button"
                        class="p-4"
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            isOffscale:
                this.legendItem instanceof LayerItem &&
                this.legendItem.layer?.isOffscale()
        };
    },
    computed: {
        /**
            ...
            this.legendItem.loadPromise.then(() => {
                ...
                this.handlers.push(
                    this.$iApi.event.on(GlobalEvents.MAP_SCALECHANGE, () => {
                        this.isOffscale = this.legendItem.layer?.isOffscale();
                    })
                );
            });
        }
