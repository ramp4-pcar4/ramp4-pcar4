...
export class LegendAPI extends FixtureInstance {
    ...
    createItem(itemConf: any, parent?: LegendItem): LegendItem {
        ...
        if (itemConf.layerId === undefined) {
            ...
            item = new SectionItem(this.$iApi, itemConf, parentItem);
        } else {
    ...
    async addLayerItem(
        ...
        this._insertItem(item as unknown as LegendItem, parentItem);
    ...
    /**
     * Checks if the given legend item is not a leaf.
     * Will return the same item if it is a non-leaf, and will return undefined otherwise
     *
     * @param {LegendItem | undefined} parent the legend item to validate
     * @returns {LegendGroup | undefined} returns the parent parameter if it is a non-leaf, and returns undefined otherwise
     */
    private _validateParent(parent?: LegendItem): LegendItem | undefined {
        /* if (parent === undefined) {
            console.warn(
