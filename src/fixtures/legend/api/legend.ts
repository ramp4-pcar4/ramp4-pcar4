...
export class LegendAPI extends FixtureInstance {
    ...
    createItem(itemConf: any, parent?: LegendItem): LegendItem {
        ...
        if (
            ...
            item = new LegendGroup(itemConf, parent);
            let isSet = itemConf.exclusiveVisibility !== undefined;

            // initialize objects for all non-hidden group/set children entries
            const children = isSet
            ...
            item = new LegendEntry(itemConf, parent);
        }
    ...
    /**
     * Add a layer legend item item given a layer instance
     *
