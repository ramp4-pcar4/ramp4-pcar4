<template>
    <div class="mt-10">
        ...
        >
            ...
            <div class="absolute flex w-full bg-black opacity-75 text-white h-30 bottom-6 items-center">
                <!-- title text -->
...
[focus-list]:focus [focus-item].focused.area-of-interest-item-button .area-of-interest-item-image {
    opacity: 0.5;
}
</style>
