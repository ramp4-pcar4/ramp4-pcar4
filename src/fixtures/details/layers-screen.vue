...
export default defineComponent({
    ...
    data() {
        return {
            ...
            greedyLoading: this.get(DetailsStore.greedyLoading),
    ...
    methods: {
        ...
        loadPayloadItems(newPayload: Array<IdentifyResult>): void {
            ...
            this.$iApi.$vApp.$store.set(DetailsStore.greedyLoading, false);
