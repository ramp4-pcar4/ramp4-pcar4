...
describe('GeoAPI SharedUtils', () => {
    ...
    it('convertImageToCanvas works with reqular url', () => {
        cy.window().then(window => {
            const sharedUtils = window.debugInstance.geo.shared;
            const url =
                'https://maps-cartes.qa.ec.gc.ca/arcgis/rest/services/TestData/BadDates/MapServer/0/images/eed7a82bfccb37a9c63f3dd221c02906';
            cy.wrap(null).then(() => {
                return sharedUtils.convertImageToCanvas(url).then(canvas => {
    ...
    //     cy.window().then(window => {
    //         const sharedUtils = window.debugInstance.geo.shared;
    //         const url = 'https://maps-cartes.qa.ec.gc.ca/arcgis/rest/services/TestData/BadDates/MapServer/0/images/eed7a82bfccb37a9c63f3dd221c02906';
