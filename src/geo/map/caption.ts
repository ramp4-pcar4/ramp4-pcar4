...
export class MapCaptionAPI extends APIScope {
    ...
    updateAttribution(newAttribution: Attribution | undefined): void {
        ...
        if (newAttribution) {
            ...
            // Update attribution
            const mapCaptionStore = useMapCaptionStore(this.$vApp.$pinia);
            mapCaptionStore.attribution.text.value = attribution.text.value;
            mapCaptionStore.attribution.text.disabled =
                attribution.text.disabled;
            mapCaptionStore.attribution.logo.altText = attribution.logo.altText;
            mapCaptionStore.attribution.logo.link = attribution.logo.link;
            mapCaptionStore.attribution.logo.value = attribution.logo.value;
            mapCaptionStore.attribution.logo.disabled =
                attribution.logo.disabled;
        } else {
        ...
        if (!newAttribution || newAttribution.text?.disabled) {
            ...
            Promise.all(baseLayerLoadPromises).then(baseLayers => {
                ...
                mapCaptionStore.attribution.text.disabled =
                    attribution.text.disabled;
                mapCaptionStore.attribution.logo.altText =
                    attribution.logo.altText;
                mapCaptionStore.attribution.logo.link = attribution.logo.link;
                mapCaptionStore.attribution.logo.value = attribution.logo.value;
                mapCaptionStore.attribution.logo.disabled =
