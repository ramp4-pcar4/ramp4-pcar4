...
export class TableLayer extends DataLayer {
    ...
    onLoadActions(): Array<Promise<void>> {
        // this will just update the draw state. If we find this causes problems (it shouldn't),
        // this can move to the end of this method, or even promise-chained after all other promises
        // in here resolve.
