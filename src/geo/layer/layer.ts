...
export class LayerAPI extends APIScope {
    ...
    /**
     * Returns all loaded data-based layers currently registered with the map.
    ...
    async loadLayerMetadata(url: string): Promise<ArcGisServerMetadata> {
        ...
        md.extent = sData.extent
            ...
            : undefined;
        // TODO can debate if missing prop should be false. My thinking is people usually want to see their stuff as default?
