...
export class DataLayer extends CommonLayer {
    ...
    protected constructor(rampConfig: RampLayerConfig, $iApi: InstanceAPI) {
        ...
        this._visibility = rampConfig.state?.visibility ?? true; // TODO: Set this value somewhere else?
    ...
    async reload(): Promise<void> {
        ...
        // TODO: Figure out if there is a better place to put this. Only data layers seem to need it but I could be wrong.
        setTimeout(() => {
     ...
     * Used to determine if layer visibility in the grid can be toggled.
     */
    ...
    /**
     * Returns the visibility of the layer in the grid.
     *
     * @returns {Boolean} visibility of the layer in the grid
     */
    ...
    /**
     * Applies visibility to layer in the grid.
     *
