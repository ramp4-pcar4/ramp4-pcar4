...
import { bG as defineComponent, bI as inject, bK as resolveComponent, bM as openBlock, bN as createBlock, bO as withCtx, fE as createBaseVNode, iM as normalizeStyle, bP as createTextVNode, bH as useI18n, bQ as toDisplayString, bR as unref, bB as FixtureInstance, hb as markRaw } from './main-b765c22f.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-58aa69a8.js'),true?["./p2-screen-1-58aa69a8.js","./main-b765c22f.js","./preload-helper-a4975f27.js","./main-a813692f.css"]:void 0,import.meta.url).then(
                    (data) => {
                      resolve(data);
                    }
                  ),
