import { bB as FixtureInstance, nT as useDetailsStore, nU as ReactiveIdentifyFactory, bG as defineComponent, fF as ref, fH as onMounted, bM as openBlock, bU as createElementBlock, fE as createBaseVNode, bV as Fragment, bW as renderList, fD as normalizeClass, iM as normalizeStyle, il as createCommentVNode, bQ as toDisplayString, i5 as pushScopeId, i6 as popScopeId, i7 as _export_sfc, bJ as computed, bL as resolveDirective, bT as withDirectives, bS as createVNode, im as withModifiers, lC as useLayerStore, iz as onBeforeMount, iu as watch, fI as onBeforeUnmount, bN as createBlock, bH as useI18n, bI as inject, nV as linkifyHtml, bR as unref, bP as createTextVNode, kN as resolveDynamicComponent, iG as LayerType, nW as GeometryType, fL as GlobalEvents, bK as resolveComponent, bO as withCtx, hb as markRaw, hc as useAppbarStore } from './main-b765c22f.js';
import { H as HilightMode } from './hilight-defs-7930cd91.js';
import { T as ToggleSwitchControl } from './toggle-switch-control-a5952aaf.js';
...
const _withScopeId$2 = (n) => (pushScopeId("data-v-8627eab6"), n = n(), popScopeId(), n);
const _hoisted_1$7 = {
  key: 0,
  class: "relative"
};
...
const _hoisted_12$2 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ createBaseVNode("div", { class: "symbologyIcon h-32 w-32" }, [
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-c491f5c3"), n = n(), popScopeId(), n);
...
const _hoisted_6$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", { class: "animate-spin spinner h-20 w-20" }, null, -1));
const _hoisted_7$1 = [
  _hoisted_6$1
];
...
const _hoisted_13$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("path", {
...
const _hoisted_16$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("path", {
  "stroke-linecap": "round",
  "stroke-linejoin": "round",
...
const resultItem_vue_vue_type_style_index_0_scoped_c491f5c3_lang = '';

const ResultItem = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c491f5c3"]]);
        ...
        layerExists.value ? (openBlock(), createElementBlock("div", _hoisted_15, [
          getLayerIdentifyItems().length > 0 ? (openBlock(), createElementBlock("div", _hoisted_16, [
            showList.value ? withDirectives((openBlock(), createElementBlock("div", _hoisted_17, [
              ...
              [_directive_focus_list]
            ]) : (openBlock(), createBlock(ResultItem, {
              key: 1,
