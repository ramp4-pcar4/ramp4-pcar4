...
export declare const useNotificationStore: import('pinia').StoreDefinition<"notification", import('pinia')._UnwrapAll<Pick<NotificationStore, "notificationStack" | "groups">>, Pick<NotificationStore, "notificationNumber">, Pick<NotificationStore, "showNotification" | "removeNotification" | "registerGroup" | "addToGroup" | "clearAll" | "removeGroup">>;
